...
public class GeoTransformDataResult {
	...
	/**
	 * @retrun array con los coeficientes para la transformacion a coord mapas
	 *         de unas coordenadas pixel. (para las x)
	 * */
	...
	/**
	 * @param con
	 *            los coeficientes para las x en transformacion a coordenadas
	 *            mapa de unas coordenadas pixel. (para las x)
	 * */
	...
	/**
	 * @retrun array con los coeficientes para la transformacion a coord mapas
	 *         de unas coordenadas pixel. (para las y)
	 * */
	 ...
	 * @param con
	 *            los coeficientes para las x en transformacion a coordenadas
	 *            mapa de unas coordenadas pixel. (para las y)
	 * */
	...
	/**
	 * @retrun array con los coeficientes para la transformacion a coord pixel
	 *         de unas coordenadas map. (para las x)
	 * */
	...
	/**
	 * @retrun array con los coeficientes para la transformacion a coord pixel
	 *         de unas coordenadas map. (para las y)
	 * */
	...
	/**
	 * @retrun array con los coeficientes para la transformacion a coord pixel
	 *         de unas coordenadas mapa. (para las y)
	 * */
	...
	private void setExpPolinomial() {
		if (exp == null) {
			int minGPC = (getPolynomialOrden() + 1)
					* (getPolynomialOrden() + 2) / 2;
