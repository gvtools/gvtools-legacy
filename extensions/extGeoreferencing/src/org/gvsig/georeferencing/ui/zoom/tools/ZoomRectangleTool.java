 ...
 */
public class ZoomRectangleTool extends BaseViewTool implements MouseListener,
		MouseMotionListener {
	...
	public void mouseReleased(MouseEvent e) {
		if (isActive()) {
			...
			// Ajuste de la petición a la proporción del canvas. Esto se hace
			// porque la relación entre
			// el ancho y alto del canvas es distinta a la del cuadro que hemos
			// pintado en pantalla.
			...
			Point2D pEnd = canvas.viewCoordsToWorld(new Point2D.Double(x + w, y
					+ h));
