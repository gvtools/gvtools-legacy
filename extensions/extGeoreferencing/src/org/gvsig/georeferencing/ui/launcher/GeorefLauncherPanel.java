...
/**
 * Panel general del cuadro de lanzamiento de la funcionalidad de
 * georreferenciación. Contiene los paneles de selección de algoritmo, selección
 * de fichero y selección de tipo de georreferenciación.
 * 
 * 10/01/2008
 * 
...
public class GeorefLauncherPanel extends DefaultButtonsPanel {
	 ...
	 */
	public GeorefLauncherPanel(String[] viewList, int polynomialDegree,
	...
	public FileSelectionPanel getFileSelectionPanel() {
		if (filePanel == null)
			filePanel = new FileSelectionPanel(getCellSizePanel()
					.getXCellSizeTextField(), getCellSizePanel()
					.getYCellSizeTextField());
		return filePanel;
	}
