...
public class TypeSelectionPanel extends JPanel implements ActionListener {
	...
	public void init() {
		...
		setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				RasterToolsUtil.getText(this, "georef_type"),
	...
	public JRadioButton getWithoutMap() {
		if (withoutMap == null)
			withoutMap = new JRadioButton(RasterToolsUtil.getText(this,
					"without_map"));
		return withoutMap;
	}
	...
	public JRadioButton getWithMap() {
		if (withMap == null) {
			withMap = new JRadioButton(
					RasterToolsUtil.getText(this, "with_map"));
	 ...
	 * 
	 * @return constante definida en Georeferencing con el tipo de
	 *         georreferenciación seleccionada.
	 */
	public int getType() {
