...
public class AlgorithmSelectionPanel extends JPanel implements ActionListener {
	...
	public void init() {
		...
		setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				RasterToolsUtil.getText(this, "georef_algorithm"),
	...
	public JRadioButton getAffine() {
		if (affine == null) {
			affine = new JRadioButton(RasterToolsUtil.getText(this,
					"affine_algorithm"));
	...
	public JRadioButton getPolynomial() {
		if (polynomial == null)
			polynomial = new JRadioButton(RasterToolsUtil.getText(this,
					"polynomial_algorithm"));
		return polynomial;
	}

	/**
	 * Obtiene el combo con la lista de vistas para la selección de la que
	 * contiene la cartografía de referencia.
	 * 
	 * @return JComboBox
	 */
	public JComboBox getDegreeList() {
		if (degreeList == null) {
			...
			for (int i = 1; i <= polynomialDegree; i++)
				degreeList.addItem(RasterToolsUtil.getText(this, "poly_order")
						+ ": " + i);
		}
		return degreeList;
	}
	...
	public JComboBox getInterpolationMethod() {
		if (interpolationMethod == null) {
			...
			interpolationMethod.addItem(RasterToolsUtil.getText(this,
					"vecino_+_proximo"));
			interpolationMethod.addItem(RasterToolsUtil.getText(this,
					"bilinear"));
			interpolationMethod.addItem(RasterToolsUtil.getText(this,
	...
	/**
	 * Obtiene el método de interpolación 0 para vecino más cercano, 1 para
	 * bilinear y 2 para convoluvión cúbica
	 * 
	...
	public int getSelectedInterpolationMethod() {
		if (interpolationMethod != null && getPolynomial().isSelected()) {
			...
			case 0:
				return GridInterpolated.INTERPOLATION_NearestNeighbour;
			case 1:
				return GridInterpolated.INTERPOLATION_Bilinear;
			case 2:
				return GridInterpolated.INTERPOLATION_BicubicSpline;
			}
		}
		return -1;
	}
	...
	public void setInterpolationMethod(int interpolationMethod) {
		...
		case GridInterpolated.INTERPOLATION_NearestNeighbour:
			getInterpolationMethod().setSelectedIndex(0);
			break;
		case GridInterpolated.INTERPOLATION_Bilinear:
			getInterpolationMethod().setSelectedIndex(1);
			break;
		case GridInterpolated.INTERPOLATION_BicubicSpline:
	 ...
	 * 
	 * @return constante definida en Georeferencing con el algoritmo
	 *         seleccionado
	 */
