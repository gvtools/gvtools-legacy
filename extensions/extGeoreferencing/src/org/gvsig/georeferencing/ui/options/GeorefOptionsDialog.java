 ...
 */
public class GeorefOptionsDialog extends JPanel implements IWindow,
		IWindowListener {
	 ...
	 */
	public GeorefOptionsDialog(int polynomialDegree,
	 ...
	 * 
	 * @return entero con el tipo de algoritmo. Es una constante definida en la
	...
	public int getInterpolationMethod() {
		return geoOptionsPanel.getAlgorithmSelectionPanel()
	...
	public void setInterpolationMethod(int interpolationMethod) {
		geoOptionsPanel.getAlgorithmSelectionPanel().setInterpolationMethod(
				interpolationMethod);
	}
	...
	public void setBackGroundColor(Color c) {
		geoOptionsPanel.getCheckOptionsPanel().getBackGroundColorSelector()
				.setColor(c);
	}
	...
	public Color getBackGroundColor() {
		return geoOptionsPanel.getCheckOptionsPanel()
				.getBackGroundColorSelector().getColor();
	}
	...
	public Color getTextColor() {
		return geoOptionsPanel.getCheckOptionsPanel().getTextSelector()
				.getColor();
	}
	...
	public void setThresholdError(double threshold) {
		geoOptionsPanel.getCheckOptionsPanel().getThresholdError()
				.setValue(new Double(threshold).toString());
	}
}
