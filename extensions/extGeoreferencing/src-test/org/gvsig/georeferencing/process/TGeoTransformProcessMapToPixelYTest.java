 ...
 * transformacion (de coordenadas mapa a coordenadas pixel para las Y), con los
...
public class TGeoTransformProcessMapToPixelYTest extends TestCase {
	...
	public void testStack() {
		...
		double A0[][] = { { 6948.25, 5135, 8722.25 },
