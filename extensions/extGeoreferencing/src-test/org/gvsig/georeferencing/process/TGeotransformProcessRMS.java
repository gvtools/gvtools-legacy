 ...
 * de control. Compara las coordenadas aproximadas tras el calculo de los
 * polinomios de transformación. El punto en coordenadas mapa que se evalua es
 * (1500,2500). Se comprueban los errores obtenidos tras el proceso con los
...
public class TGeotransformProcessRMS extends TestCase {
	...
	public void testStack() {
		...
		// Se evaluan los RMS de los tres puntos de partida y se comparan con
		// los obtenidos
		...
		assertEquals(x_1, resultado.getCoordPixel(1369.000000, 2985.750000)[0],
				0.1);
		assertEquals(y_1, resultado.getCoordPixel(1369.000000, 2985.750000)[1],
				0.1);

		assertEquals(x_2, resultado.getCoordPixel(1673.500000, 2803.250000)[0],
				0.1);
		assertEquals(y_2, resultado.getCoordPixel(1673.500000, 2803.250000)[1],
				0.1);

		assertEquals(x_3, resultado.getCoordPixel(2092.500000, 2933.250000)[0],
				0.1);
		assertEquals(y_3, resultado.getCoordPixel(2092.500000, 2933.250000)[1],
				0.1);

		GeoPointList list = resultado.getGpcs();

		// Comparativa del error en x
		assertEquals(Math.pow(x_1 - gpl.get(0).pixelPoint.getX(), 2),
				list.get(0).getErrorX(), 0.001);
		assertEquals(Math.pow(x_2 - gpl.get(1).pixelPoint.getX(), 2),
				list.get(1).getErrorX(), 0.001);
		assertEquals(Math.pow(x_3 - gpl.get(2).pixelPoint.getX(), 2),
				list.get(2).getErrorX(), 0.001);

		// Comparativa del error en y
		assertEquals(Math.pow(y_1 - gpl.get(0).pixelPoint.getY(), 2),
				list.get(0).getErrorY(), 0.001);
		assertEquals(Math.pow(y_2 - gpl.get(1).pixelPoint.getY(), 2),
				list.get(1).getErrorY(), 0.001);
		assertEquals(Math.pow(y_3 - gpl.get(2).pixelPoint.getY(), 2),
				list.get(2).getErrorY(), 0.001);

		double rms1 = Math.sqrt(Math.pow(x_1 - gpl.get(0).pixelPoint.getX(), 2)
				+ Math.pow(y_1 - gpl.get(0).pixelPoint.getY(), 2));
		double rms2 = Math.sqrt(Math.pow(x_2 - gpl.get(1).pixelPoint.getX(), 2)
				+ Math.pow(y_2 - gpl.get(1).pixelPoint.getY(), 2));
		double rms3 = Math.sqrt(Math.pow(x_3 - gpl.get(2).pixelPoint.getX(), 2)
				+ Math.pow(y_3 - gpl.get(2).pixelPoint.getY(), 2));
