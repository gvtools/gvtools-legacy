...
public class I18nPreferencePage extends AbstractPreferencePage implements
			...
			try {
				...
				if (installedLocales == null || installedLocales.length == 0) {
					JOptionPane
							.showMessageDialog(
									this,
									Messages.getText("I18nPreferencePage.idiomas_no_encontrados_para_instalar"),
									Messages.getText("I18nPreferencePage.error_instalar_idiomas"),
									JOptionPane.ERROR_MESSAGE);
				} else {
					StringBuffer msg = new StringBuffer(
							Messages.getText("I18nPreferencePage.idiomas_instalados"));
					...
					JOptionPane
							.showMessageDialog(
									this,
									msg.toString(),
									Messages.getText("I18nPreferencePage.instalar_idiomas"),
	...
	private void exportLocaleForUpdate() {
		...
		if (locales == null) {
			...
			LocaleItem[] items = getLocaleItemsForSelection(
					manager.getInstalledLocales(), locales);
			...
			if (items != null && items.length > 0) {
				...
				selected = (LocaleItem) JOptionPane
						.showInputDialog(
								this,
								Messages.getText("I18nPreferencePage.seleccione_idioma_referencia"),
								Messages.getText("I18nPreferencePage.exportar_idioma"),
			...
			if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
				...
				try {
					...
					JOptionPane
							.showMessageDialog(
									this,
									Messages.getText("I18nPreferencePage.exportado_textos_idioma")
											+ " " + saveFile,
									Messages.getText("I18nPreferencePage.exportar_idioma"),
									JOptionPane.INFORMATION_MESSAGE);
				} catch (I18nException ex) {
	...
	private void exportLocaleForTranslation() {
		...
		if (refLocales == null) {
			JOptionPane
					.showMessageDialog(
							this,
							Messages.getText("I18nPreferencePage.seleccione_idioma_actualizar"),
							Messages.getText("I18nPreferencePage.error_actualizar_idioma"),
							JOptionPane.ERROR_MESSAGE);
		} else {

			// Select the locale to translate
			LocaleItem[] items = getLocaleItemsForSelection(
					Locale.getAvailableLocales(), manager.getInstalledLocales());
			LocaleItem selected = (LocaleItem) JOptionPane
					.showInputDialog(
							this,
							Messages.getText("I18nPreferencePage.seleccione_idioma_traducir"),
							Messages.getText("I18nPreferencePage.exportar_idioma"),
			...
			if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
				...
				try {
					...
					JOptionPane
							.showMessageDialog(
									this,
									Messages.getText("I18nPreferencePage.idioma_preparado_traducir")
	...
	private String getLocaleJarFileName(Locale locale) {
		return manager.getDisplayName(locale, I18nManager.ENGLISH)
				.replace(' ', '_').concat(EXPORT_ZIP_FILE_EXTENSION);
	}
	...
	private void uninstallSelectedLocale() {
		...
		if (locales == null) {
			JOptionPane
					.showMessageDialog(
							this,
							Messages.getText("I18nPreferencePage.seleccione_idioma_desinstalar"),
							Messages.getText("I18nPreferencePage.error_desinstalar_idioma"),
							JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		for (int i = 0; i < locales.length; i++) {
			...
			if (locales[i].equals(manager.getCurrentLocale())) {
				JOptionPane
						.showMessageDialog(
								this,
								Messages.getText("I18nPreferencePage.idioma_actual_no_puede_desinstalar"),
								Messages.getText("I18nPreferencePage.error_desinstalar_idioma"),
								JOptionPane.ERROR_MESSAGE);
			} else {
				int option = JOptionPane
						.showConfirmDialog(
								this,
								Messages.getText("I18nPreferencePage.seguro_desea_desinstalar_idioma")
										+ " "
										+ manager.getDisplayName(locales[i])
										+ "?",
								Messages.getText("I18nPreferencePage.confirmar_desinstalar_idioma"),
	...
	private Component getButtonsPanel() {
		...
		JButton newLocaleButton = new JButton(
				Messages.getText("I18nPreferencePage.Instalar"));
		...
		constraints.gridx = 0;
		constraints.insets = btInsets;
		JButton removeLocaleButton = new JButton(
				Messages.getText("I18nPreferencePage.Desinstalar"));
		...
		constraints.gridx = 0;
		constraints.insets = btInsets;
		JButton exportLocaleButton = new JButton(
				Messages.getText("I18nPreferencePage.exportar_actualizar"));
		...
		constraints.gridx = 0;
		constraints.insets = btInsets;
		JButton exportNewLocaleButton = new JButton(
				Messages.getText("I18nPreferencePage.exportar_traducir"));
	...
	private Component getActiveLocaleLabel() {
		JTextArea textArea = new JTextArea(
				Messages.getText("I18nPreferencePage.ayuda"));
	...
	private Component getCollaborationLabel() {
		JTextArea textArea = new JTextArea(
				Messages.getText("I18nPreferencePage.colaboracion"));
		textArea.setEditable(false);
		textArea.setAutoscrolls(true);
		textArea.setLineWrap(true);
		textArea.setWrapStyleWord(true);
