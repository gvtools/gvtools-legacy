...
public class ProjectMapFactory extends ProjectDocumentFactory {
	...
	public ImageIcon getButtonIcon() {
		// return new
		// ImageIcon(ProjectMap.class.getClassLoader().getResource("images/mapas.png"));
	...
	public ImageIcon getSelectedButtonIcon() {
		// return new
		// ImageIcon(ProjectMap.class.getClassLoader().getResource("images/mapas_sel.png"));
	...
	public ProjectDocument create(Project project) {
		String mapName = "";
		String aux = PluginServices.getText(this, "untitled");
		int numMaps = ((Integer) ProjectDocument.NUMS.get(registerName))
				.intValue();
		mapName = aux + " - " + numMaps++;
		if (project != null) {
	...
	public boolean resolveImportXMLConflicts(XMLEntity root, Project project,
		...
		XMLEntity xmlViews = root.firstChild("type",
				ProjectViewFactory.registerName);
		XMLEntity xmlTables = root.firstChild("type",
				ProjectTableFactory.registerName);

		Hashtable mapsConflits = (Hashtable) conflicts
				.get(ProjectMapFactory.registerName);

		Hashtable viewsConflits = (Hashtable) conflicts
				.get(ProjectViewFactory.registerName);
