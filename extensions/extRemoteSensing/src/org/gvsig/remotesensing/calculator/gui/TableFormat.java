...
/**
 * Clase que define el modelo de tabla variable- valor. La tabla contiene dos
 * columnas una con el identificador de la variable y otra con la banda asociada
 * a la variable.
 * 
...
public class TableFormat {
	...
	final String[] headers = { PluginServices.getText(this, "variable"),
	...
	public JTable getTableFormat() {
		if (jTableVariables == null) {
			...
			jTableVariables.getColumn(PluginServices.getText(this, "variable"))
					.setResizable(true);
			jTableVariables.getColumn(PluginServices.getText(this, "variable"))
					.setPreferredWidth(60);
			jTableVariables.getColumn(PluginServices.getText(this, "valor"))
					.setResizable(true);
			...
			MouseListener ml = new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					if (e.getClickCount() == 2) {
						...
						textExpresion.insert(s,
								textExpresion.getCaretPosition());
					} else {
	...
	/**
	 * Indica si la tabla está en espera de un valor para asignar a una variable
	 * 
	...
	/**
	 * Establece el valor de la propiedad que indica si se espera un valor para
	 * la tabla
	 * 
	 * @param enEspera
	 */
	 ...
	 * 
	 * @param row
	 *            fila en la que está la variable
	 * @param valor
	 *            nuevo valor que se le asigna
	 * 
	 */
