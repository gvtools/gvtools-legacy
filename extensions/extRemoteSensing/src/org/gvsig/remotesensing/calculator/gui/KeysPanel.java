...
public class KeysPanel extends JPanel implements ActionListener {
	 ...
	 * Constructor
	 * 
	 * @param m_TextExpression
	 *            area de texto donde se reliza la escritura de los caracteres
	 */
	...
	private void Inicializar() {
		...
		TableLayout thisLayout = new TableLayout(new double[][] {
				{ TableLayout.PREFERRED, 1.0, TableLayout.PREFERRED,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(jButton0)) {
			...
			textExpression
					.setCaretPosition(textExpression.getCaretPosition() - 1);
		}
	}
