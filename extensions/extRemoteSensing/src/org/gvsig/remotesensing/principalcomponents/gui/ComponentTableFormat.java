...
class ComponentTableFormat extends AbstractTableModel {
	...
	final String[] columnNames = { PluginServices.getText(this, "componente"),
			PluginServices.getText(this, "autovalor"), "%", "" };
	 ...
	 * @param número
	 *            de columna
	 * @return nombre de la columna correspondiente al indice que se pasa como
	 *         parámetro
	 */
	 ...
	 *            indice de la banda
	 * @param autovalor
	 *            autovalor asociado al componente
	 * @param vj
	 *            porcentaje variabilidad
	 * @param b
	 *            seleccionado o no
	 */
	public void addRow(int band, double autovalor, double vj, boolean b) {
		...
		// Objeto a añadir
		Object[] newRow = { "C" + (band + 1), new Double(autovalor),
				new Double(vj), new Boolean(b) };
