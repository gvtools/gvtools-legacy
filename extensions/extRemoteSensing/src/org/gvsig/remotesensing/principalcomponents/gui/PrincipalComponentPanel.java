...
/**
 * Clase que define la interfaz para la selección de parámetros para el análisis
 * de componentes principales. Para la imagen seleccionada se toman las bandas
 * marcadas para el cálculo de estadísticas como matriz de varianza-covarianza,
...
public class PrincipalComponentPanel extends DefaultButtonsPanel implements
		IWindow, ActionListener, FocusListener, ButtonsPanelListener,
		IProcessActions {
	...
	public WindowInfo getWindowInfo() {
		...
		m_viewinfo.setTitle(PluginServices
				.getText(this, "principal_components"));
	...
	private void Inicializar() {
		...
		this.setBorder(new CompoundBorder(topBorder, new EmptyBorder(10, 10,
				10, 10)));
	...
	public JPanel getCenterPanel() {
		...
		if (centerPanel == null) {
			...
			p.setLayout(bd);
			p.setBorder(new CompoundBorder(topBorder, new EmptyBorder(5, 5, 5,
					5)));
	...
	public JPanel getPanelImagen() {
		...
		if (panelImagen == null) {
			...
			topBorder.setTitlePosition(TitledBorder.TOP);
			panelImagen.setBorder(new CompoundBorder(topBorder,
					new EmptyBorder(2, 2, 2, 2)));
			JPanel p = new JPanel();

			TableLayout thisLayout = new TableLayout(new double[][] { { 250 },
