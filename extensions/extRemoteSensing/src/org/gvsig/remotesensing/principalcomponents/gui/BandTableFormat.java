...
/**
 * Clase que define el modelo de tabla contenida PrincipalComponentPanel. La
 * tabla contiene dos columnas una con el identificador de la banda y otra con
 * el check box para su seleccion
 * 
...
public class BandTableFormat extends AbstractTableModel {
	...
	public void setOnlyTwoSelecction(boolean onlyTwo) {
