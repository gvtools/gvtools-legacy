...
/**
 * Clase que define el comportamiento para los eventos de un
 * ZProfileOptionsPanel.
 * 
 * @author aMuÑoz (alejandro.munoz@uclm.es)
 * @version 11/3/2008
 */

public class ZProfileOptionsListener implements ButtonsPanelListener,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == optionsPanel.getNewButton()) {
			try {
				String roiName = PluginServices.getText(this, "point")
	...
	/**
	 * Método que dibuja sobre la vista las rois del panel. y construye el
	 * gráfico correspondiente a todas las rois definidas en el panel.
	 * */
