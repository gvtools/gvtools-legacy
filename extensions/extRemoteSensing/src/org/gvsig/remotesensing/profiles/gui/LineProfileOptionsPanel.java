...
/**
 * Panel para los lineProfiles. Contiene la tabla y los controles asociados para
 * añadir y eliminar nuevos profiles.
 * 
...
public class LineProfileOptionsPanel extends JPanel {
	...
	/**
	 * Tabla que muestra la información asociada a cada una de las lineas cuyo
	 * perfil se quiere extraer La información para cada linea es:
	 * identificador, color asociado, valor maximo, valor mínimo y valor medio
	 * */
	...
	public JToggleButton getDeleteButton() {
		if (deleteButton == null) {
			...
			ImageIcon icono = new ImageIcon(LineProfileOptionsPanel.class
	...
	public JToggleButton getNewButton() {
		if (newButton == null) {
			...
			ImageIcon icono = new ImageIcon(LineProfileOptionsPanel.class
					.getClassLoader().getResource("images/Line.png"));
	...
	/**
	 * Metodo que asigna el cursor asociado al dibujado de la linea y asigna la
	 * herramienta drawLineROI
	 */

	public void selectDrawRoiTool() {
		if (mapControl != null) {
			if (getNewButton().isSelected()) {
				Image img = new ImageIcon(LineProfileOptionsPanel.class
						.getClassLoader().getResource("images/LineCursor.png"))
						.getImage();
	...
	/**
	 * @param roiName
	 *            identificador de la roi
	 * @return arraylist con los graphics de la roi cuyo nombre se pasa como
	 *         parámetro
	 * */
	...
	/**
	 * @return panel sobre el que se dibuja la grafica. Cada vez que se llama
	 *         este método se limpia el gráfico.
	 * */
	...
	/**
	 * Método que elimina de la lista de rois del panel la roi cuyo nombre
