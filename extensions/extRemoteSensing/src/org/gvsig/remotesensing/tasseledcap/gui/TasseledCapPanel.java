...
/**
 * Clase que define la interfaz para el proceso de transformación Tasseled Cap
 * de una imagen. Recoge la imagen a clasificar y el tipo de
 * transformación.Posibilita configurar las opciones de salida.
 * 
...
public class TasseledCapPanel extends DefaultButtonsPanel implements
	...
	public JPanel getCenterPanel() {
		if (centerPanel == null) {
			...
			TitledBorder topBorder2 = BorderFactory
					.createTitledBorder(PluginServices.getText(this,
							"imagen_transformar"));
			;
			topBorder2.setTitlePosition(TitledBorder.TOP);
			p2.setBorder(new CompoundBorder(topBorder2, new EmptyBorder(5, 5,
					5, 5)));
	...
	public JPanel getPanelImagen() {
		if (panelImagen == null) {
			...
			TableLayout thisLayout = new TableLayout(new double[][] {
					{ 5, 50, 150 }, { TableLayout.PREFERRED } });
	...
	public JPanel getPanelTipo() {
		if (panelTipo == null) {
			...
			JPanel p = new JPanel();
			TableLayout thisLayout = new TableLayout(new double[][] {
					{ 5.0, 50, 150 }, { TableLayout.PREFERRED } });
			thisLayout.setHGap(5);
			thisLayout.setVGap(5);
			p.setLayout(thisLayout);
	...
	public DefaultComboBoxModel getComboModel() {
		if (jComboBoxLayersModel == null) {
			jComboBoxLayersModel = new DefaultComboBoxModel(
					getLayerNames(TIPOLANDSAT_MS));
		}
	...
	/**
	 * actualiza el combo de imágenes con las que se ajustan al tipo pasado como
	 * parametro
	 */
	...
	public void aplicar() {
		...
		if (filename != null) {
			...
			process.addParam("type", new Integer(getComboTipos()
					.getSelectedIndex()));
