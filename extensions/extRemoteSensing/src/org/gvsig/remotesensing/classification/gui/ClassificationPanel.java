...
public class ClassificationPanel extends DefaultButtonsPanel implements PropertyListener, IWindow, IWindowListener, 
	 ...
	 */
	 private JPanel getPanelTab1(){	 
		if (panelTab1==null){
			...
			TitledBorder topBorder = BorderFactory.createTitledBorder(PluginServices.getText(this, "raster"));
			topBorder.setTitlePosition(TitledBorder.TOP);
			...
			TitledBorder topBorderMethod = BorderFactory.createTitledBorder(PluginServices.getText(this, "operation"));
			topBorder.setTitlePosition(TitledBorder.TOP);
	...
	public JPanel getOutputOptionsPanel() {
		if (nombreCapa==null){ 
			...
			gridBagConstraints.anchor = GridBagConstraints.WEST;
			gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
			nombreCapa.add(new JLabel((PluginServices.getText(this, "name") + ": "),SwingConstants.RIGHT ),gridBagConstraints);
