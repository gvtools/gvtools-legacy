 ...
 * los metodos de clasificación. Recoge procedimientos comunes a todos los
 * metodos: construccion del grid que se va a clasificar, asignacion de la
 * leyenda a la capa resultante o escritura en fichero. Cada procedimiento de
 * clasificación implementará los métodos que determinan la clase a la que
 * pertenece un pixel, además del metodo run().
 * 
...
public abstract class ClassificationGeneralProcess extends RasterProcess {
	...
	/**
	 * Método que determina la clase de pertenencia del pixel cuyos valores por
	 * banda se pasan en un array de bytes.
	 * 
	 * @param valores
	 *            del pixel en cada una de las bandas
	...
	/**
	 * Método que determina la clase de pertenencia del pixel cuyos valores por
	 * banda se pasan en un array de shorts.
	 * 
	 * @param valores
	 *            del pixel en cada una de las bandas
	 * @return clase a la que pertenece el pixel
	...
	/**
	 * Método que determina la clase de pertenencia del pixel cuyos valores por
	 * banda se pasan en un array de int.
	 * 
	 * @param valores
	 *            del pixel en cada una de las bandas
	 * @return clase a la que pertenece el pixel
	...
	/**
	 * Método que determina la clase de pertenencia del pixel cuyos valores por
	 * banda se pasan en un array de float.
	 * 
	 * @param valores
	 *            del pixel en cada una de las bandas
	 * @return clase a la que pertenece el pixel
	...
	/**
	 * Método que determina la clase de pertenencia del pixel cuyos valores por
	 * banda se pasan en un array de double.
	 * 
	 * @param valores
	 *            del pixel en cada una de las bandas
	 * @return clase a la que pertenece el pixel
