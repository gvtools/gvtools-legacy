...
public class RemoteSensingUtils {
	...
	/**
	 * Asigna a la capa <code>lyr</code> una leyenda construida a partir de un
	 * <code>ArrayList</code> de <code>ColorItem</code>.
	 * 
	 * @param lyr
	 *            capa a la que se asigna la leyenda
	 * @param colorItems
	 *            ColorItems con los que se contruye la leyenda
	 * 
	 * @throws FilterTypeException
	 */
	public static void setLeyend(FLayer lyr, ArrayList colorItems)
			throws FilterTypeException {
	...
	public static double getCellValueInLayerCoords(IBuffer buffer, int x,
			int y, int band) throws InterruptedException {
		...
		} else if ((iType == RasterBuffer.TYPE_SHORT)
				| (iType == RasterBuffer.TYPE_USHORT)) {
