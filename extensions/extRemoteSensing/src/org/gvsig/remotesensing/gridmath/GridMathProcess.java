...
/**
 * GridMathProcess implenta la funcionalidad para el cálculo de operaciones entre grids.
 * El proceso permite hacer operaciones matemáticas entre los valores de las bandas de la misma imagen o entre 
 * diferentes imágenes bajo ciertas restricciones espaciales (siempre sobre los datos originales). 
 *	
