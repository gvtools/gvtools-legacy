...
public class ClassEditorPanelListener implements ActionListener,
	...
	public ClassEditorPanelListener(ClassEditorPanel classEditorPanel) {
		...
		dialog = JColorChooser.createDialog(classEditorPanel.getJButtonColor(),
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == classEditorPanel.getJButtonColor()) {
			...
			classEditorPanel.getJButtonColor().setBackground(
	...
	public void actionButtonPressed(ButtonsPanelEvent e) {
		...
		if (e.getButton() == ButtonsPanel.BUTTON_ACCEPT) {
			DefaultGraphCell cell = classEditorPanel.getDecisionTreePanel()
					.getSelectedCell();
			DecisionTreeNode node = (DecisionTreeNode) cell.getUserObject();
			node.setClassID(Integer.valueOf(
					classEditorPanel.getJtextValue().getText()).intValue());
			classEditorPanel
					.getDecisionTreePanel()
					.getDecisionTree()
					.getColorTable()
					.put(new Integer(node.getClassID()),
	...
	private void close() {
		try {
			PluginServices.getMDIManager().closeWindow(
					classEditorPanel.getClassEditorDialog());
