...
public class DecisionTreeNode {
	...
	/**
	 * 
	 * @return <code>true</code> si la evaluación de la expresión da como
	 *         resultado un valor distinto de 0;
	 */
	...
	/**
	 * 
	 * @return <code>true</code> si todas las expresiones del subárbol que
	 *         radica en este nodo están libres de errores de sintaxis.
	 */
	public boolean hasError() {
		if (expression == null)
			return true;
		else
			return (parser.hasError() && getLeftChild().hasError() && getRightChild()
					.hasError());
	}
	...
	/**
	 * Asigna a la variable con nombre <code>varName</code> el valor
	 * <code>value</code>
	 * 
	 * @param varName
	...
	public void setChildren(DecisionTreeNode leftChild,
