...
//		 Caso Bufer tipo int
	...
	private void processIHS(short[][] bufferInput, int iLine) throws InterruptedException {    	
	...
	private void processIHS(int [][] bufferInput, int iLine) throws InterruptedException {    	
	...
	private void processIHS(float [][] bufferInput, int iLine) throws InterruptedException {    	
	...
	private void processIHS(double [][] bufferInput, int iLine) throws InterruptedException {    	
