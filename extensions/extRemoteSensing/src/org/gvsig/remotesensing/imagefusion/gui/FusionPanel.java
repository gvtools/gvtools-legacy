...
public class FusionPanel extends JPanel implements IPreviewRenderProcess {
	...
	private PreviewBasePanel getPreviewBasePanel() {
		if (previewBasePanel == null) {
			...
			previewBasePanel = new PreviewBasePanel(list, null, panelOptions(),
					this, (FLyrRasterSE) layer);
	 ...
	 * 
	 * @see
	 * org.gvsig.raster.beans.previewbase.IPreviewRenderProcess#isShowPreview()
	 */
	 ...
	 * 
	 * @see
	 * org.gvsig.raster.beans.previewbase.IPreviewRenderProcess#setShowPreview
	 * (boolean)
	 */
