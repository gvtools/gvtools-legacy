...
/**
 * Es el panel central del panel de fusion. Se compone de un panel de seleccion
 * de la banda de alta resolución, de una parte central en la que se selecciona
 * el método de fusion y los parámetros propisos del método y el fichero de
 * salida.
 * 
...
public class FusionMainPanel extends JPanel implements IUserPanelInterface {
	...
	public JPanel getCentralPanel() {
		if (centralPanel == null) {
			...
			centralPanel.add(getPanel(0).getParameterPanel(),
					BorderLayout.CENTER);
			first = false;
	...
	public JPanel getMethodPanel() {
		if (methodPanel == null) {
			...
			TitledBorder topBorder = BorderFactory
					.createTitledBorder(PluginServices.getText(this, "method"));
			topBorder.setTitlePosition(TitledBorder.TOP);
			methodPanel.setBorder(new CompoundBorder(topBorder,
	...
	public JComboBox getJComboMethods() {
		if (jComboMethods == null) {
			...
			jComboMethods.addItem(PluginServices.getText(this,
					"wavelets_atrous"));
	...
	/**
	 * @return PCAPara,eterPanel para la selección de parámetros para el método
	 *         de fusion PCA
	 * */
