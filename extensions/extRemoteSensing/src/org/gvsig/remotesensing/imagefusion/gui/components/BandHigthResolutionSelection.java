...
/**
 * Componente para la seleccion de la banda de alta resolución. Permite abrir el
 * fichero en el que se encuentra la banda pancromática y seleccionar la banda
 * en cuestión.
 * 
 * @version 27/02/2008
 ...
 * 
 */
public class BandHigthResolutionSelection extends JPanel implements
		ActionListener {
	...
	public void init() {
		...
		TitledBorder topBorder = BorderFactory
				.createTitledBorder(PluginServices.getText(this, "band_high"));
	...
	/**
	 * Muestra el dialogo de selección de fichero para la carga de la capa con
	 * la banda de alta resolucion
	 * 
