...
/**
 * Clase que define el diagrama de puntos. Personalización de un modelo
 * concretro de grafico extraido de jfreechart. Esta clase define sobreescribe
 * de forma personalizada los metodos getRangeX() y getRangeY().
 * 
...

{
	 ...
	 * 
	 * @param data
	 *            datos que se muestran en el diagrama (<code>null</code>
	 *            permitted).
	 * @param domainAxis
	 *            rango en eje x.
	 * @param rangeAxis
	 ...
	 * 
	 */
	public ScatterPlotChart(float[][] data, ValueAxis domainAxis,
			ValueAxis rangeAxis) {
