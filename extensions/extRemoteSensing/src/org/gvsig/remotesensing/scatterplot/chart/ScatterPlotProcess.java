...
public class ScatterPlotProcess extends RasterProcess {
	...
	/**
	 * Metodo que construye el grafico inicialmente. Antes de construirlo, llama
	 * a setDataChart() para cargar los datos a representar
	 * 
	 * @throws InterruptedException
	 * 
	 * */
	private void createChart(Color colorChart, Color colorBackground,
			Color colorExternal) throws InterruptedException {
		...
		chart = new JFreeChart(PluginServices.getText(this,
				"diagrama_dispersion"), plot);
		data = null;
	 ...
	 * @throws InterruptedException
	 * */
	public void setDataChart() throws InterruptedException {
