...
public class DecisionTreePersistenceTest extends TestCase {
	...
	public void testStack() {
		...
		assertEquals(xmlDecisionTree.toString(), decisionTree.getXMLEntity()
				.toString());

		/*
		 * FileOutputStream fos; try { //fos = new
		 * FileOutputStream("//home//dguerrero//Desktop//aa.xml");
		 * //OutputStreamWriter writer = new OutputStreamWriter(fos,
		 * "ISO-8859-1"); FileWriter writer = new
		 * FileWriter("//home//dguerrero//Desktop//aa.xml");
		 * //xmlTag.marshal(writer); Marshaller m = new Marshaller(writer);
		 * m.setEncoding("ISO-8859-1"); m.marshal(xmlDecisionTree.getXmlTag());
		 * 
		 * } catch (FileNotFoundException e) { // TODO Auto-generated catch
		 * block e.printStackTrace(); } catch (UnsupportedEncodingException e) {
		 * // TODO Auto-generated catch block e.printStackTrace(); } catch
		 * (MarshalException e) { // TODO Auto-generated catch block
		 * e.printStackTrace(); } catch (ValidationException e) { // TODO
