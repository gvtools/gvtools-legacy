...
/**
 * Este test prueba el proceso de construcción de la imagen resultante del
 * proceso de analisis de componentes principales de la imagen
 * pc_CreateImageTest.tif de dimensiones 4x4 y tres bandas.
 * 
...
public class TPCImageProcess extends TestCase {
	...
	public void testStack() {
		...
		PCStatistics pcStatistics = new PCStatistics(new Matrix(new double[][] {
				{ -0.922766631036, 0.2990630039783, 0.2430289371596 },
				{ -0.030678162029, -0.685664096085, 0.7272713370632 },
				{ 0.3841361672896, 0.6636460404393, 0.6418826512605 } }),
				new double[] { 425.104, 1753.227, 18714.369 }, null);
		...
		iProcess.addParam("selectedComponents", new boolean[] { true, true,
				true });
		iProcess.run();
