...
/**
 * <p>
 * Extends {@link StringUtilities StringUtilities} for adding support to replace
 * some problematic letters to their most equivalent.
 * </p>
 * 
...
public class StringUtilitiesExtended {
	/**
	 * <p>
	 * Replaces all letters with accent by their equivalent without it:
	 * <ul>
	...
	public static String replaceAllAccents(String s) {
		return s.replaceAll("[àáâä]", "a").replaceAll("[èéêë]", "e")
				.replaceAll("[ìíîï]", "i").replaceAll("[òóôö]", "o")
				.replaceAll("[ùúûü]", "u").replaceAll("[ÀÁÂÄ]", "A")
	...
	/**
	 * <p>
	 * Replaces all cedilla letters by the letter c:
	 * <ul>
	...
	/**
	 * <p>
	 * Replaces all n with tilde letters by n:
	 * <ul>
