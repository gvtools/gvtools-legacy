...
public class RepeatedChooseGeometryTypePanel extends JWizardPanel {
	...
	private static int NEW_LAYER_NAME_INDEX = 0;
	...
	private void initialize() {
        ...
        String new_layer_name = "Oracle - " + PluginServices.getText(this, "Capa") + " ";
        
        new_layer_name = new_layer_name + NEW_LAYER_NAME_INDEX;
        getJTextFieldLayerName().setText(new_layer_name);
        NEW_LAYER_NAME_INDEX++;
	}
