...
/**
 * This panel contains the rigth panel of the "Set Geometry" panel. It is the
 * imput to write the file size in bytes, the data type, the byte order and the
...
public class GeometryPropertiesRigthPanel extends JPanel {
	...
	private JPanel getByteOrderLabelPanel() {
		if (byteOrderLabelPanel == null) {
			...
			byteOrderLabelPanel.setPreferredSize(new java.awt.Dimension(
	...
	private JPanel getInterleavingLabelPanel() {
		if (interleavingLabelPanel == null) {
			...
			interleavingLabel.setText(PluginServices.getText(this,
					"type_of_interleaving"));
			FlowLayout flowLayout1 = new FlowLayout();
			flowLayout1.setAlignment(java.awt.FlowLayout.LEFT);
			interleavingLabelPanel = new JPanel();
			interleavingLabelPanel.setLayout(flowLayout1);
			interleavingLabelPanel.setPreferredSize(new java.awt.Dimension(
					LABELS_WIDTH, LABELS_HEIGHT));
	...
	private JPanel getDataTypeLabelPanel() {
		if (dataTypeLabelPanel == null) {
			...
			dataTypeLabelPanel.setPreferredSize(new java.awt.Dimension(
					LABELS_WIDTH, LABELS_HEIGHT));
	...
	private JPanel getFileSizeLabelPanel() {
		if (fileSizeLabelPanel == null) {
			...
			fileSizeLabel.setText(PluginServices.getText(this,
					"file_size_in_bytes"));
			...
			fileSizeLabelPanel.setPreferredSize(new java.awt.Dimension(
					LABELS_WIDTH, LABELS_HEIGHT));
	...
	private JPanel getFileSizeTextPanel() {
		if (fileSizeTextPanel == null) {
			...
			fileSizeTextPanel.setPreferredSize(new java.awt.Dimension(
	...
	private JPanel getDataTypeTextPanel() {
		if (dataTypeTextPanel == null) {
			...
			dataTypeTextPanel.setPreferredSize(new java.awt.Dimension(
					TEXTS_WIDTH, TEXTS_HEIGHT));
	...
	private JPanel getInterleavingTextPanel() {
		if (interleavingTextPanel == null) {
			...
			interleavingTextPanel.setPreferredSize(new java.awt.Dimension(
					TEXTS_WIDTH, TEXTS_HEIGHT));
	...
	private JPanel getByteOrderTextPanel() {
		if (byteOrderTextPanel == null) {
			...
			byteOrderTextPanel.setPreferredSize(new java.awt.Dimension(
					TEXTS_WIDTH, TEXTS_HEIGHT));
	...
	private JTextField getFileSizeText() {
		if (fileSizeText == null) {
			...
			fileSizeText.setPreferredSize(new Dimension(TEXTS_WIDTH,
					TEXTS_HEIGHT));
	...
	private JComboBox getDataTypeText() {
		if (dataTypeText == null) {
			...
			dataTypeText.setPreferredSize(new Dimension(TEXTS_WIDTH,
					TEXTS_HEIGHT));
		}
		return dataTypeText;
	}
	...
	private JComboBox getByteOrderText() {
		if (byteOrderText == null) {
			...
			byteOrderText.setPreferredSize(new Dimension(TEXTS_WIDTH,
					TEXTS_HEIGHT));
		}
	...
	private JComboBox getInterleavingText() {
		if (interleavingText == null) {
			...
			interleavingText.setPreferredSize(new Dimension(TEXTS_WIDTH,
					TEXTS_HEIGHT));
		}
	...
	public String getByteOrder() {
		return ((VRTFormatOptions.UIOption) getByteOrderText()
	...
	public String getInterleaving() {
		return ((VRTFormatOptions.UIOption) getInterleavingText()
				.getSelectedItem()).getVrtOptionName();
	}
}