...
public class VRTFormatUtils {
	...
	public static String getImageOffset(VRTFileCreator fileCreator, int band) {
		return getImageOffset(fileCreator.getDataSize(),
				fileCreator.getHeaderSize(), fileCreator.getInterleaving(),
				band, fileCreator.getBands(), fileCreator.getImageWidth(),
	 ...
	 *            Type of each pixel
	 * @param interLeaving
	 *            Type of interleaving Band number
	 * @param numBands
	 *            Number of bands
	 * @param width
	 *            Image width
	 * @return ImageOffSet parameter value
	 */
	public static String getLineOffset(int dataSize, String interLeaving,
			int numBands, int width) {
	...
	public static String getLineOffset(VRTFileCreator fileCreator) {
		return getLineOffset(fileCreator.getDataSize(),
				fileCreator.getInterleaving(), fileCreator.getBands(),
	 ...
	 * @return ImageOffSet parameter value
	 */
	public static String getPixelOffset(int dataSize, String interLeaving,
			int numBands) {
		int pixelOffSet = 0;
		if (interLeaving.equals(VRTFormatOptions.INTERLEAVING_PIXEL)) {
