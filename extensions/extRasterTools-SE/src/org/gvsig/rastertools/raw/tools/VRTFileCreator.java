...
public class VRTFileCreator {
	...
	/**
	 * Creates the header of the VRTDataset XML tag. It contains the width and
	 * the height.
	 * 
	...
	/**
	 * Creates the header of the VRTRasterBand XML tag. It contains the image
	 * data type.
	 * 
	...
	/**
	 * Creates the ImageOffset XML tag: The image data starts from the byte
	...
	/**
	 * @param outputHeaderFormat
	 *            The outputHeaderFormat to set.
	 */
