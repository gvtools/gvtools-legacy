...
/**
 * Behavior que espera un listener de tipo GeoMoveListener. Nacho Brodin
 * (nachobrodin@gmail.com)
 * 
 */
public class GeoRasterBehavior extends Behavior {
	...
	public FLyrRasterSE getLayer() {
		// Cuando cargamos desde el menú contextual la capa es asignada de forma
		// fija
		if (lyr != null)
			return lyr;
