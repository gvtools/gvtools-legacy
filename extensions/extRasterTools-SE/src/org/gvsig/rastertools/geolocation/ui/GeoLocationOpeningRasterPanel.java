 ...
 * transformación que está aplicandose en esos momentos al raster. Tenemos
 * también la posibilidad de introducir los parámetros con las esquinas superior
...
public class GeoLocationOpeningRasterPanel extends GeolocationBaseClassPanel {
	...
	private JTabbedPane getJTabbedPane() {
		if (coordsPanel == null) {
			...
			coordsPanel.addTab(PluginServices.getText(this, "transf"),
					transfPanel);
			coordsPanel.addTab(PluginServices.getText(this, "corners"),
					cornersPanel);
		}
		return coordsPanel;
	}
