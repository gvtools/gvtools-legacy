...
/**
 * <code>VectorizationTocMenuEntry</code> es el punto de entrada del menu de
 * vectorización.
 * 
 * @version 12/06/2008
 * @author Nacho Brodin nachobrodin@gmail.com
 */
public class VectorizationTocMenuEntry extends AbstractTocContextMenuAction
	...
	public void execute(ITocItem item, FLayer[] selectedItems) {
		...
		long size = RasterUtilities
				.getBytesFromRasterBufType(lyr.getDataType()[0]);
	...
	public void end(Object param) {
		...
		GrayConversionListener grayConvList = new GrayConversionListener(lyr,
				grayConvPanel, grayConvData);
		StretchListener stretchListener = new StretchListener(lyr,
				stretchPanel, stretchData);
		VectorListener vectorList = new VectorListener(lyr, vectorPanel,
				vectorData);
		...
		MainListener vectListener = new MainListener(lyr, mainPanel,
				grayConvList, clipList, vectorList, stretchListener);
		if (grayScaleConversion) {
