 ...
 */
public class SelectionAreaPanel extends BasePanel implements ActionListener,
		TableModelListener {
	...
	public JRadioButton getAreaSelector() {
		if (areaSelect == null) {
			areaSelect = new JRadioButton(RasterToolsUtil.getText(this,
					"porarea"));
	...
	public JRadioButton getROISelector() {
		if (roiSelect == null) {
			roiSelect = new JRadioButton(
					RasterToolsUtil.getText(this, "porroi"));
	...
	/**
	 * Obtiene el botón de vectorización de todo lo que hay en el interior de la
	 * bounding box.
	 * 
	 * @return JRadioButton
	 */
	public JRadioButton getVectorizeAllBBox() {
		if (vectorizeBBoxSelect == null) {
			vectorizeBBoxSelect = new JRadioButton(RasterToolsUtil.getText(
					this, "vectbbox"));
		}
	...
	public JRadioButton getVectorizeOnlyInside() {
		if (vectorizeOnlyInside == null) {
			vectorizeOnlyInside = new JRadioButton(RasterToolsUtil.getText(
					this, "vectinside"));
		}
	...
	public ButtonBarContainer getButtonBarContainer() {
		if (buttonBarContainer == null) {
			...
			buttonBarContainer.addButton("fullExtent.png",
					RasterToolsUtil.getText(this, "fullExtent"), 0);
			buttonBarContainer.addButton("selectTool.png",
					RasterToolsUtil.getText(this, "select_tool"), 1);
