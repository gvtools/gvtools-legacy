 ...
 */
public class ClipPanel extends BasePanel implements ActionListener,
	...
	public JPanel getOutputScalePanel() {
		if (outputScalePanel == null) {
			...
			outputScalePanel.add(
					new JLabel(RasterToolsUtil.getText(this, "outputscale")),
					BorderLayout.WEST);
