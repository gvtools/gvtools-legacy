...
public class StretchData extends Observable {
	...
	private double[] histogram = new double[] { 0, 0, 3, 4, 5, 8, 7, 18, 45,
			36, 21, 36, 12, 23, 23, 40, 17, 10, 5, 1, 0, 0, 0 };
	...
	/**
	 * Asigna el modelo de datos de la capa gráfica. Este es el que contiene la
	 * lista de valores de los tramos.
	 */
	...
	/**
	 * Obtiene el histograma para asignarlo a la capa del canvas gráfico.
	 * 
	 * @return double[]
	 */
	...
	/**
	 * Asigna el histograma en el formato tabla obtenido desde el objeto
	 * Histogram. Es almacenado en formato double[] que es el necesario para la
	 * capa del canvas.
	 * 
	 * @param hist
	 */
	...
	public double getMax() {
		try {
			...
			RasterToolsUtil
					.debug("El valor de max de StretchSelectorData no es convertible a double",
							this, e);
		}
		return 0;
	}
	...
	public double getNInterval() {
		try {
			...
			RasterToolsUtil
					.debug("El valor de número de intervalos de StretchSelectorData no es convertible a double",
							this, e);
		}
		return 0;
	}
	...
	public double getSizeInterval() {
		try {
			...
			RasterToolsUtil
					.debug("El valor de tamaño de intervalo de StretchSelectorData no es convertible a double",
							this, e);
		}
		return 0;
	}
