 ...
 */
public class GrayConversionPanel extends BasePanel implements
	...
	protected void init() {
		setBorder(BorderFactory.createTitledBorder(null,
				RasterToolsUtil.getText(this, "grayescaleconversion"),
		...
		/*
		 * gbc.gridy = 2; add(getHighPassPanel(), gbc);
		 */
	...
	public JPanel getLevelPanel() {
		if (levelsPanel == null) {
			...
			levelsPanel.add(new JLabel(RasterToolsUtil.getText(this, "bands")),
					BorderLayout.WEST);
	 ...
	 */
	/*
	 * public HighPassPanel getHighPassPanel() { if(highPassPanel == null) {
	 * highPassPanel = new HighPassPanel(); } return highPassPanel; }
	 */
	...
	public void update(Observable o, Object arg) {
		...
		getPosterizationPanel().getLevels().setValue(
				data.getPosterizationLevels() + "");
