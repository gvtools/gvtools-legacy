...
public class GrayConversionData extends Observable {
	 ...
	 * 
	 * @return Entero con el valor del umbral. El umbral es el lado de la
	 *         ventana de píxeles a analizar.
	 */
	 ...
	 * 
	 * @param Entero
	 *            con el valor del umbral. El umbral es el lado de la ventana de
	 *            píxeles a analizar.
	 */
	...
	/**
	 * Obtiene el texto del desplegable de bandas. Este depende del número de
	 * bandas del raster de origen.
	 * 
	 * @return Lista de textos con la interpretación de las bandas con las que
	 *         se hará la posterización
	 */
	...
	/**
	 * Asigna el texto del desplegable de bandas. Este depende del número de
	 * bandas del raster de origen.
	 * 
	 * @param Lista
	 *            de textos con la interpretación de las bandas con las que se
	 *            hará la posterización
	 */
	 ...
	 * 
	 * @param Entero
	 *            con el tipo de banda. Debe corresponder a una constante
	 *            definida en la clase GrayScaleFilter
	 */
