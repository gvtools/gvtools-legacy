 ...
 */
public class PixelIncreaseDialog extends JPanel implements IWindow,
		MouseListener {
	...
	/**
	 * Posición en X e Y donde se comienza a dibujar dentro del inspector de
	 * pixeles
	 */
	private int posX = 0;
	private int posY = 0;
	/**
	 * Posición del pixel en X e Y en relación a las coordenadas del buffer de
	 * la vista
	 */
	public int pixX = 0;
	public int pixY = 0;
	...
	public PixelIncreaseDialog() {
		...
		if (active instanceof IView) {
			view = (IView) active;
			WindowInfo wInfo = PluginServices.getMDIManager().getWindowInfo(
					active);
		...
		CompoundBehavior
				.setAllControlsBehavior(new PixelIncreaseBehavior(this));
		initMenu();
	...
	/**
	 * Inicializa el menú contextual con las opciones de selección del zoom.
	 */
	 ...
	 * 
	 * @param posX
	 *            posición X del Graphics donde se empieza a dibujar
	 */
	 ...
	 * 
	 * @param posY
	 *            posición Y del Graphics donde se empieza a dibujar
	 */
