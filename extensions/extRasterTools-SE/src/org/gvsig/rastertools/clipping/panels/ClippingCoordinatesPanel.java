...
public class ClippingCoordinatesPanel extends JPanel {
	...
	/**
	 * Añade los listener a los controles que lo necesiten
	 * 
	 * @param list
	 */
	public void setClippingListener(ClippingPanelListener clippingPanelListener) {
		...
		getButtonBarContainer().getButton(0).addActionListener(
				clippingPanelListener);
		getButtonBarContainer().getButton(1).addActionListener(
				clippingPanelListener);
		getButtonBarContainer().getButton(2).addActionListener(
				clippingPanelListener);
		getButtonBarContainer().getButton(3).addActionListener(
				clippingPanelListener);
		getButtonBarContainer().getButton(4).addActionListener(
				clippingPanelListener);
	...
	public CoordinatesPanel getPixelCoordinates() {
		if (coordinatesPixel == null) {
			...
			coordinatesPixel.setTitlePanel(PluginServices.getText(this,
					"coordenadas_pixel"));
		}
	...
	public CoordinatesPanel getRealCoordinates() {
		if (coordinatesReales == null) {
			...
			coordinatesReales.setTitlePanel(PluginServices.getText(this,
					"coordenadas_reales"));
		}
	...
	public ButtonBarContainer getButtonBarContainer() {
		if (buttonBarContainer == null) {
			...
			buttonBarContainer.addButton("export.png",
					RasterToolsUtil.getText(this, "load_parameters"), 0);
			buttonBarContainer.addButton("import.png",
					RasterToolsUtil.getText(this, "save_parameters"), 1);
			buttonBarContainer.addButton("rois.png",
					RasterToolsUtil.getText(this, "adjust_to_rois"), 2);
			buttonBarContainer.addButton("fullExtent.png",
					RasterToolsUtil.getText(this, "fullExtent"), 3);
			buttonBarContainer.addButton("selectTool.png",
					RasterToolsUtil.getText(this, "select_tool"), 4);
			buttonBarContainer.setButtonAlignment("right");
			buttonBarContainer.setComponentBorder(false);
			buttonBarContainer.setBorder(BorderFactory
					.createLineBorder(new Color(189, 190, 176)));
		}
