 ...
 */
public class ClippingTocMenuEntry extends AbstractTocContextMenuAction
	 ...
	 */
	private void loadClippingListener(MapControl m_MapControl,
			ClippingMouseViewListener clippingMouseViewListener,
			FLyrRasterSE lyr) {
		// Si no se ha cargado el listener aún lo cargamos.
		StatusBarListener sbl = new StatusBarListener(m_MapControl);
		TransformedRectangleBehavior trb = new TransformedRectangleBehavior(
				clippingMouseViewListener);
		AffineTransform at = ((FLyrRasterSE) lyr).getAffineTransform();
		trb.setAffineTransform(at);
		m_MapControl.addMapTool("clipRaster", new Behavior[] { trb,
	...
	public void execute(ITocItem item, FLayer[] selectedItems) {
		...
		ClippingPanelListener clippingPanelListener = new ClippingPanelListener(
				clippingDialog.getClippingPanel());
		clippingPanelListener.setLayer((FLyrRasterSE) fLayer);
		clippingDialog.getClippingPanel().setClippingListener(
		...
		ClippingMouseViewListener clippingMouseViewListener = new ClippingMouseViewListener(
				mapCtrl, clippingDialog.getClippingPanel(), clippingData,
				(FLyrRasterSE) fLayer);
		loadClippingListener(mapCtrl, clippingMouseViewListener,
				((FLyrRasterSE) fLayer));
