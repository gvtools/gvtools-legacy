...
public class RasterModule extends Extension implements ConfigurationListener {
	...
	public void initialize() {
		...
		extensionPoints.add("View_TocActions", "ColorTable", ColorTableTocMenuEntry.getSingleton());
		extensionPoints.add("View_TocActions", "RegionsOfInterest", ROIManagerTocMenuEntry.getSingleton());
		extensionPoints.add("View_TocActions", "Filters", FilterTocMenuEntry.getSingleton());
