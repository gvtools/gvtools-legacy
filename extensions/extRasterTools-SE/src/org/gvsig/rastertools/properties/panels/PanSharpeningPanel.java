...
public class PanSharpeningPanel extends AbstractPanel implements
		TableModelListener {
	...
	public void setTranslation() {
		this.getCbActiveSharpening().setText(
				PluginServices.getText(this, "onSharpening"));
		this.getPSharpNorth().setBorder(
	...
	public String getBandName(int i) {
		String s = (String) ((DefaultTableModel) rgbTable.getModel())
				.getValueAt(i, 1);
	...
	public void removeSelections() {
		for (int i = 0; i < ((DefaultTableModel) rgbTable.getModel())
				.getRowCount(); i++) {
			((DefaultTableModel) rgbTable.getModel()).setValueAt(new Boolean(
					false), i, 0);
		}
	}
	...
	public JPanel getPSharpNorth() {
		if (pSharpNorth == null) {
			...
			pSharpNorth.setBorder(javax.swing.BorderFactory.createTitledBorder(
					null, "Selector de banda de refinado",
					javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
					javax.swing.border.TitledBorder.DEFAULT_POSITION, null,
					null));
	...
	public JCheckBox getCbActiveSharpening() {
		if (cbActiveSharpening == null) {
			...
			cbActiveSharpening
					.setPreferredSize(new java.awt.Dimension(150, 23));
			cbActiveSharpening
	...
	public void setReference(Object ref) {
		...
		/*
		 * if (lyr instanceof IRasterDataset) dataset = (IRasterDataset) lyr;
		 */
		...
		pansharpControl = new PanSharpeningControl(getPanelGroup(), this,
				(IRasterDataset) dataset, prop, lyr, rfl);
	 ...
	 * 
	 * @see
	 * org.gvsig.raster.gui.properties.dialog.IRegistrablePanel#getLayerClass()
	 */
	 ...
	 */
	private void clear() {
		int rows = ((DefaultTableModel) getBandTable().getModel())
				.getRowCount();
		if (rows > 0) {
	...
	class RadioColumnEditor extends AbstractCellEditor implements
			TableCellEditor {
