 ...
 * array representa una extensión de fichero soportada. Cuando se modifica las
 * propiedades para una determinada extensión de un driver estas se asignan a su
 * entrada del vector driversExtensionProps y desde aquí son leidas para ser
 * restauradas en caso de volver el cuadro de dialogo de propiedades.
 * 
...
public class DriverProperties {
	...
	/**
	 * Para una extensión de fichero determinada obtiene el valor de una
	 * propiedad si existe este. La extensión solicitadad deberá estar
	 * registrada
	 * 
	 * @param extension
	 ...
	 * @return Valor de la propiedad o null en caso de que la extensión de
	 *         fichero no exista o la propiedad no se encuentre.
	 */
		...
		if (props != null) {
			for (int i = 0; i < props.length; i++) {
				if (props[i].startsWith(property + "="))
					return props[i].substring(props[i].lastIndexOf("=") + 1,
							props[i].length());
			}
		}
		return null;
