...
public class CopyDataset {
	 ...
	 * @throws NotSupportedExtensionException
	 */
	public CopyDataset(String src, String dst,
			IncrementableTask incrementableTask) throws LoadLayerException {
		fSrcName = src;
		fDstName = dst;
	...
	public void copy() throws InterruptedException {
		...
		int[] dValues = new int[] { 0, (int) src.getPxHeight(),
				(int) src.getPxWidth(), 0 };
		...
		if (incrementableTask != null)
			clippingProcess.addParam("cancellable", new ExternalCancellable(
					incrementableTask));
		...
		clippingProcess.addParam("colorInterpretation", src.getDataSource()
		...
		clippingProcess.addParam("resolution",
				new int[] { (int) src.getPxWidth(), (int) src.getPxHeight() });
