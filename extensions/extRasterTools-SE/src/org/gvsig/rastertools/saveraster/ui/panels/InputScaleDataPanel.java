...
public class InputScaleDataPanel extends JPanel {
	...
	public DataInputContainer getTMtsPixel() {
		if (inputMtsPixel == null) {
			...
			inputMtsPixel
					.setLabelText(PluginServices.getText(this, "mtspixel"));
		}
	...
	private JPanel getPResolution() {
		if (pResolution == null) {
			...
			lResolution.setText(PluginServices.getText(this,
					"resolucion_espacial") + ":");
	...
	/**
	 * Pone como activo el input scale o mts por pixel dependiendo del valor del
	 * parámetro.
	 * 
	 * @param active
	 *            Si vale 0 activa la Escala y desactiva mts/pixel. Si vale 1
	 *            activa mts/pixel y desactiva la Escala. Si vale 2 desactiva
	 *            ambos.
	 */
