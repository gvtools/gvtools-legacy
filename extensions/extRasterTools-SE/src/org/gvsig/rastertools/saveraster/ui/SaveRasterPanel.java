...
public class SaveRasterPanel extends JPanel {
	...
	// -------------------------------------------
	/**
	 * Obtiene la etiqueta del nombre de fichero seleccionado return JLabel
	 */
	...
	/**
	 * Obtiene la entrada de texto correspondiente a la X de la esquina superior
	 * izquierda
	 * 
	 * @return DataInputContainer
	 */
	public DataInputContainer getTSupIzqX() {
		return getWCCoordsPanel().getCoordinatesPanel()
				.getDataInputContainer11();
	}

	/**
	 * Obtiene la entrada de texto correspondiente a la Y de la esquina superior
	 * izquierda
	 * 
	 * @return DataInputContainer
	 */
	public DataInputContainer getTSupIzqY() {
		return getWCCoordsPanel().getCoordinatesPanel()
				.getDataInputContainer12();
	}

	/**
	 * Obtiene la entrada de texto correspondiente a la X de la esquina inferior
	 * derecha
	 * 
	 * @return DataInputContainer
	 */
	public DataInputContainer getTInfDerX() {
		return getWCCoordsPanel().getCoordinatesPanel()
				.getDataInputContainer21();
	}

	/**
	 * Obtiene la entrada de texto correspondiente a la Y de la esquina inferior
	 * derecha
	 * 
	 * @return DataInputContainer
	 */
