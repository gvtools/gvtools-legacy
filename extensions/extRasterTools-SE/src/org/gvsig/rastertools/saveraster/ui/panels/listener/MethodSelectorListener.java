...
/**
 * Listener para la gestión del método de selección del tamaño de la salida.
 * Este listener se encarga de que cuando se varia el JRadioButton se activen y
 * desactiven los controles correspondientes.
 * 
 * @version 18/04/2007
 * @author Nacho Brodin (nachobrodin@gmail.com)
 * 
 */
public class MethodSelectorListener implements ActionListener, ChangeListener,
