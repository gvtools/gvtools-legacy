...
public class InputSizePanel extends JPanel {
	...
	public JComboBox getCbMeasureType() {
		if (cbMeasureType == null) {
			...
			cbMeasureType.addItem(PluginServices.getText(this, "pixels"));
			cbMeasureType.addItem(PluginServices.getText(this, "centimeters"));
			cbMeasureType.addItem(PluginServices.getText(this, "millimeters"));
			cbMeasureType.addItem(PluginServices.getText(this, "meters"));
			cbMeasureType.addItem(PluginServices.getText(this, "inches"));
		}
