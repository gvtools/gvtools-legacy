...
/**
 * Gráfico que representa un borde para el canvas. Dibuja un cuadrado sin
 * relleno en el perimetro máximo de dibujo del canvas.
 * 
 * 14-oct-2007
 * 
...
public class Border extends DrawableElement {
	...
	public void paint(Graphics g) {
		g.setColor(color);
		g.drawRect(canvas.getCanvasMinX(), canvas.getCanvasMinY(),
