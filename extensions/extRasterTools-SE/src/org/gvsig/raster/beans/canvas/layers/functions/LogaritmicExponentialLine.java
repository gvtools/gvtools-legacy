 ...
 * directamente.
 * 
 * Las formas mas logicas de uso seria pasandole: 1.0: Para una funcion
 * logaritmica -1.0: Para una funcion exponencial 0.0: Para una funcion lineal
 * 
 * @version 02/04/2008
...
public class LogaritmicExponentialLine extends StraightLine {
	 ...
	 * valores normales son 1.0 para logaritmica y -1.0 para exponencial. El
	 ...
	 * componente. Cuando el porcentaje es mayor a 0 siempre estamos en la
	 * Logaritmica Cuando el porcentaje es menor a 0 siempre estamos en la
	 * exponencial
	 * 
	 * @param perc
	 */
	...
	/**
	 * Recalcula todos los puntos de la funcion ( 0.0 a 1.0) - Funcion
	 * logaritmica con aproximacion al centro ( 1.0 a 2.0) - Funcion logaritmica
	 * con aproximacion al borde ( 0.0 a -1.0) - Funcion exponencial con
	 * aproximacion al centro (-1.0 a -2.0) - Funcion exponencial con
