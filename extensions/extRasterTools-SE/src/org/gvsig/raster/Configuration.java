...
/**
 * La clase <code>Configuration</code> sirve para poder leer y escribir valores
 * en el entorno de raster a nivel de configuración. Para leer o escribir hay
 * que usar los metodos getValue y setValue, estos metodos lanzan eventos en el
 * caso de cambiar el valor que habia establecido. Forma de uso:
 * <p>
 * 
 ...
 * <p>
 * 
 * <code>Boolean valor = Configuration.getValue("valorBooleano", Boolean.valueOf(true));</code>
 * <p>
 * 
 * <code>Configuration.setValue("valorBooleano", Boolean.valueOf(false));</code>
 * <p>
 * 
 * Solo se pueden usar los siguientes tipos de datos:<br>
 * - <b>Boolean</b>, <b>Double</b>, <b>Float</b>, <b>Integer</b>, <b>Long</b> y
 * <b>String</b>.
 * <p>
 * 
 * Otra funcionalidad que tiene, es que puedes agregar un manejador de eventos
 * para controlar los cambios de las variables y actuar en consecuencia si
 * cambia la que deseas.
 * 
 * @version 07/12/2007
...
public class Configuration implements IConfiguration {
	...
	/**
	 * Constructor privado. Nos aseguramos de que nadie pueda crear una
	 * instancia desde fuera, la configuración es única para todos.
	 */
	private Configuration() {
		try {
			PluginServices ps = PluginServices
					.getPluginServices("org.gvsig.rastertools");
	...
	/**
	 * Guarda en la configuracion el Objeto pasado por parametro asociado a
	 * dicho key
	 * 
	 * @param key
	 * @param value
	...
	private void callConfigurationChanged(String key, Object value) {
		...
		while (iterator.hasNext()) {
			ConfigurationListener listener = (ConfigurationListener) iterator
					.next();
			listener.actionConfigurationChanged(new ConfigurationEvent(this,
					key, value));
		}
	}
	...
	/**
	 * Devuelve una instancia al unico objeto de configuración que puede
	 * existir.
	 * 
	 * @return
	 */
