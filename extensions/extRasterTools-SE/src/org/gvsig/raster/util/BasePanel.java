...
public abstract class BasePanel extends JPanel {
	...
	/**
	 * Obtiene el valor para la activación y desactivación del evento de cambio
	 * de valor en las cajas de texto.
	 * 
	 * @param enableValueChangedEvent
	 */
	...
	/**
	 * Obtiene la lista de componentes del panel. Si dentro tiene algún
	 * BasePanel consulta la lista de componentes de este y la devuelve.
	 * 
	 * @return
	 */
	public ArrayList getComponentList() {
		...
		for (int i = 0; i < this.getComponentCount(); i++) {
			if (getComponent(i) instanceof BasePanel) {
				ArrayList list = ((BasePanel) getComponent(i))
						.getComponentList();
	 ...
	 * 
	 * @param type
	 *            Tipo de listener definido por las variables estáticas en esta
	 *            clase
	 * @param listener
	 *            Objeto listener del tipo correcto
	 */
