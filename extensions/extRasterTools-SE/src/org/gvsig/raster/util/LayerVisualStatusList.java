...
/**
 * Clase para almacenar estados visuales de una capa raster. Estos estados deben
 * ser locales a cada funcionalidad para que no interfieran entre ellos. Luego
 * es posible tener una lista de estados globales para restaurar el que nos
 * convenga. 07/10/2008
 * 
...
public class LayerVisualStatusList {
	...
	/**
	 * Clase que contiene el estado visual de una capa raster. 07/10/2008
	 * 
	 * @author Nacho Brodin nachobrodin@gmail.com
	 */
