...
public class PdfPanel extends AbstractHyperLinkPanel implements
	...
	private Component[] initChangerPanel() {
		...
		URL printImage = getClass().getResource(
	...
	/**
	 * This is not used by hyperlink, but it's kept as it may be useful to get a
	 * quick PDF window in gvSIG.
	 */
