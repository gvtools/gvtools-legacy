 ...
 * of the URI that the constructor of the class receives. This panel invokes a
 * new one with the content of the URI. The type of the supported URI should be
 * added like extension point in the initialization of the extension.
 * 
		...
		if (m_ViewInfo == null) {
			...
			if (contents.getURI().toString().startsWith("file:")
				...
				try {
					...
					m_ViewInfo
							.setTitle(PluginServices.getText(this, "Hyperlink")
