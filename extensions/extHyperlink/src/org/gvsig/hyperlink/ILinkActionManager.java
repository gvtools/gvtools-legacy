...
/**
 * TODO document this interface This interface must be implemented by format
 * managers for the hyperlink tool. A manager is able to load an specific file,
 * either by loading it in an AbstractHyperLinkPanel or by opening the proper
