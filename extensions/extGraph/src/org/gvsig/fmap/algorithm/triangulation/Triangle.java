...
/**
 * @author Francisco José Peñarrubia (fjp@scolab.es) I think it would be better
 *         to speak with people from JTS and pay them to implement contour and
 *         delaunay, and put them on JTS library.
 * 
 */
