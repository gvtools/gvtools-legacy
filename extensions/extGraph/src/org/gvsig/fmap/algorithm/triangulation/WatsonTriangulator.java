...
public class WatsonTriangulator extends AbstractTriangulator {
	...
	private void createTriangle(int[] vertex, double[][] points) {
		...
		Vertex v1 = tin.vertices.get(vertex[0]); // new
													// Vertex(points[0][vertex[0]],
													// points[1][vertex[0]]);
		Vertex v2 = tin.vertices.get(vertex[1]); // new
													// Vertex(points[0][vertex[1]],
													// points[1][vertex[1]]);
		Vertex v3 = tin.vertices.get(vertex[2]); // new
													// Vertex(points[0][vertex[2]],
													// points[1][vertex[2]]);
