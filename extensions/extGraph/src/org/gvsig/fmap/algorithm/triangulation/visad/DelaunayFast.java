...
public class DelaunayFast extends Delaunay {
  ...
  private final void qsort(int[] array, double[][] samples,
    ...
    while (sp != 0) {
      ...
      if (!cmp) {
        ...
        for (int t=0; t<3; t++) {
          ...
          double u = (cvh) ? (double) (bamy/Math.sqrt(bamx*bamx + bamy*bamy))
                          : (double) (bamx/Math.sqrt(bamx*bamx + bamy*bamy));
          double v = (cvh) ? (double) (camy/Math.sqrt(camx*camx + camy*camy))
                          : (double) (camx/Math.sqrt(camx*camx + camy*camy));
          ...
          while (u < v) {
            ...
            u = (cvh) ? (double) (bamy/Math.sqrt(bamx*bamx + bamy*bamy))
                      : (double) (bamx/Math.sqrt(bamx*bamx + bamy*bamy));
            v = (cvh) ? (double) (camy/Math.sqrt(camx*camx + camy*camy))
                      : (double) (camx/Math.sqrt(camx*camx + camy*camy));
          }
