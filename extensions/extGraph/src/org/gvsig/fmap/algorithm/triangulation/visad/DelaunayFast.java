		...
		while (sp != 0) {
			...
			if (!cmp) {
				...
				for (int t = 0; t < 3; t++) {
					...
					double u = (cvh) ? (double) (bamy / Math.sqrt(bamx * bamx
							+ bamy * bamy)) : (double) (bamx / Math.sqrt(bamx
							* bamx + bamy * bamy));
					double v = (cvh) ? (double) (camy / Math.sqrt(camx * camx
							+ camy * camy)) : (double) (camx / Math.sqrt(camx
							* camx + camy * camy));
					...
					u = (cvh) ? (double) (bamy / Math.sqrt(bamx * bamx + bamy
							* bamy)) : (double) (bamx / Math.sqrt(bamx * bamx
							+ bamy * bamy));
					v = (cvh) ? (double) (camy / Math.sqrt(camx * camx + camy
							* camy)) : (double) (camx / Math.sqrt(camx * camx
							+ camy * camy));
					plus_dir = (u < v);
					if (!plus_dir) {
						bob = upp2;
