...
public class ObjectComparator {
	...
	public static int compare(Object o1, Object o2) {
		...
		if (value1.doubleValue() == Double.NaN
				|| value2.doubleValue() == Double.NaN)
	...
	/**
	 * Method to generate a <code>double</code> value out of different number
	 * objects.
	 * 
	 * @param o
	 * @return a double value representing to given object or
	 *         <code>Double.NAN</code> if it can't be parsed
	 */
	public static double getDoubleValue(Object o) {
		double value = Double.NaN;

		if (o == null) {
			System.err.println("got NULL value");
		} else {
			if (Integer.class.isInstance(o)) {
				...
				System.err.println(" can't get double value... - "
						+ o.getClass().getName());
			}
		}
		return value;
