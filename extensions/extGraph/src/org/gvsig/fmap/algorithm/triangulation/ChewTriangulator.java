 ...
 * 
 * Adapter to Chew algorithm
 * FIXME: Doesn't work with my data, I don't know why :-(
 * It seems that there are points that return no cavity.
...
public class ChewTriangulator extends AbstractTriangulator {
	...
	public TIN calculateTriangulation() {
	    ...
	    Pnt leftPnt = new Pnt(centerX- 2.0*fullExtent.getWidth(), fullExtent.getMinY());
	    Pnt rightPnt = new Pnt(centerX+ 2.0*fullExtent.getWidth(), fullExtent.getMinY());
	    ...
	    System.out.println("BigTriangle = " + bigTriangle.get(0) + " - " + bigTriangle.get(1));
