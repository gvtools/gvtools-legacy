...
public class Triangulation {
	    ...
	    * @param points tableau des points a trianguler.
	    ...
	    */
	    public Triangulation(Coordinate[] points, int[][] breaklines) {
	        ...
	        log.info("Initialisation : " + hs.size() + "/" + points.length + " points tries en " + (t1-t0) + " ms");
	    }
	   ...
	   /**
	    * Inserer un point dans la triangulation
	    * TODO : verifier si la methode marche uniquement pour des points ajoutes ?
	    * droite ou si elle est valable pour l'ajout de n'importe quel point situe
	    ...
	    * et s'appuie dessus pour creer de nouveaux triangles.
	  ...
	  /**
	   ...
	   /**
	    *Cette fonction permet de determiner si le triangle p0-p1-p2
	    ...
	    private boolean lierC (Triangle T1, int c, Triangle T2) {
	        ...
	        try {
	            ...
	            if (T1.ppp[c].i==T2.ppp[0].i) {
	                // si le cote 2 de T2 est un segment contraint, la contrainte est ajoutee a T1
	            ...
	            // Le cote c de T1 est egal au cote 1 de T2
	                ...
	                // si le cote 1 de T2 est un segment contraint, la contrainte est ajoutee a T1
	            ...
	            // Le cote c de T1 est egal au cote 0 de T2
	                ...
	                // si le cote 0 de T2 est un segment contraint, la contrainte est ajoutee a T1
	   ...
	   /**
	    * Test if Fonction booleenne renvoyant vrai s'il existe deja une arete
	    ...
	    * @param p2 point dont on veut savoir s'il est connecte ? p1.
	  ...
	  /** Localise le triangle contenant le point p.
	   ...
	   /** localise le triangle contenant le point p.*/
	    ...
	    /** Trouve le triangle adjacent ? t dans la direction de p.
	      ...
	      *            0, 1 ou 2 : cote du triangle suivant
	      */
	    ...
	    */
	    ...
	    /**
	    * Classe Triangle definissant un triangle et ses voisins.
	    * Un Triangle est compose :
	    * - d'un tableau de 3 PointT (designant des Points)
	    * Les trois PointT, d'indice 0,1,2 tournent dans le sens trigo (ccw)
	    * - d'un tableau de 3 references vers les triangles voisins
	    * Le triangle voisin ttt[0] partage le segment ppp[0]-ppp[1]
	    * - une propriete permettant de memoriser les cotes representant des
	    * contraintes
	    *               
	    *         _ _ _t.ppp[2]_ _ 
	    *         \      /\      /
	    ...
	    */
	    public class Triangle {
	      ...
	      /** Cherche l'indice (0,1 ou 2) du point oppose ? ce Triangle dans le Triangle
	        * adjacent au cote i-(i+1)
	        ...
	        */
	        ...
	        /** Ajoute une contrainte sur un cote et met sous letriangle
	          * adjacent.*/
	       ...
	       /**
	        * Ce test renvoie true si les deux triangles pointent 
	        * sur les memes PointT, dans le meme ordre.
	        * (Tester l'egalite des coordonnees est en effet inutile puisque 2 
	        * PointT ne peuvent avoir les memes coordonnees).
	        */
