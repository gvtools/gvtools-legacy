...
public class ContourValidator {
	...
	public ContourValidator(Geometry border, Collection<Geometry> outsideGeometries, Collection <Geometry> insideGeometries) {
	...
	/**
	 * @return a List of geometries from insideGeoms that are not inside.
	 * It does a clip also, so you can use this collection to adapt border geometry and
	 * fix the error by expanding border.
	 * If the list is empty, all insideGeoms are inside border.
	 */
	...
	/**
	 * @return a List of geometries from outsideGeoms that are not inside.
	 * It does a clip also, so you can use this collection to adapt border geometry and
	 * fix the error by "crunching" the border.
	 * If the list is empty, all outsideGeoms are outside border.
	 */
