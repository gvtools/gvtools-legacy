 ...
 * @author fjp
 * 
 *         Useful when working with a network based on a jdbc layer (random
 *         access very slow). The idea is to put in memory theGeom and every
 *         field that we may need later (street name, length, cost, etc).
 * 
