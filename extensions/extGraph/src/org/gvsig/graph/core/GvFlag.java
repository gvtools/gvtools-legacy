...
public class GvFlag {
	...
	/**
	 * Useful for general purpose. For example, we can use it to label flags
	 * (with something different from getDescription. In odMatrix, we use
	 * properties to distinguish between origins and destinations.
	 */
	private Properties properties = new Properties();

	public GvFlag(double x, double y) {
		this.originalPoint = new Point2D.Double(x, y);
		// this.description = PluginServices.getText(this,
		// "new_flag")+flagNumber++;
	...
	/**
	 * Returns the cost for this flag. The cost represents the amount of
	 * resource of the user's cost unit required to reach this flag from the
	 * previous one in the route.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns a human-readable description of this flag. This is typically a
	 * name for this marker.
	 * 
	 * @return
	 */
	...
	/**
	 * Sets the description of this flag. The description should be a human
	 * readable description for this flag such is street name or something like
	 * that. But it can be whatever.
	 * 
	 * @param description
	 */
