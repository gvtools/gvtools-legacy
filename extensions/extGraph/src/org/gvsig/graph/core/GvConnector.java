 ...
 * 
 *         Each node connects to GvEdge by GvConnectors. Their purpose is to
 *         model accurately turnCosts.
 * 
 */
public class GvConnector {
	...
	private double bestCostIn = Double.MAX_VALUE; // Cost arriving to this
													// connector
	private double bestCostOut = Double.MAX_VALUE; // Cost exiting from this
													// connector
