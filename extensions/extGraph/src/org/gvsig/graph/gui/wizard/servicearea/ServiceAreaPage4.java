...
public class ServiceAreaPage4 extends JWizardPanel implements ActionListener,
		MouseListener {
	...
	private void initialize() {
		this.labelChooseArea = new JLabel("<html><b>Tipo de áreas:</b></html>",
				JLabel.LEFT);
		...
		this.radioAreaTypesDisks = new JRadioButton(
				"<html>Las <b>áreas de disco</b> se crean formando polígonos que representan cada una de las áreas de servicio</html>");
		...
		this.labelAreaTypesDisksPicture.setIcon(PluginServices.getIconTheme()
				.get("service_area_disks"));
		...
		this.radioAreaTypesRings = new JRadioButton(
				"<html>Las <b>áreas de anillo</b> solo muestran una línea que delimita cada una de las áreas de servicio</html>");
		...
		this.labelAreaTypesRingsPicture.setIcon(PluginServices.getIconTheme()
				.get("service_area_rings"));
		this.labelAreaTypesRingsPicture.setEnabled(false);
		this.labelAreaTypesRingsPicture.addMouseListener(this);

		this.labelAreaTypesDisksPicture.setSize(this.labelAreaTypesDisksPicture
				.getIcon().getIconWidth(), this.labelAreaTypesDisksPicture
				.getIcon().getIconHeight());
		this.panelAreaTypesDisksPicture.add(this.labelAreaTypesDisksPicture);
		this.panelAreaTypesDisksPicture.setSize(this.labelAreaTypesDisksPicture
				.getSize());
		...
		this.labelAreaTypesRingsPicture.setSize(this.labelAreaTypesRingsPicture
				.getIcon().getIconWidth(), this.labelAreaTypesRingsPicture
				.getIcon().getIconHeight());
		this.panelAreaTypesRingsPicture.add(this.labelAreaTypesRingsPicture);
		this.panelAreaTypesRingsPicture.setSize(this.labelAreaTypesRingsPicture
				.getSize());
