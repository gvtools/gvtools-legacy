...
public class NetworkPointsModel extends AbstractPointsModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 1:
			if (this.getRowCount() > rowIndex)
				return Integer.valueOf(((GvFlag) this.network.getOriginaFlags()
						.get(rowIndex)).getIdFlag());
			else
				return null;
		case 2:
			if (rowIndex < this.getRowCount())
				return ((GvFlag) this.network.getOriginaFlags().get(rowIndex))
						.getDescription();
			else
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		case 2: {
			if (rowIndex < this.getRowCount())
				((GvFlag) this.network.getOriginaFlags().get(rowIndex))
						.setDescription(String.valueOf(aValue));
	...
	public String toString() {
		return "Modelo: Red # Número de flags: "
				+ this.network.getOriginaFlags().size() + " #";
	}
}
