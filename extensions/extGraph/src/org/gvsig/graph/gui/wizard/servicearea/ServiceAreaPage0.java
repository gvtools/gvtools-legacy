...
public class ServiceAreaPage0 extends JWizardPanel implements ActionListener, LayerCollectionListener{
	...
	private void initialize(){	
		...
		this.labelSourcePointsSelectionFromNetworkNote=new JLabel("<html><p>NOTA: Las paradas se podrán gestionar en el siguiente paso</p></html>");
	...
	public void next(){
		...
		if(this.radioSourcePointsSelectionFromLayer.isSelected()){
			try {
				...
				if(window instanceof View){
					...
					if(layer!=null && layer instanceof FLyrVect){
						...
						JOptionPane.showMessageDialog(this, "No se ha podido obtener una capa de puntos válida", "Error", JOptionPane.ERROR_MESSAGE);
					}
				}
				else{
					JOptionPane.showMessageDialog(this, "No se ha podido obtener una capa de puntos válida", "Error", JOptionPane.ERROR_MESSAGE);
				...
				JOptionPane.showMessageDialog(this, except.getMessage(), "Campo no válido", JOptionPane.ERROR_MESSAGE);
			}
			catch (ReadDriverException except) {
				JOptionPane.showMessageDialog(this, "Se ha producido un error en la lectura de la información de la capa", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
			...
			JOptionPane.showMessageDialog(this, "No se ha encontrado un modelo de datos válido", "Error", JOptionPane.ERROR_MESSAGE	);
		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.radioSourcePointsSelectionFromLayer){
			...
			if(ext!=null){
				...
				JOptionPane.showMessageDialog(this, "Imposible añadir capas", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
