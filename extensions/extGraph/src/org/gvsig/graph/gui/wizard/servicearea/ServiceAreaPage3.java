...
public class ServiceAreaPage3 extends JWizardPanel implements ActionListener, MouseListener{
	...
	private void initialize(){
		this.labelChooseArea=new JLabel("<html><b>Fusion de áreas:</b></html>", JLabel.LEFT);
		...
		this.radioAreaTypesFusioned=new JRadioButton("<html>Las áreas de servicio que se solapen se <b>fusionarán</b> en una sola teniendo en cuenta los costes</html>");
		...
		this.titledBorderAreaTypesNonFusioned=new TitledBorder("No fusionar áreas");
		this.panelAreaTypesNonFusioned.setBorder(this.titledBorderAreaTypesNonFusioned);
		this.radioAreaTypesNonFusioned=new JRadioButton("<html>Las áreas de servicio que ocupen un mismo lugar se solaparán</html>");
