 ...
 * @author __USER__
 */
public class TurnCostsTableChooser extends javax.swing.JPanel implements
		IWindow {
	...
	private void updateFieldCombos() {
		...
		FieldDescription[] fields = selectedTable.getModelo()
		...
		layout.setVerticalGroup(layout
				...
				.add(layout
						...
						.add(layout
								.createParallelGroup(
										org.jdesktop.layout.GroupLayout.BASELINE)
								.add(btnCancel).add(btnOK)).addContainerGap()));
	}// </editor-fold>
