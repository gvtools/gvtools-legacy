...
class FormatSelectionPanel extends JPanel implements IWindow {
	 ...
	 * 
	 */
	FormatSelectionPanelData data = new FormatSelectionPanelData(null, false);
	...
	public FormatSelectionPanel(String introductoryText) {
		...
		JButton okButton = new JButton(PluginServices.getText(null, "Aceptar"));
	...
	public WindowInfo getWindowInfo() {
		if (data.getWi() == null) {
			data.setWi(new WindowInfo(WindowInfo.MODALDIALOG
					| WindowInfo.PALETTE));
			data.getWi().setTitle(
					PluginServices.getText(null, "Format_selection"));// Internacionalizar
																		// esto
