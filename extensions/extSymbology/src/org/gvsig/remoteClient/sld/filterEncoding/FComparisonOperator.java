...
/**
 * Implements the main functionalities to parse a comparison operator of a
 * Filter Encoding expression.<br>
 * 
 * A comparison operator is used to form expressions that evaluate the
 * mathematical comparison between two arguments. If the arguments satisfy the
 * comparison then the expression evaluates to TRUE.Otherwise the expression
 * evaluates to FALSE.
 * 
	...
	public void parse(XMLSchemaParser parser, String tag)
		...
		while (!end) {
			...
			case XMLSchemaParser.START_TAG:
				...
				opExpressionStr += FilterUtils.getSymbol4Expression("ogc:"
						+ this.comparisonType)
						+ " ";
