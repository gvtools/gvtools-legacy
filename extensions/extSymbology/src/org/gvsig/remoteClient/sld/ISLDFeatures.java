...
public interface ISLDFeatures {
	...
	/**
	 * Parses the contents of the SLD document to extract the information about
	 * a specific SLD Feature
	 * 
	 * @param parser
	 * @param cuTag
	...
	/**
	 * Translate the object into an XML String according with the Styled Layer
	 * Specification
	 * 
	 * @return
	 */
