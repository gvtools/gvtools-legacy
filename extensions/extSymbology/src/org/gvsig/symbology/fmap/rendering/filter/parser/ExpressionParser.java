...
public class ExpressionParser implements ExpressionParserConstants {
	...
	public ExpressionParser(StringReader reader,
		...
		label_6: while (true) {
			...
			try {
				...
				if (aInt && bInt) {
					...
					double a = new Double(((Expression) A).evaluate()
							.toString());
					double b = new Double(((Expression) B).evaluate()
							.toString());
					if (x.kind == MULTIPLY)
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x10000, 0x20000, 0x9000, 0x9000, 0x6600,
				0x6600, 0x60, 0x60, 0x180, 0x180, 0x60, 0x38280860, 0x38280800,
				0x18080000, 0x200000, 0x20000000, 0x38280860, 0x1000000, };
	}

	private static void jj_la1_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0xb, 0xb, 0xb, 0x0, 0x0, 0xb, 0x0, };
	}
