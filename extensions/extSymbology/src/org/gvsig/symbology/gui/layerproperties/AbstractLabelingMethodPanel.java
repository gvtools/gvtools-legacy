...
public abstract class AbstractLabelingMethodPanel extends JPanel implements
	...
	public void setModel(ILabelingMethod method, FLyrVect srcLayer)
		...
		try {
			if (method != null
					&& method.getClass().equals(getLabelingMethodClass())) {
				this.method = method;
			} else {
			...
			throw new ReadDriverException(srcLayer.getRecordset().getDriver()
					.getName(), new Error(
					"Unable to load labeling method. Is it in your classpath?",
					e));
		}
	...
	public abstract void fillPanel(ILabelingMethod method,
