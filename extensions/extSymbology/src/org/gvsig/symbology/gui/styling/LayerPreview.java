...
public class LayerPreview extends ImageNavigator implements
	...
	public void setLayer(FLayer layer) throws ExpansionFileReadException,
			ReadDriverException {
		this.layer = layer;
		if (layer != null) {
			vp = new ViewPort(layer.getCrs());
			Rectangle2D b = layer.getFullExtent();
			setViewDimensions(b.getMinX(), b.getMaxY(), b.getMaxX(),
					b.getMinY());
		}
		updateBuffer();
		setEnabled(true);
