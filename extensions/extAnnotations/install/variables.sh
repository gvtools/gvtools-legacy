...
export APPNAME=gvsig_annotations
...
export MAIN_INSTALL_PLUGIN=com.iver.cit.gvsig.annotation #Nombre del plugin que proporciona el 'build.nuber' para la distribucion
