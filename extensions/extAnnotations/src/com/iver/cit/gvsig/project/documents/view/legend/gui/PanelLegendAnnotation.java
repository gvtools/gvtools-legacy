...
public class PanelLegendAnnotation extends AbstractThemeManagerPage {
	...
	private JCheckBox getChkDelOverLapping() {
		if (chkDelOverLapping == null) {
			...
			chkDelOverLapping
					.setBounds(new java.awt.Rectangle(27, 147, 303, 23));
			chkDelOverLapping.setText(PluginServices.getText(this,
	...
	private JCheckBox getChkAvoidOverLapping() {
		if (chkAvoidOverLapping == null) {
			...
			chkAvoidOverLapping.setBounds(new java.awt.Rectangle(27, 116, 303,
					23));
			chkAvoidOverLapping.setText(PluginServices.getText(this,
					"avoid_overlapping"));
