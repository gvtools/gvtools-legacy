...
/**
 * <p>
 * <a href="http://www.gvsig.com/">gvSIG</a> extension.
 * </p>
 * <p>
 * Tool that displays the selected information that the cursor points on the
 * active view.
 * </p>
 * 
	...
	protected void registerIcons() {
		PluginServices.getIconTheme().registerDefault(
				...
				this.getClass().getClassLoader()
						.getResource("images/arrow_right.png"));
		...
		PluginServices.getIconTheme().registerDefault(
				"field-leaf-icon",
				this.getClass().getClassLoader()
						.getResource("images/field-leaf-icon.png"));

		PluginServices.getIconTheme().registerDefault(
				"field-complex-icon",
				this.getClass().getClassLoader()
						.getResource("images/field-complex-icon.png"));

		PluginServices.getIconTheme().registerDefault(
				"field-child-icon",
				this.getClass().getClassLoader()
						.getResource("images/field-child-icon.png"));
	}
