...
/* CVS MESSAGES:
 *
 * $Id: ReprojectGeoprocessController.java 21235 2008-06-05 14:08:38Z azabala $
 * $Log$
...
public class ReprojectGeoprocessController extends AbstractGeoprocessController {
	...
	public boolean launchGeoprocess() {
		...
		SHPLayerDefinition definition = (SHPLayerDefinition) reproject
		...
		if (previousCrs.equals(crs)) {
			String error = PluginServices.getText(this, "Error_entrada_datos");
			String errorDesc = PluginServices.getText(this,
