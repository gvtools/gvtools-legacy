...
public class CatalogClientExtension extends Extension {
	...
	public void initialize() {
		...
		ExtensionPoints extensionPoints = ExtensionPointsSingleton
				.getInstance();
		ExtensionPoint extensionPoint = new ExtensionPoint("CatalogLayers",
				"Lista de capas que se pueden cargar desde el catalogo.");
	...
	private void registerIcons() {
		PluginServices.getIconTheme().registerDefault(
				...
				this.getClass().getClassLoader()
						.getResource("images/SearchButton.png"));
	}
	...
	private ServerData[] getDefaultServers() {
		...
		servers[0] = new ServerData("http://delta.icc.es/indicio/csw", date,
				date, ServerData.SERVER_TYPE_CATALOG,
				ServerData.SERVER_SUBTYPE_CATALOG_CSW);
		servers[1] = new ServerData("mapas.euitto.upm.es:2100", date, date,
				ServerData.SERVER_TYPE_CATALOG,
				ServerData.SERVER_SUBTYPE_CATALOG_Z3950);
		servers[2] = new ServerData("193.43.36.137:2100", date, date,
				ServerData.SERVER_TYPE_CATALOG,
				ServerData.SERVER_SUBTYPE_CATALOG_Z3950);
		servers[3] = new ServerData(
				"http://idee.unizar.es/SRW/servlet/search/ExplainSOAP", date,
				date, ServerData.SERVER_TYPE_CATALOG,
				ServerData.SERVER_SUBTYPE_CATALOG_SRW);
		return servers;
	}
