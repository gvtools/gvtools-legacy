Annotations Plugin version 1.0 (Build number #build.number#):
...
2.- (Only if using Eclipse) Import the projects:
  ...
  *6: Mark the following project from the list: extAnnotations.
  *7: Click on 'Finish'.

3.- Run the 'build.xml' in the project 'extAnnotations' (using  Ant or Eclipse).
