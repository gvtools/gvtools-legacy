...
//
//            FMapRasterArcImsDriver drv = (FMapRasterArcImsDriver) layer.getDriver(); //).getClient().getServiceInformation().getMapunits();
...
//
//            bandSetup = (BandSetupPanel) ((FilterRasterDialogPanel) propsDialog.getContentPane()).getPanelByClassName(
//                    "BandSetupPanel");
//
...
//            RasterTransparencyPanel rasterTrans = (RasterTransparencyPanel) ((FilterRasterDialogPanel) propsDialog.getContentPane()).getPanelByClassName(
...
//     */
//    private void bandSelector(RasterFilterStackManager stackManager, int posR,
//        int posG, int posB) {
...
//
//    /**
//     * Modificación del estado de los controles del panel de brillo y contraste
//     */
//    public void actionPerformed(RasterFilterStackManager stackManager,
//        ArcImsRasterPropsDialog propsDialog, FLyrRaster fLayer) {
//        EnhancedBrightnessContrastPanel bcPanel = (EnhancedBrightnessContrastPanel) ((FilterRasterDialogPanel) propsDialog.getContentPane()).getPanelByClassName(
