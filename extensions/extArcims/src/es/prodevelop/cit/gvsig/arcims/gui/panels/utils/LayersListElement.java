...
/**
 * Implements the class used as a list element in most lists in this plugin.
 * 
 * @author jldominguez
 * 
 */
public class LayersListElement extends JComponent {
	...
	/**
	 * Gets a description of the layer to be shown on one of the wizard's panes.
	 * 
	...
	public Vector getDataVector() {
		...
		true_scale = LayerScaleData.getTrueScaleFromRelativeScaleAndMapUnits(
				maxscale, mapUnits, theDPI);
	...
	/**
	 * Implements the toString() method automatically invoqued by the system to
	 * paint a list.
	 * 
