...
public class ServiceNamesPanel extends JPanel implements ActionListener,
	...
	private static Logger logger = Logger.getLogger(ServiceNamesPanel.class
			.getName());
		...
		if (servicesTableScrollPane == null) {
			...
			servicesTableScrollPane
					.setBorder(javax.swing.BorderFactory.createTitledBorder(
							null,
							PluginServices.getText(this, "available_services"),
							javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getSource() == this.servicesTable) {
			...
			String servname = ServicesTableModel
					.getColumnValueOfRow(servicesTable,
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == connectButton) {
			...
			ServicesTableModel dtm = new ServicesTableModel(
					stds.getDataVector(), stds.getColNamesVector());
		...
		if (e.getSource() == nextButton) {
			...
			if (selectedServiceType
				...
				FMapRasterArcImsDriver idrv = (FMapRasterArcImsDriver) parentWizard
	...
	private JPanel getUserDefinedServiceNamePanel() {
		if (userDefinedServiceNamePanel == null) {
			...
			userDefinedServiceNamePanel
					.setBorder(javax.swing.BorderFactory.createTitledBorder(
							null,
							PluginServices.getText(this, "service_name"),
							javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
							javax.swing.border.TitledBorder.DEFAULT_POSITION,
							null, null));
	...
	private void fireServerUrlOk() {
		...
		// ActionEvent ae = new
		// ActionEvent(serviceNameSelectionModeListRadioButton,
		// ActionEvent.ACTION_PERFORMED, "");
		// actionPerformed(ae);
		setUserDecisionTrue();
	}
