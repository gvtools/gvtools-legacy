...
/**
 * ArcIMS driver implementation. Requests are passed to the
 * <tt>ArcImsClientP</tt> object.
 * 
...
public class FMapRasterArcImsDriver implements ArcImsDriver {
	private static Logger logger = Logger
			.getLogger(FMapRasterArcImsDriver.class.getName());
	 ...
	 * @return the graphic data to be viewed, that is, the map. For the
	 *         imageservice, it will be a <tt>File</tt> object.
	 */
	...
	/**
	 * Given a layer name, gets a node that contains relevant information about
	 * the layer.
	 * 
	 * @param layerName
	...
	/**
	 * This method starts a connection with the server and sends a
	 * <tt>getCapabilities</tt> request.
	 * 
	...
	/**
	 * Gets the <tt>ArcImsClientP</tt> object, onto which requests are passed.
	 * 
	 ...
	 * 
	 * @return <b>true</b> if method <tt>getFeatureInfo(...)</tt> can be
	 *         invoqued, <b>false</b> otherwise
	 */
