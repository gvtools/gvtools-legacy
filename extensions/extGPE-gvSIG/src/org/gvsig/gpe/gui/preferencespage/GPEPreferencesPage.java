...
public class GPEPreferencesPage extends AbstractPreferencePage {
	...
	/**
	 * @return the default properties that have their own panel to set them.
	 */
	...
	/**
	 * @return a panel that contains all the properties related with the
	 *         coordinates
	 */
	private Component getCoordinatesPanel() {
		// PropertiesComponent component = new PropertiesComponent();
		Component component = new JPanel();
		// component.addValue(PluginServices.getText(this, "gpe_" +
		// GPEDefaults.DECIMAL),
		// GPEDefaults.DECIMAL,
		...
		// null);
		// component.setBorder(createBorderPanel(PluginServices.getText(this,
		// "gpe_preferences_window_coordinates")));
		return component;
	}

	/**
	 * @return a panel that contains all the properties related with XML
	 */
	...
	/**
	 * @return a panel that contains all the properties related with the XML
	 *         Schema
	 */
	...
	/**
	 * @return a panel that contains all the properties that have not been join
	 *         in the other groups
	 */
	private Component getOthersPanel() {
		...
		// component.addValue(PluginServices.getText(this, key), key, value,
		// null);
		// i++;
		// }
		// }
	 ...
	 * 
	 * @see
	 * com.iver.andami.preferences.AbstractPreferencePage#setChangesApplied()
	 */
