...
public abstract class GPEWriterTest extends TestCase {
	...
	public void setUp() throws FileNotFoundException, IOException,
		...
		GPERegister.addGpeWriterHandler(getGPEWriterHandlerName(),
				getGPEWriterHandlerDescription(), getGPEWriterHandlerClass());
	}

	public void testWrite() throws Exception {
		FLayer layer = getLayerToWrite();
		ExportTask task = new ExportTask(getLayerToWrite(), getWriterHandler(),
				getMapContext(), new File(fileName));
		task.run();
	}
	...
	protected GPEWriterHandler getWriterHandler()
	...
	/**
	 * @return the mapcontext SRS. If you want to cahnge it you have to override
	 *         this method
	 */
	...
	/**
	 * Gets the file format. The deafult writer version will be used by default
	 * 
	 * @return
	 */
