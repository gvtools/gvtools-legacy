...
class InfoPanel extends JPanel {
	...
	private final String layer_abstract = PluginServices.getText(this,
			"layer_abstract");
	private final String selected_parameters = PluginServices.getText(this,
			"selected_parameters");
	...
	private final String properties = PluginServices
			.getText(this, "properties");
	 ...
	 *            crs: the CRS value
	 * @param String
	 *            parameters: comma-separated key-value string containing the
	 *            values for the parameters
	 */

	public void refresh(WCSWizardData dataSource, WCSLayer layer, String time,
			String format, String crs, String parameters) {
		...
		if (layer != null) {
			...
			String time_text = (time == null) ? PluginServices.getText(this,
					"not_available") : time;// ((FMapWMSStyle)
											// selectedStyles.get(i)).title;
		...
		if (parameters != null) {
			...
			for (int i = 0; i < myParameters.length; i++) {
				...
				parameter_html += "  <tr valign=\"top\" bgcolor="
						+ color
						+ ">"
						+ "    <td width=\"120\" height=\"18\" bgcolor=\"#D6D6D6\" align=\"right\"><b>"
						+ parameter[0] + "</b></td>"
						+ "    <td width=\"322\" height=\"18\">" + parameter[1]
						+ "</td>" + "  </tr>";
				swap = !swap;
			}
			parameter_html += "  <tr>" + "  </tr>";
		}
		if (!parameter_html.equals(""))
			parameter_html = "  <tr valign=\"top\">"
					+ "    <td width=\"92\" height=\"18\" bgcolor=" + bgColor3
					+ " colspan=\"2\"><font face=\"" + font
					+ "\" size=\"4\"><b>" + selected_parameters
					+ "</font></b></td>" + "  </tr>" + parameter_html;

		String format_html = "  <tr valign=\"top\" bgcolor=\"#FFFFFF\">"
