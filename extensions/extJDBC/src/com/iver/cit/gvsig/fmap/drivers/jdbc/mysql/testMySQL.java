...
/* CVS MESSAGES:
 * 
 * $Id: testMySQL.java 6566 2006-07-31 06:47:19Z jaume $
 * $Log$
...
public class testMySQL {
	...
	public static void main(String[] args) {
		...
		try {
			...
			java.sql.Driver drv = DriverManager.getDriver(conn.getMetaData()
					.getURL());
			...
			while (r.next()) {
				...
				/*
				 * int id = r.getInt(2); System.out.println("Row " + id + ":");
