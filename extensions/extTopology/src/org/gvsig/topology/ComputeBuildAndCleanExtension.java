...
public class ComputeBuildAndCleanExtension extends Extension {
	...
	String msgErrorLyrBuild = PluginServices.getText(this,"Desea_añadir_capa_con_geometrias_que_no_forman_parte_de_poligonos");
	
	String msgErrorLyrClean = PluginServices.getText(this,"Desea_añadir_capa_con_pseudonodos");
