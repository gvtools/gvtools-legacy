...
import com.iver.cit.gvsig.geoprocess.impl.lineorpolygontopoints.gui.LineToPointsGeoprocessPanel;
import com.iver.cit.gvsig.geoprocess.manager.GeoprocessManager;
import com.iver.cit.gvsig.project.documents.view.gui.View;

public class LineToPointsGeoprocessPlugin extends GeoprocessPluginAbstract  implements IGeoprocessPlugin {
	...
	static{
		...
		geoprocessName = PluginServices.getText(null, "LineOrPolygonToPoints");
	...
	public IGeoprocessUserEntries getGeoprocessPanel() {
		...
		return  new LineToPointsGeoprocessPanel(layers);
	}

	public URL getImgDescription() {
		URL url = PluginServices.getIconTheme().getURL("linetopoints-icon");
		return url;
	}

	public IGeoprocessController getGpController() {
		return new LineToPointsGeoprocessController();
	}
