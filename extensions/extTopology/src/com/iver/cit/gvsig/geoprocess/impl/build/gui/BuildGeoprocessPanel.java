...
public class BuildGeoprocessPanel extends AbstractGeoprocessGridbagPanel
	...
	protected void addSpecificDesign() {
		...
		this.cleanBeforeCb.setText(PluginServices.getText(this,
				"Limpiar_antes_geometrias"));
		addComponent(cleanBeforeCb, GridBagConstraints.NONE, new Insets(5, 5,
				5, 5));

		txtFuzzy = new JTextField();
		txtFuzzy.setEnabled(false);
		addComponent(PluginServices.getText(null, "Tolerancia_fuzzy"),
				txtFuzzy, GridBagConstraints.HORIZONTAL, new Insets(5, 20, 5,
						100));

		txtDangle = new JTextField();
		txtDangle.setEnabled(false);
		addComponent(PluginServices.getText(null, "Max_lenght_dangle_nodes"),
				txtDangle, GridBagConstraints.HORIZONTAL, new Insets(5, 20, 5,
						100));
