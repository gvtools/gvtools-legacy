...
class InfoPanel extends JPanel {
	...
	private final String layer_abstract = PluginServices.getText(this,
			"layer_abstract");
	private final String selected_dimensions = PluginServices.getText(this,
			"selected_dimensions");
	...
	public void refresh(WMSWizardData dataSource, Vector layers, Vector styles,
			String format, String srs, Vector dimensions) {
		...
		for (int i = 0; i < layers.size(); i++) {
			...
			String style_title = (styles == null) ? PluginServices.getText(
					this, "not_available") : (String) styles.get(i);// ((FMapWMSStyle)
		...
		if (dimensions != null) {
			...
			for (int i = 0; i < dimensions.size(); i++) {
				...
				dimension_html += "  <tr valign=\"top\" bgcolor="
						+ color
						+ ">"
						+ "    <td width=\"120\" height=\"18\" bgcolor=\"#D6D6D6\" align=\"right\"><b>"
						+ dimension[0] + "</b></td>"
						+ "    <td width=\"322\" height=\"18\">" + dimension[1]
						+ "</td>" + "  </tr>";
				swap = !swap;
			}
		}
		if (!dimension_html.equals(""))
			dimension_html = "  <tr valign=\"top\">"
					+ "    <td width=\"92\" height=\"18\" bgcolor=" + bgColor3
					+ " colspan=\"2\"><font face=\"" + font
					+ "\" size=\"4\"><b>" + selected_dimensions
					+ "</font></b></td>" + "  </tr>" + dimension_html;
