 ...
 * 
 */
public class WebMapContextSettingsPanel extends JPanel implements
		SingletonWindow {
	public static Preferences fPrefs = Preferences.userRoot().node(
			"gvsig.mapcontext-settingspanel");
	...
	protected boolean useFullExtent = fPrefs.getBoolean("use_full_extent",
			false);
	...
	private void switchPanels() {
		...
		if (!first) {
			PluginServices.getMDIManager().changeWindowInfo(this,
					getWindowInfo());
	...
	private JPanel getSimplePanel() {
		if (simplePanel == null) {
			...
			lblView.setText(PluginServices.getText(this,
	...
	private JPanel getAdvancedPanel() {
		if (advancedPanel == null) {
			...
			lblDescriptionURL.setText(PluginServices.getText(this,
					"description_URL") + ":");
			lblDescriptionURL
			...
			advancedPanel
					.setBorder(javax.swing.BorderFactory.createTitledBorder(
							null,
							PluginServices.getText(this, "advanced_settings"),
							javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
					...
					.addActionListener(new java.awt.event.ActionListener() {
						...
						public void actionPerformed(java.awt.event.ActionEvent e) {
							JFileChooser fc = new JFileChooser(
									ImportWebMapContextExtension.WMC_FILECHOOSER_ID,
									lastPath);
							...
							if (fc.showOpenDialog((Component) PluginServices
								...
								lastPath = fileName.substring(0, fileName
	...
	private JRadioButton getRdBtnUseViewSize() {
		if (rdBtnUseViewSize == null) {
			...
			rdBtnUseViewSize.setText(PluginServices.getText(this,
					"use_view_size"));
	...
	private JRadioButton getRdBtnCustomSize() {
		if (rdBtnCustomSize == null) {
			...
			rdBtnCustomSize.setText(PluginServices.getText(this,
					"use_custom_size"));
		}
	...
	private JTextField getTxtWidth() {
		if (txtWidth == null) {
			...
			Dimension sz = exportableViews[getCmbViews().getSelectedIndex()]
					.getMapContext().getViewPort().getImageSize();
	...
	private JTextField getTxtHeight() {
		if (txtHeight == null) {
			...
			Dimension sz = exportableViews[getCmbViews().getSelectedIndex()]
					.getMapContext().getViewPort().getImageSize();
			lastHeight = (sz != null) ? (int) sz.getHeight() + ""
					: defaultHeight + "";
	...
	private JPanel getPnlContactInfo() {
		if (pnlContactInfo == null) {
			...
			lblStateProvince.setText(PluginServices.getText(this,
					"state_or_province") + ":");
			lblStateProvince
					.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
			lblStateProvince
			...
			lblContactPosition.setText(PluginServices.getText(this,
					"contact_position"));
			lblContactOrganization = new JLabel();
			lblContactOrganization.setBounds(6, 44, 99, 20);
			lblContactOrganization
					.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
			lblContactOrganization
					.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
			lblContactOrganization.setText(PluginServices.getText(this,
			...
			lblContactPerson.setText(PluginServices.getText(this,
					"contact_person") + ":");
			lblContactPerson
					.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
			lblContactPerson
			...
			pnlContactInfo
					.setBorder(javax.swing.BorderFactory.createTitledBorder(
							null,
							PluginServices.getText(this, "contact_info"),
							javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
							javax.swing.border.TitledBorder.DEFAULT_POSITION,
							null, null));
	...
	private JComboBox getCmbCountries() {
		if (cmbCountries == null) {
			...
			String[] countries = PluginServices.getText(this,
					"countries_of_the_world").split(";");
		...
		if ("OK".equals(actionCommand)) {
			...
			if (str == null || str.equals("")) {
				JOptionPane.showMessageDialog(this,
						PluginServices.getText(this, "must_specify_a_file"),
						PluginServices.getText(this, "error"),
						JOptionPane.ERROR_MESSAGE);
				return;
			}
			ProjectView theView = exportableViews[getCmbViews()
					.getSelectedIndex()];
			...
			if (advanced) {
				if (getRdBtnUseViewSize().isSelected()) {
					...
					if (sz == null || (int) sz.getHeight() == 0
							|| (int) sz.getWidth() == 0)
						// View's size is not initialized, will use default
						// size.
					...
					try {
						...
						JOptionPane.showMessageDialog(this, PluginServices
								.getText(this, "invalid_dimension_values"),
								PluginServices.getText(this, "error"),
								JOptionPane.ERROR_MESSAGE);
						return;
					}
			...
			if (str != null && !str.equals(""))
				...
				JOptionPane.showMessageDialog(this, getTxtTitle().getName()
						+ " " + PluginServices.getText(this, "is_required"),
						PluginServices.getText(this, "error"),
						JOptionPane.ERROR_MESSAGE);
				return;
			}
			...
			if (str != null && !str.equals(""))
				...
				JOptionPane.showMessageDialog(this, getTxtId().getName() + " "
						+ PluginServices.getText(this, "is_required"),
						PluginServices.getText(this, "error"),
						JOptionPane.ERROR_MESSAGE);
				return;
			...
			if (str != null && !str.equals("")) {
				String[] ss = str.split("[, ;:]+"); // sequence of spaces,
													// commas, colons or
													// semicolons will be
			...
			ExportWebMapContextExtension exp = (ExportWebMapContextExtension) PluginServices
		...
		if (cmbViews == null) {
			...
			cmbViews.addItemListener(new java.awt.event.ItemListener() {
				public void itemStateChanged(java.awt.event.ItemEvent e) {
					ProjectView theView = exportableViews[getCmbViews()
							.getSelectedIndex()];
					Dimension sz = theView.getMapContext().getViewPort()
							.getImageSize();
					if (sz == null || (int) sz.getHeight() == 0
							|| (int) sz.getWidth() == 0)
						sz = new Dimension(defaultWidth, defaultHeight);
	...
	private JRadioButton getRdBtnCurrentViewExtent() {
		if (rdBtnCurrentViewExtent == null) {
			...
			rdBtnCurrentViewExtent.setText(PluginServices.getText(this,
					"defined_by_view_extent"));
			rdBtnCurrentViewExtent
					.addItemListener(new java.awt.event.ItemListener() {
						public void itemStateChanged(java.awt.event.ItemEvent e) {
							fPrefs.putBoolean("use_full_extent",
									!getRdBtnFullExtent().isEnabled());
						}
					});
	...
	private JRadioButton getRdBtnFullExtent() {
		if (rdBtnFullExtent == null) {
			...
			rdBtnFullExtent.setText(PluginServices.getText(this,
					"use_full_extent"));
			rdBtnFullExtent.addItemListener(new java.awt.event.ItemListener() {
				public void itemStateChanged(java.awt.event.ItemEvent e) {
					boolean b = getRdBtnFullExtent().isEnabled();
					fPrefs.putBoolean("use_full_extent", getRdBtnFullExtent()
							.isEnabled());
					useFullExtent = b;
				}
			});
