...
/**
 * LayerTree extends the standard JTree class to allow use custom tooltips. It
 * is just JTree containing WMSLayerNode at its nodes.
 * 
 * @author jaume
 * 
 */
public class LayerTree extends JTree {
	...
	/**
	 * Layer tree specific renderer allowing to show multiple line tooltips
	 * 
	 * @author jaume
	 * 
	 */
