...
public interface IFMapWMSDimension {
	...
	/**
	 * Returns the unit symbol (i.e. 'm', 's', or 'l' for meters, seconds, or
	 * liters respectively)
	 * 
	 * @return
	 */
	...
	/**
	 * This method returns the <b>lowest</b> value of this dimension if this
	 * dimension is specified as an interval or as a set of values, or the value
	 * specified if it was a single value.
	 * 
	...
	/**
	 * This method returns the <b>highest</b> value of this dimension if this
	 * dimension is specified as an interval or as a set of values, or the value
	 * specified if it was a single value.
	 * 
	 * @return String containing the coded value.
	 ...
	 * dimension's axis.
	 * 
	 * @return String containing the coded value, or null if no value for
	 *         resolution.
	 * @deprecated
	 */
	...
	/**
	 * Checks if the value represented as string is a valid value by checking if
	 * the dimensions supports it. It should be true if one of the following is
	 * true:
	 * <p>
	 * <ol>
	 * <li>
	 * The dimension <b>supports nearest values</b> and <b>the value is greather
	 * or equal than the low limit</b> and <b>less or equal than the high
	 * limit</b>.</li>
	 * <li>
	 * The value matches in one of the points defined by the low and high
	 * limits, and the resolution value.</li>
	 * </ol>
	 * </p>
	 * 
	 * @param value
	...
	/**
	 * Return the value of the String passed in the dimension's unit-natural
	 * type.
	 * 
	 * @param value
	 * @return
	 ...
	 * <b>IFMapWMSDimension.MULTIPLE_VALUE</b> <b>IFMapWMSDimension.INTERVAL</b>
	 * </li>
	 * </ol>
	 * 
	 * @return int
	...
	/**
	 * Analyzes and establishes the starting values for this dimension. No
	 * operation of this dimension can be called before the dimension has been
	 * compiled.
	 * 
	 * @throws IllegalArgumentException
	 */
