...
/**
 * GUI component to that allows user entrys to launch a Merge geoprocess.
 * 
 * @author azabala
 * 
 */
public class GeoProcessingMergePanel extends AbstractGeoprocessPanel implements
		MergePanelIF, IWindow {
	...
	/**
	 * Combo box to select which layer of the user selection will preserve its
	 * schema
	 */
	...
	/**
	 * It has a list with all the FLyrVect in the directory selected by the user
	 */
		...
		public Object getElementAt(int arg0) {
			if (arg0 < layers.getLayersCount())
				...
				if (aditionalLayers == null)
					...
					FLyrVect layer = aditionalLayers[arg0
	...
	public JTextField getFileNameResultTextField() {
		if (fileNameResultTextField == null) {
			super.getFileNameResultTextField().setBounds(
					new java.awt.Rectangle(134, 7, 194, 22));
		}
	...
	private JButton getDirectoryButton() {
		if (directoryButton == null) {
			...
			directoryButton.setText(PluginServices.getText(this,
	...
	public void layersSelected() {
		...
		AditionalLayerSelectorListener aditionalListener = new AditionalLayerSelectorListener(
				aditionalLayers);
		directoryLayerList.addListSelectionListener(aditionalListener);
		AditionalLayersListModel aditionalListModel = new AditionalLayersListModel(
				aditionalLayers);
	...
	private JScrollPane getDirectoryLayerScrollPane() {
		if (directoryLayerScrollPane == null) {
			...
			directoryLayerScrollPane.setBounds(new java.awt.Rectangle(10, 29,
					428, 59));
	...
	public WindowInfo getWindowInfo() {
		if (viewInfo == null) {
			...
			viewInfo.setTitle(PluginServices.getText(this, "Juntar"));
		}
		return viewInfo;
	}
	...
	private JPanel getDirectoryPanel() {
		if (directoryPanel == null) {
			...
			directoryLabel.setText(PluginServices.getText(this,
