...
/* CVS MESSAGES:
 *
 * $Id: ConvexHullGeoprocessPlugin.java 21232 2008-06-05 14:03:49Z azabala $
 * $Log$
...
public class ConvexHullGeoprocessPlugin extends GeoprocessPluginAbstract
	...
	static {
		...
		geoprocessName = PluginServices.getText(null, "Convex_Hull");
	...
	public IGeoprocessUserEntries getGeoprocessPanel() {
		...
		GeoProcessingConvexHullPanel2 panel = new GeoProcessingConvexHullPanel2(
				layers);
		return panel;
	}
