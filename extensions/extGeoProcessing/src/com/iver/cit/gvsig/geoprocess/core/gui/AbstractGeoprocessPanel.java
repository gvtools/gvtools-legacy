...
/**
 * Abstract base class with utility methods commons to all GeoprocessXXXPanel
 * 
 * @author azabala
 * 
 */
public abstract class AbstractGeoprocessPanel extends JPanel implements
		IGeoprocessPanel, IGeoprocessUserEntries {
	...
	/**
	 * Gives access to the text field where user could enter the result file
	 * path. If this method is called during the concrete gui subclasses
	 * building, caller must sets bounds of this component.
	 * 
	 * @return
	 */
