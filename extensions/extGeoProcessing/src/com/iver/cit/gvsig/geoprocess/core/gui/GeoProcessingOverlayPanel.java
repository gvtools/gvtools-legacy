...
/**
 * Panel that allows user to enter clip geoprocess params (input layers, etc).
 * 
...
public class GeoProcessingOverlayPanel extends AbstractGeoprocessPanel
	...
	/**
	 * Text that describes which type of overlay operation will launch this
	 * panel
	 */
	...
	/**
	 * 
	 * TODO El panel de seleccion de escritura esta metido a pelo en todas las
	 * pantallas. Hacer que sea generico, y vinculado a los IWriters cargados en
	 * el sistema.
	 * 
	 * 
	 */
	...
	private JCheckBox getOnlyFirstLayerSelectedCheckBox() {
		if (selectedFirstLayerCheckBox == null) {
			...
			selectedFirstLayerCheckBox.setText(PluginServices.getText(this,
					"Usar_solamente_los_elementos_seleccionados"));
			selectedFirstLayerCheckBox
	...
	private JPanel getResultLayerPanel() {
		if (resultLayerPanel == null) {
			...
			resultLayerPanel.add(getFileNameResultTextField(),
					gridBagConstraints1);
			resultLayerPanel
					.add(getOpenFileDialogButton(), gridBagConstraints2);
	...
	private JPanel getClipLayerjPanel() {
		if (clipLayerjPanel == null) {
			...
			jLabel4.setText(PluginServices
					.getText(this, "Cobertura_de_recorte") + ":");
			jLabel6 = new JLabel();
			jLabel6.setText("00");
			jLabel5 = new JLabel();
			...
			clipLayerjPanel.add(getOnlySecondLayerSelectedCheckBox(),
	...
	private JPanel getInputLayerPanel() {
		if (inputLayerPanel == null) {
			...
			inputLayerPanel.add(getOnlyFirstLayerSelectedCheckBox(),
					gridBagConstraints4);
