...
/* CVS MESSAGES:
 *
 * $Id: CacherJTSProcessor.java 5412 2006-05-24 21:15:07Z azabala $
 * $Log$
...
/**
 * Processes individual geometries procedent from a geoprocessing operation, by
 * caching them in a multilevel memory/file cache.
 * 
 * TODO Maybe, we could work with a VectorialEditableAdapter (spatially indexed)
 * and save results in a third layer
 * 
 * @author azabala
 * 
 *         TODO DEPRECAR!!!
...
public class CacherJTSProcessor implements GeoprocessingResultsProcessor {
	/**
	 * It caches JTS geometries (to process them in a second pass)
	 */
	...
	public CacherJTSProcessor() throws GeoprocessException {
		try {
			...
			throw new GeoprocessException(
					"Problemas para guardar la capa de salida");
		}
	}
	...
	public void processJtsGeometry(Geometry g, int index) {
		spatialCache.put((long) index, g.getEnvelopeInternal(), g);
