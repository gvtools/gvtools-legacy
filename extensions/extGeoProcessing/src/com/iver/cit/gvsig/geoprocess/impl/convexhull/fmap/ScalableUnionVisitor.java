...
/* CVS MESSAGES:
 *
 * $Id: ScalableUnionVisitor.java 12949 2007-08-07 15:23:01Z azabala $
 * $Log$
...
public class ScalableUnionVisitor extends ScalableConvexHullVisitor {
	...
	public void visit(IGeometry g, int index) throws VisitorException,
		...
		/*
		 * TODO Aquí estamos desechando aquellas geometrias cuyo tipo no es
		 * POLYGON (el tipo MULTI no aparece por ningún lado)
		 * 
		 * Se puede dar el caso de que una capa tenga polilineas cerradas, y el
		 * usuario visualmente piensa que son poligonos.
		 * 
