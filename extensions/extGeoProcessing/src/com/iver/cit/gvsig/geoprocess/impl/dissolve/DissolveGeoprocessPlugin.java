...
/* CVS MESSAGES:
 *
 * $Id: DissolveGeoprocessPlugin.java 21232 2008-06-05 14:03:49Z azabala $
 * $Log$
...
public class DissolveGeoprocessPlugin extends GeoprocessPluginAbstract
	...
	static {
		...
		GeoprocessManager.registerPackageDescription(analisisPkg + "/"
				+ agregationPkg, agregationPkgDesc);
	}
	...
	public IGeoprocessUserEntries getGeoprocessPanel() {
		...
		GeoProcessingDissolvePanel2 dataSelectionPanel = new GeoProcessingDissolvePanel2(
				layers);
