 ...
 * except that it works for <tt>double</tt> values instead of Objects.
 ...
 *
 * <p>Each <tt>DoubleList</tt> instance has a <i>capacity</i>.  The capacity is
 * the size of the array used to store the elements in the list.  It is always
 * at least as large as the list size.  As elements are added to an DoubleList,
 * its capacity grows automatically.  The details of the growth policy are not
 * specified beyond the fact that adding an element has constant amortized
 * time cost.
 *
 * <p>An application can increase the capacity of an <tt>DoubleList</tt> instance
 * before adding a large number of elements using the <tt>ensureCapacity</tt>
 * operation.  This may reduce the amount of incremental reallocation.
 *
 * <p><strong>Note that this implementation is not synchronized.</strong>
 * If multiple threads access an <tt>DoubleList</tt> instance concurrently,
 ...
 * @author  Josh Bloch
 * @author  Neal Gafter
 * @author  Adapted to <tt>double</tt> primitive type by Cesar Martinez Izquierdo <cesar.martinez@iver.es>
 * @see     Collection
 * @see     List
 * @see     LinkedList
 * @see     Vector
...
public class DoubleList implements RandomAccess, Cloneable, Serializable
{
     ...
     * specified collection.
     *
     * @param c DoubleList containing elements to be removed from this list
    ...
    /**
     * Save the state of the <tt>DoubleList</tt> instance to a stream (that
     * is, serialize it).
     *
