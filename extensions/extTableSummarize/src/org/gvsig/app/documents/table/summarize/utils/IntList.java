 ...
 * 
 * ------
 * This class has been adapted to work with the int primitive type instead
...
/**
 * Resizable-array implementation similar to the <tt>List</tt> interface,
 * except that it works for <tt>integer</tt> values instead of Objects.
 * Implements methods similar to the list operations, except the methods
 ...
 *
 * <p>Each <tt>IntList</tt> instance has a <i>capacity</i>.  The capacity is
 * the size of the array used to store the elements in the list.  It is always
 * at least as large as the list size.  As elements are added to an IntList,
 * its capacity grows automatically.  The details of the growth policy are not
 * specified beyond the fact that adding an element has constant amortized
 * time cost.
 *
 * <p>An application can increase the capacity of an <tt>IntList</tt> instance
 * before adding a large number of elements using the <tt>ensureCapacity</tt>
 * operation.  This may reduce the amount of incremental reallocation.
 *
 * <p><strong>Note that this implementation is not synchronized.</strong>
 * If multiple threads access an <tt>IntList</tt> instance concurrently,
 ...
 * @author  Josh Bloch
 * @author  Neal Gafter
 * @author  Adapted to <tt>int</tt> primitive type by Cesar Martinez Izquierdo <cesar.martinez@iver.es>
 * @see     Collection
 * @see     List
 * @see     LinkedList
 * @see     Vector
...
public class IntList implements RandomAccess, Cloneable, Serializable
{
     ...
     * The capacity of the IntList is the length of this array buffer.
     */
    ...
    /**
     * Trims the capacity of this <tt>IntList</tt> instance to be the
     * list's current size.  An application can use this operation to minimize
     * the storage of an <tt>IntList</tt> instance.
     */
    ...
    /**
     * Returns a shallow copy of this <tt>IntList</tt> instance.  (The
     ...
     * specified array's size, it is returned therein.
     ...
     * unchanged. Returns <tt>true</tt> if this list
     ...
     * specified collection.
     *
     * @param c IntList containing elements to be removed from this list
    ...
    /**
     * Save the state of the <tt>IntList</tt> instance to a stream (that
     * is, serialize it).
     *
     * @serialData The length of the array backing the <tt>IntList</tt>
     *             instance is emitted (int), followed by all of its elements
     *             (each a <tt>int</tt>) in the proper order.
     */
    ...
    private class SubList extends IntList implements RandomAccess {
        ...
        public int removeAt(int index) {
            rangeCheck(index);
            checkForComodification();
            int result = parent.removeAt(parentOffset + index);
            this.modCount = parent.modCount;
            this.size--;
            return result;
        }
