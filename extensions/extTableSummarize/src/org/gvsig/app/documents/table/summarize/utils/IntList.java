 ...
 * that it works for <tt>integer</tt> values instead of Objects. Implements
 ...
 * @author Josh Bloch
 * @author Neal Gafter
 * @author Adapted to <tt>int</tt> primitive type by Cesar Martinez Izquierdo
...
public class IntList implements RandomAccess, Cloneable, Serializable {
	 ...
	 * capacity of the IntList is the length of this array buffer.
	 */
	 ...
	 * 
	 * @param c
	 *            IntList containing elements to be removed from this list
	 ...
	 * serialize it).
	 * 
	 * @serialData The length of the array backing the <tt>IntList</tt> instance
	 *             is emitted (int), followed by all of its elements (each a
	...
	private class SubList extends IntList implements RandomAccess {
		...
		SubList(IntList parent, int offset, int fromIndex, int toIndex) {
			this.parent = parent;
