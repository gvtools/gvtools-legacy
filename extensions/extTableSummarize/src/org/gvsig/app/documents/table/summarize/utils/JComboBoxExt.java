...
/**
 * JComboBoxExt es una clase que extiende JComboBox para incorporar nuevas características como 
 * lo posibilidad de bloquear la edición en el control por parte del usuario.
 */
public class JComboBoxExt extends JComboBox{
	...
	*/
	 ...
	 *                         de si el control está bloqueado o no (locked) 
	 */
	public void setSelectedIndex(int anIndex, boolean forceSelection) {
		if (isLocked() && !forceSelection) return;
		//OJO: setSelectedIndex llama internamente a super.setSelectedItem() que a su vez llamará a setSelectedItem(anObject, false)!!! 
		//Con este flujo, el valor de forceSelection en este método no se propaga! Para solucionar esto no debemos sobrescribir 
		//setSelectedItem. El boqueo sigue funcionando igual porque cuando actúas desde el interfaz de usuario, para seleccionar un
