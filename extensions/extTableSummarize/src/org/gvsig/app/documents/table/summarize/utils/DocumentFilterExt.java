...
/**
 * DocumentFilterExt extiende a DocumentFilter para limitar el nº máximo de caracteres que
...
class DocumentFilterExt extends DocumentFilter {
    private int maxLength = 0;                  //Indica la longitud máxima de caracteres admitida. Si cero, no hay longitud máxima!
	...
	/**
     * Esta función se encarga de analizar el texto que se va a insertar en el documento. En caso
     * de que sea más grande que el tamaño máximo permitido devuelve la parte "que cabe" hasta 
     ...
     * @param offs: Lugar de inserción en el documento
