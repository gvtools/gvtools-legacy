 ...
 */
	 ...
	 * @param forbidden
	 */
	public XMLTreeTableModel(XMLNode node, int level, String[] allowed,
			String[] forbidden) {
 ...
 */
	 ...
	 * @param width
	 */
	public void addJScrollPaneColumn(String name, String attribute,
	 ...
	 * @param width
	 */
	public void addStringColumn(String name, String attribute, String label,
			int width) {
		addColumn(new Column(name, attribute, label, ALIGN_LEFT, width,
				String.class, null));
	}
	 ...
	 * @param format
	 */
	public void addNumberColumn(String name, String attribute, String label,
	 ...
	 * @param format
	 */
	public void addDateColumn(String name, String attribute, String label,
			int width, String format) {
		addColumn(new Column(name, attribute, label, ALIGN_LEFT, width,
				Date.class, format));
	}
		...
		if (currentNode.getUserObject() instanceof XMLNode) {
			...
			if (xr != null) {
				if (getAttribute(xr) != null) {
					if (!(Strings.replace(getAttribute(xr), " ", "").equals(""))) {
						return true;
					}
				}
			}
 ...
 */
		 ...
		 * @param format
		 */
		Column(String name, String attribute, String label, int align,
				int width, Class jClass, String format) {
			this.name = name;
