...
import es.gva.cit.catalog.ui.chooseresource.ChooseResourceDialogPanel;
 ...
 */
	 ...
	 * @param dialog
	 */
	public ButtonEditor(JCheckBox checkBox, Collection resources,
	...
	public Object getCellEditorValue() {
		if (isPushed) {
			Resource resource = (Resource) resources.toArray()[Integer.valueOf(
					button.getName()).intValue()];
