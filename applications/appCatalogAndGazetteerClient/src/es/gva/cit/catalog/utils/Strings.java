...
public class Strings {
	...
	/**
	 * This method creates an String of words (blanck separated) enveloped by
	 * asteriscs: Example "This is an example" returns
	 * "*This* *is* *an* *example*"
	 * 
	 * 
	 * @return String
	 ...
	 *            Input String
	 * @param charNumber
	 *            Number of chars that must be tried
	 */
	...
	/**
	 * This method returns all the forms than can have a word to do an advanced
	 * search. A form could be to change all the characters to lower case, other
	 * one could be to change only the first character to upper case, ...
	 * 
	 * @param str
	 *            Input string
