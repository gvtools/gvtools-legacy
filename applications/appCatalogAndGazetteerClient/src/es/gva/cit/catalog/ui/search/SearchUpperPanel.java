...
public class SearchUpperPanel extends JPanel {
	...
	private void initComponents() {
		...
		rigthPanel.setBorder(javax.swing.BorderFactory.createEmptyBorder(72, 1,
				1, 1));
		...
		areaCheckBox.setBorder(javax.swing.BorderFactory.createEmptyBorder(0,
				0, 0, 0));
	...
	private void initLabels() {
		...
		resizeButton.setPreferredSize(new Dimension(
	...
	public void setUpIcon() {
		resizeButton
				.setIcon(new ImageIcon(
						"./gvSIG/extensiones/es.gva.cit.gvsig.catalogClient/images/up.png"));
	}
	...
	public void setDownIcon() {
		resizeButton
				.setIcon(new ImageIcon(
						"./gvSIG/extensiones/es.gva.cit.gvsig.catalogClient/images/down.png"));
