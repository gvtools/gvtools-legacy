...
/**
 * this class represent the "choose resource frame". It is basically contains a
 * list with all the geo-resources that can be loaded. *
 * 
 * 
 ...
 */
	public void setDefaultButtonListeners() {
		...
		getControlsPanel().getTable()
				.getColumn(Messages.getText("resourceShowColumn"))
				.setCellRenderer(new ButtonRenderer());
		getControlsPanel()
				.getTable()
				.getColumn(Messages.getText("resourceShowColumn"))
				.setCellEditor(
						new ButtonEditor(new JCheckBox(), resources, this));
	...
	public void resourceButtonActionPerformed(Resource resource) {
		System.out.println(resource.getLinkage()
				+ " no se puede cargar sin usar gvSIG");
	}
