...
public class ChooseResourceDialog extends JFrame implements WindowListener {
	...
	private void initialize(Collection resources) {
		...
		ChooseResourceDialogPanel panel = new ChooseResourceDialogPanel(
				resources);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see es.gva.cit.catalogClient.ui.ILoadResource#loadResource(es.gva.cit.
	 * catalogClient.parsers.Resource)
	 */
	...
	public void loadResource(Resource resource) {
		System.out.println(resource.getLinkage()
				+ " solo puede ser cargado usando gvSIG");
	}
}
