...
/**
 * All classes that implement a new catalog protocol must to inherit to this
 * class.ç It contains the common atributes for the protocols.
 * 
 * 
 * @author Jorge Piera Llodra (piera_jor@gva.es)
 */
public abstract class AbstractCatalogServiceDriver extends
		AbstractDiscoveryServiceDriver implements ICatalogServiceDriver {
	...
	/**
	 * Used to set a ServerData that contains the properties that have been
	 * fixed by the user
	 */
	...
	/**
	 * Gets the profile. It has to be implemented by all the drivers with
	 * profile
	 * 
	 * @return The profile
	 */
	 ...
	 *            The answer tree
	 * @param label
	 *            Node Name that contains the value
	 * @param attribute
	 *            Attributes wich contain the value
	 */
	public int getNumberOfRecords(XMLNode node, String label, String attribute) {
		...
		if (attribute != null)
			sNumberOfRecords = XMLTree.searchNodeAtribute(node, label,
					attribute);
		else
