...
/**
 * This interface has one method for each operation and for each communication
 * protocol. Each method returns the protocol message.
 * 
 * 
...
public interface IProtocolMessages {
	 ...
	 * @param upper
	 *            If the 'G' of the getCapabilities must be written in uppercase
	 */
	 ...
	 * @param firstRecord
	 */
	public NameValuePair[] getHTTPGETFeatures(GazetteerQuery query,
			int firstRecord);
