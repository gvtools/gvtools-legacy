 ...
 *   dac@iver.es
 */
package es.gva.cit.gazetteer.adl.languages;

import java.util.Iterator;

import es.gva.cit.catalog.languages.AbstractGeneralLanguage;

/**
 * This class is used to create a query in the language supported by the ADL
 * protocol
 * 
 * 
...
public class AdlLanguage extends AbstractGeneralLanguage {
	 ...
	 *            operation option
	 */
	public void addClauses(String parameter, String line, String concordancia,
			String option) {
		currentClause = null;
	 ...
	 * @param operator
	 */
	public void addClauses(String parameter, Iterator values,
			String concordancia, String operator) {
	...
	public String toString() {
		return "<query-request>" + "<gazetteer-query>" + currentQuery
				+ "</gazetteer-query>"
	...
	public String containsPhrase(String value) {
		return "<name-query operator=\"contains-phrase\" " + "text=\"" + value
				+ "\"/>";
	}
	...
	public String classQuery(String value) {
		return "<class-query " + "thesaurus=\"ADL Feature Type Thesaurus\" "
				+ "term=\"" + value + "\"/>";
	}
	...
	public String addBoundingBox(String coordinates) {
		return "<footprint-query operator=\"overlaps\">" + "<gml:Box>"
				+ "<gml:coordinates>" + coordinates + "</gml:coordinates>"
				+ "</gml:Box>" + "</footprint-query>";
