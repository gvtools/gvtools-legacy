 ...
 */
	...
	public void actualizaLabel(int number, int recordsByPage) {
		textLabel.setText(Messages.getText("results") + ": "
				...
				+ Messages.getText("page") + " " + String.valueOf(number) + " "
				+ Messages.getText("of") + " " + " "
				+ String.valueOf(this.numPages));
		loadList((number * recordsByPage) - recordsByPage,
				(number * recordsByPage) - 1);
	}
	...
	public Feature getFeature() {
		if (descriptionList.getSelectedIndex() == -1)
			return null;
		return (Feature) listModel.getElementAt(descriptionList
				.getSelectedIndex());
	}
