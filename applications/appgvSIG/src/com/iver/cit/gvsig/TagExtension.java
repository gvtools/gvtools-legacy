...
public class TagExtension extends Extension {
	private static Logger logger = Logger.getLogger(TagExtension.class
			.getName());
	...
	private void registerIcons() {
		...
		PluginServices.getIconTheme().registerDefault("layout-tag",
				this.getClass().getClassLoader().getResource("images/tag.png"));

		PluginServices.getIconTheme().registerDefault(
				"layout-insert-tag",
				this.getClass().getClassLoader()
						.getResource("images/gtk-add.png"));

		PluginServices.getIconTheme().registerDefault(
				"layout-show-tag",
				this.getClass().getClassLoader()
						.getResource("images/gtk-apply.png"));
	}
	...
	public void execute(String s) {
		 ...
		 * logger.debug("Comand : " + s); if (s.compareTo("SET_TAG") == 0) {
		...
		if (s.equals("SET_TAG")) {
			IFFrame[] selectedFrames = layout.getLayoutContext()
					.getFFrameSelected();
			if (selectedFrames.length > 0) {
				String defaultStr = "";
				if (selectedFrames.length == 1)
					defaultStr = selectedFrames[0].getTag();
				String theTag = JOptionPane.showInputDialog(
