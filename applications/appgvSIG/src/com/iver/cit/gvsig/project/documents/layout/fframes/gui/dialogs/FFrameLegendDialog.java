...
public class FFrameLegendDialog extends JPanel implements IFFrameDialog {
		...
		if (accept == null) {
			...
			okAction = new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					// }
					// }
					newFFrameLegend = (FFrameLegend) fframelegend
					 ...
					 * fframelegend.setLayers(m_projectView
	...
	private void refreshLayers(FLayers layers, boolean first) {
		...
		for (int i = layers.getLayersCount() - 1; i >= 0; i--) {
			 ...
			 * //refreshLayers((FLayers)layer,false); }else
			 */
			{
	...
	private JButton getBFuente() {
		if (bFuente == null) {
			...
			bFuente.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (font != null) {
						font = FontChooser.showDialog(PluginServices.getText(
								this, "seleccion_fuente"), font); // fchoser=new
																	// FontChooser();
					} else {
						font = FontChooser.showDialog(PluginServices.getText(
								this, "seleccion_fuente"), getFont());
					}
				}
			});
		}
