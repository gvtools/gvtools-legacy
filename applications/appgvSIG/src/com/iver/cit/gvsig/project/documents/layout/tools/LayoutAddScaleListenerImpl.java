...
public class LayoutAddScaleListenerImpl extends LayoutAddRectangleListener {
	...
	public void rectangle(RectangleEvent event) throws BehaviorException {
		FFrameScaleBar fframe = (FFrameScaleBar) FrameFactory
				.createFrameFromName(FFrameScaleBarFactory.registerName);
		...
		FFrameScaleBarDialog fframedialog = new FFrameScaleBarDialog(layout,
				fframe);
