...
public interface IFFrame extends IPrintable {
	...
	/**
	 * Devuelve el boundingBox del fframe en función de la transformada afín que
	 * se pasa como parámetro. Si se pasa como parámetro null, devuelve el
	 ...
	 * dibuja de una forma diferente sobre el graphics. Método que dibuja sobre
	 * el graphics que se le pasa como parámetro, según la transformada afin que
	 * se debe de aplicar y el rectángulo que se debe de dibujar.
	 * 
	 * @param g
	 *            Graphics
	 * @param at
	...
	/**
	 * Pasando como parámetro true, se toma como que está seleccionado el fframe
	 * y si es false como que esta sin seleccionar, de esta forma se selecciona
	 * un fframe directamente sin comprobar si un punto está contenido en él.
	 * 
	 * @param b
	...
	/**
	 * Dibuja un rectángulo de color gris, con el nombre en el centro y escalado
	...
	/**
	 * Actualiza el BoundBox del FFrame a partir de su rectángulo en pixels y la
	...
	/**
	 * Devuelve true si el rectángulo primero es null o si es distinto de null e
	 * intersecta.
	 * 
	 * @param rv
	 *            Rectángulo
	 ...
	 * 
	 * @param rotation
	 *            rotación que se quiere aplicar.
	 */
	...
	/**
	 * Inserta el nivel de dibujado del FFrame respecto del resto de fframes del
	 * Layout.
	 * 
	 * @param l
	 *            nivel.
	...
	/**
	 * Operaciones necesarias para finalizar correctamente el clonado de un
	 * frame, por ejemplo los listeners.
	 * 
	 * @param frame
	 *            IFFrame del cual copiar los listeners.
	 */
