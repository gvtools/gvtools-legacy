...
public class JPRotation extends JPanel {
	 ...
	 */
	/*
	 * private boolean ensureDouble(JTextField tf){ String s = tf.getText(); try
	 * { Double.parseDouble(s); return true; } catch (Exception e){ if
	 * (s.length()!=0){ // tf.setText(s.substring(0, s.length()-1)); }else {
	 * //tf.setText("0"); } return true; } }
	 */
	/**
