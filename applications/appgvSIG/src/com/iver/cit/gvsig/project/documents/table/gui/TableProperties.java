...
public class TableProperties extends JPanel implements SingletonWindow {
	 ...
	 * @param t
	 *            Tabla que se representa en el diálogo
					...
					new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							...
							if (tm instanceof TableModelProperties) {
								table.setAliases(((TableModelProperties) tm)
										.getAliases());
								table.setMapping(((TableModelProperties) tm)
										.getFieldMapping());
							}
	...
	private javax.swing.JPanel getJPanel() {
		if (jPanel == null) {
			 ...
			 * layFlowLayout9.setVgap(9); jPanel.setLayout(layFlowLayout9);
			 */
