...
/**
 * <p>
 * Listener to select the upper layer with raster data that has information in
 * the associated <code>MapControl</code> object, down the position selected by
 * a single click of any button of the mouse.
 * </p>
 * 
 * <p>
 * The layer selected will be set as <i>active</i>, and the available controls
 * for managing the data will be updated, enabling and disabling the necessary.
 * </p>
 * 
 * <p>
 * The status of the other layers will be changed to <i>not active</i>.
 * </p>
 * 
 * @deprecated
...
public class SelectImageListener extends SelectImageListenerImpl {
	...
	/**
	 * <p>
	 * Creates a new <code>SelectImageListener</code> object.
	 * </p>
	 * 
	 * @param mapCtrl
	 *            the <code>MapControl</code> where are stored the layers
	 */
	...
	/**
	 * Determines if the <code>layer</code> is selected at a position starting
	 * by the end.
	 * 
	 * @param layer
	 *            kind of layer
	 * @param pos
	 *            number of positions starting by the end
	 * 
	 * @return <code>true</code> if the <code>layer</code> is selected at a
	 *         position starting by the end, otherwise <code>false</code>
	 */
