			...
			this.acceptCancel = new AcceptCancelPanel(
					new java.awt.event.ActionListener() { // Accept
						...
						public void actionPerformed(java.awt.event.ActionEvent e) {
							newFFrameNorth = (FFrameNorth) fframenorth
									.cloneFFrame(layout);
							if (m_file != null) {
								...
								try {
									dimension = fframenorth.getBound(m_file
											.getAbsolutePath());
								} catch (Exception ex) {
									NotificationManager.addError("Excepción :",
											ex);
								}
								newFFrameNorth
			...
			listNorth
					.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
						...
						public void valueChanged(
							...
							m_file = new File((String) ((JList) e.getSource())
									.getSelectedValue());
