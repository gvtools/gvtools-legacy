 ...
 * 
 * Basic separator "," -> csv basic file Excel separator ";" -> csv file to work
 * in gvSIG documents
 * 
...
public class CSVSeparatorOptionsPanel extends JPanel implements IWindow,
	...
	private JRadioButton getJCheckBoxComma() {
		if (commaOption == null) {
			commaOption = new JRadioButton(
					PluginServices.getText(this, "comma"), false);
	...
	private JRadioButton getJCheckBoxPointComma() {
		if (semicolonOption == null) {
			semicolonOption = new JRadioButton(PluginServices.getText(this,
					"semicolon"), true);
	...
	private JRadioButton getJCheckBoxOtherSymbol() {
		if (otherSymbol == null) {
			otherSymbol = new JRadioButton(PluginServices.getText(this,
					"otro_simbolo"), false);
	...
	/**
	 * 
	 * @return separator - Chosen as the separator character or separator string
	 */
