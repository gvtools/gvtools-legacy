...
/**
 * <p>
 * Lightweight <code>MapControl</code> that uses another <code>MapControl</code>
 * 's <code>MapContext</code>, and updates any rectangular extent selected, to
 * the associated <code>MapControl</code>.
 * </p>
 * 
 * <p>
 * Both <code>MapControl</code> instances work in the same projection. And,
 * always, the not undefined <i>adjusted extent</i> of the associated one, will
 * be enhanced as a red-bordered grey-filled rectangle in this one. Furthermore,
 * draws a horizontal and vertical this component's width or height, black lines
 * centered in that rectangle.
 * </p>
 * 
 * @author FJP
 */
public class MapOverview extends MapControl implements ViewPortListener {
	/**
	 * <p>
	 * Associated <code>MapControl</code> instance that this component
	 * represents its overview.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Determines that's the first time this component is going to be painted.
	 * </p>
	 */
	boolean first = true;
	...
	/**
	 * <p>
	 * Tool listener used to apply a <i>zoom out</i> operation in this component
	...
	/**
	 * <p>
	 * Tool listener used to allow user work with this component applying
	 * <i>pan</i> operations.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Rectangular area selected in this component, that will be the extent of
	...
	/**
	 * <p>
	 * Double buffer used to paint this component graphical information.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Creates a <code>MapOverview</code> instance associated to
	 * <code>mapAssoc</code>.
	 * </p>
	 * 
	 * @param mapAssoc
	 *            <code>MapControl</code> this component will be the overview
	 */
	public MapOverview(MapControl mapAssoc) {
		...
		// setModel((FMap) m_MapAssoc.getMapContext().clone()); // Lo
		// inicializamos con
		...
		addMapTool("zoomtopoint", new Behavior[] { new PointBehavior(movl),
				new RectangleBehavior(movczl), new DraggerBehavior(movczl),
	...
	/**
	 * <p>
	 * Gets the <code>MapControl</code> instance that wrappers.
	 * </p>
	 * 
	...
	public void extentChanged(ExtentEvent evExtent) {
		// Nos llega el nuevo extent del FMap asociado, así que dibujamos
		// nuestro
	...
	/**
	 * <p>
	 * If this had no extent, calls {@link #delModel() #delModel()}, otherwise
	 * recalculates this component's view port extent as the union of all
	 * extents of all layers of this map.
	 * </p>
	 */
		...
		try {
			if (this.getMapContext().getFullExtent() != null) {
				this.getMapContext().getViewPort()
						.setExtent(this.getMapContext().getFullExtent());
			} else {
				delModel();
			}
	...
	/**
	 * <p>
	 * Repaints this component updating its <i>extent</i>.
	 * </p>
	 * 
	 * @param r
	 *            the new extent
	...
	/**
	 * <p>
	 * Paints this component's graphical information using a 8-bit RGBA color
	 * double buffer, drawing a red-bordered grey-filled rectangle enhancing the
	 * extent selected, and a horizontal and vertical this component's width or
	...
	protected void paintComponent(Graphics g) {
		...
		if ((m_MapAssoc.getMapContext().getViewPort().getExtent() != null)
			...
			Line2D.Double linVert = new Line2D.Double(extent.getCenterX(),
					extentView.getMinY(), extent.getCenterX(), pRightUp.getY());
	...
	/**
	 * <p>
	 * Sets a <code>MapContext</code> to this component, configuring it to
	 * manage view port events produced in the associated
	 * <code>MapControl</code> and this one's view port.
	 * </p>
	 * 
	 * <p>
	 * This <code>MapContext</code>'s projection will be the same as the
	 * associated <code>MapControl</code>'s one.
	 * </p>
	 * 
	 * <p>
	 * Setting the model includes the following steps:
	 * <ul>
	 * <li><b>1.-</b> set <code>model</code> as the <code>MapContext</code> of
	 * <code>this</code>.</li>
	 * <li><b>2.-</b> set as <code>model</code> projection, the associated
	 * <code>MapControl<code>'s projection.</li>
	 * <li><b>3.-</b> set <code>this</code> as <i>view port</i> listener of the
	 * associated <code>MapControl</code>'s <i>view port</i>.</li>
	 * <li><b>4.-</b> set <code>this</code> as <i>view port</i> listener of this
	 * <code>MapContext</code>'s <i>view port</i></li>
	 * </ul>
	 * </p>
	 * 
	 * @param model
	 ...
	 * <code>MapControl</code> and this one's view port. Besides, removes the
	 * extent.
	 * </p>
	 */
