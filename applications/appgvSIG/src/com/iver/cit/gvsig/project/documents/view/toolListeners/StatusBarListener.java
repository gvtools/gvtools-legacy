...
public class StatusBarListener implements PointListener {
	...
	public void point(PointEvent event) throws BehaviorException {
		...
		axisText[0] = "X = ";
		axisText[1] = "Y = ";
		Point2D p = mapControl.getMapContext().getViewPort()
		...
		if (mF != null) {
			...
			mF.getStatusBar().setMessage(
					...
					PluginServices.getText(this, mapControl.getMapContext()
							.getDistanceNames()[mapControl.getMapContext()
			...
			mF.getStatusBar()
					.setMessage(
							"projection",
							ProjectionUtils.getAbrev(mapControl.getViewPort()
									.getCrs()));
	...
	public String[] getCoords(Point2D p) {
		...
		if (!(crs instanceof ProjectedCRS)) {
			...
			if (PluginServices.getText(
					this,
					MapContext.getDistanceNames()[mapControl.getViewPort()
							.getDistanceUnits()]).equals(
				...
				coords[0] = String
						.valueOf(nf.format((p.getX() / trans2Meter[mapControl
								.getViewPort().getDistanceUnits()])
								* trans2Meter[mapControl.getViewPort()
										.getMapUnits()]));
				coords[1] = String
						.valueOf(nf.format((p.getY() / trans2Meter[mapControl
								.getViewPort().getDistanceUnits()])
								* trans2Meter[mapControl.getViewPort()
										.getMapUnits()]));
			}
