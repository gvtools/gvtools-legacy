 ...
 * 
 * This class will save information of the user session, to recover later.
 * 
 * The key of the session will be the Andami's view (to allows a user to save
 * different user sessions for different views)
 * */
