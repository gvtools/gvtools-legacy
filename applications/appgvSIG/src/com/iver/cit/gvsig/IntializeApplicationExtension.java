...
public class IntializeApplicationExtension extends Extension {
	...
	private void registerIcons() {
		...
		PluginServices.getIconTheme().registerDefault(
				...
				this.getClass().getClassLoader()
						.getResource("images/addeventtheme.png"));
		PluginServices.getIconTheme().registerDefault(
				"gvsig-logo-icon",
				this.getClass().getClassLoader()
						.getResource("images/icon_gvsig.png"));

		PluginServices.getIconTheme().registerDefault(
				"mapa-icono",
				this.getClass().getClassLoader()
						.getResource("images/mapas.png"));
		...
		PluginServices.getIconTheme().registerDefault(
				"add-layer-icono",
				this.getClass().getClassLoader()
						.getResource("images/add-layer.png"));
	...
	public String getStringInfo() {
		...
		try {
			try {
				extensionsPath = (new File(Launcher.getAndamiConfig()
						.getPluginsDirectory())).getCanonicalPath();
			} catch (IOException e) {
				extensionsPath = (new File(Launcher.getAndamiConfig()
						.getPluginsDirectory())).getAbsolutePath();
			}
		} catch (Exception e1) {
			extensionsPath = "???";
		}
		...
		writer.write("    gvSIG locale language: "
