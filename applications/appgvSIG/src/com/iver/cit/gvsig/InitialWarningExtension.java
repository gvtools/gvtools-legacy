...
public class InitialWarningExtension extends Extension {
	...
	private class DlgWaring extends JWindow {
		...
		public DlgWaring() {
			...
			setLocation(window.getWidth() / 2 + window.getX() - 150,
					window.getHeight() / 2 + window.getY() - 150);
			initialize();
		...
		private void initialize() {
			...
			lblText.setBorder(new TitledBorder(PluginServices.getText(this,
					"warning")));
			panel2.add(lblText);
			panel2.setSize((int) (panel.getSize().getWidth() - 4), (int) (panel
					.getSize().getHeight() - 4));
			panel.add(panel2);
			this.setLayout(null);
		...
		// chkBoxShowAgain.setText(PluginServices.getText(this,
