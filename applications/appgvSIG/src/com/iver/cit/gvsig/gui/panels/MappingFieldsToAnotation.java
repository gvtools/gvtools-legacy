...
public class MappingFieldsToAnotation extends JPanel implements IWindow {
	...
	public WindowInfo getWindowInfo() {
		...
		m_viewinfo.setTitle(PluginServices.getText(this, "indexar_campos"));
			...
			bOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (getCmbText().getSelectedItem().equals(""))
						...
						mapping.setColumnText(mapText[getCmbText()
								.getSelectedIndex()]);
					if (!getCmbAngle().getSelectedItem().equals("- Default -"))
						mapping.setColumnRotate(mapAngle[getCmbAngle()
								.getSelectedIndex()]);
					if (!getCmbColor().getSelectedItem().equals("- Default -"))
						mapping.setColumnColor(mapColor[getCmbColor()
								.getSelectedIndex()]);
					if (!getCmbHeight().getSelectedItem().equals("- Default -"))
						mapping.setColumnHeight(mapHeight[getCmbHeight()
								.getSelectedIndex()]);
					if (!getCmbFont().getSelectedItem().equals("- Default -"))
						mapping.setColumnTypeFont(mapFont[getCmbFont()
								.getSelectedIndex()]);
	 ...
	 */
	/*
	 * private JCheckBox getChbPixels() { if (chbPixels == null) { chbPixels =
	 * new JCheckBox(); chbPixels.setBounds(new
	 * java.awt.Rectangle(15,138,226,25)); chbPixels.setText("pixels"); } return
	 * chbPixels; }
	 */
	/**
