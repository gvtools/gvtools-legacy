...
public class PanelLinkProperties extends JPanel {
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jLabelAccion1.setText(PluginServices.getText(this,
					"Accion_Predefinida") + "  ");
		...
		if (jComboBoxCampo1 == null) {
			...
			if (PluginServices.getMainFrame() != null)
				if (PluginServices.getMDIManager().getActiveWindow() instanceof BaseView) {
					BaseView theView = (BaseView) PluginServices
					...
					try {
						if (layer instanceof AlphanumericData) {
							...
							if (view.getSelectedField() != null) {
								jComboBoxCampo1.setSelectedItem(view
										.getSelectedField());
	...
	private JComboBox getJComboBoxAccion1() {
		if (jComboBoxAccion1 == null) {
			...
			DefaultComboBoxModel defaultModel1 = new DefaultComboBoxModel(
					t.getModel());
