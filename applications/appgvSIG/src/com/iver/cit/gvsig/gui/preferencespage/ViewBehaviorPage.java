...
public class ViewBehaviorPage extends AbstractPreferencePage {
	...
	public void storeValues() throws StoreException {
		...
		xml.putProperty(MAPCONTROL_REFRESH_RATE_KEY_NAME,
				MapControl.getDrawFrameRate());
		xml.putProperty(MAPCONTROL_ENABLE_ANIMATION_KEY_NAME,
	...
	public void initializeValues() {
		...
		if (xml.contains(MAPCONTROL_REFRESH_RATE_KEY_NAME)) {
			MapControl.setDrawFrameRate(xml
					.getIntProperty(MAPCONTROL_REFRESH_RATE_KEY_NAME));
		}

		// View animation enabled
		if (xml.contains(MAPCONTROL_ENABLE_ANIMATION_KEY_NAME)) {
			MapControl.setDrawAnimationEnabled(xml
					.getBooleanProperty(MAPCONTROL_ENABLE_ANIMATION_KEY_NAME));
		}
	...
	private class ScreenRefreshRatePanel extends JPanel {
		...
		public ScreenRefreshRatePanel() {
			...
			Border border = BorderFactory.createTitledBorder(PluginServices
					.getText(this, "options.view.behavior.screen_refreshrate"));
			setBorder(border);
