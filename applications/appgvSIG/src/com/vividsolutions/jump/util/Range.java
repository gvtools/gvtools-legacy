...
public class Range {
	...
	public Range(Object min, boolean includingMin, Object max,
	...
	public static final Comparator RANGE_COMPARATOR = new Comparator() {
		public int compare(Object o1, Object o2) {
			Range range1 = o1 instanceof Range ? (Range) o1 : new Range(o1,
					true, o1, true);
			Range range2 = o2 instanceof Range ? (Range) o2 : new Range(o2,
					true, o2, true);
			int max1ComparedToMin2 = INFINITY_COMPARATOR.compare(
					range1.getMax(), range2.getMin());
			if (max1ComparedToMin2 < 0
					|| (max1ComparedToMin2 == 0 && (!range1.isIncludingMax() || !range2
							.isIncludingMin()))) {
				return -1;
			}
			int min1ComparedToMax2 = INFINITY_COMPARATOR.compare(
					range1.getMin(), range2.getMax());
			if (min1ComparedToMax2 > 0
					|| (min1ComparedToMax2 == 0 && (!range1.isIncludingMin() || !range2
							.isIncludingMax()))) {
				return +1;
			}
			return 0;
