 ...
 * 
 */
public class VectorialDBConnectionParamsDialog extends JPanel implements
		IWindow, ActionListener, KeyListener {
	private static Logger logger = Logger
			.getLogger(VectorialDBConnectionParamsDialog.class.getName());
	...
	private JCheckBox getConnectedCheckBox() {
		if (connectedCheckBox == null) {
			...
			connectedCheckBox
					.setBounds(new java.awt.Rectangle(155, 247, 26, 21));
		}
