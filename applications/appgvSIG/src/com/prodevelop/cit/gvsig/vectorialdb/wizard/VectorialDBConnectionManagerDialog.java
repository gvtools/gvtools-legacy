 ...
 * 
 */
public class VectorialDBConnectionManagerDialog extends JPanel implements
		IWindow, ActionListener {
	private static Logger logger = Logger
			.getLogger(VectorialDBConnectionManagerDialog.class.getName());
	...
	private DefaultMutableTreeNode getTreeRoot() {
		...
		ConnectionWithParams[] conns = SingleVectorialDBConnectionManager
	...
	private void addConnection(String _drvName, String _port, String _host,
		...
		SingleVectorialDBConnectionManager.instance().getConnection(_drvName,
				_user, _pw, _conn_usr_name, _host, _port, _dbName, is_conn);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (src == editButton) {
			...
			if (modifyco.isOkPressed()) {
				...
				try {
					old_was_open = SingleVectorialDBConnectionManager
							.instance().closeAndRemove(old_cwp);
