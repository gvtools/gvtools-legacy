...
public class NewVectorDBConnectionPanel extends JWizardPanel implements
		ItemListener, PropertyChangeListener, ActionListener, KeyListener {

	private static int NEW_TABLE_NAME_INDEX = 0;
	private static Logger logger = Logger
			.getLogger(NewVectorDBConnectionPanel.class.getName());

	private String drvName = "";
	private int idMaxLen = 10;

	public NewVectorDBConnectionPanel(JWizardComponents wizardComponents,
			String drv_name, int id_max_len) {
