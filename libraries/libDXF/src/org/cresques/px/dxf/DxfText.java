 ...
 * @author jmorell jmorell, 050406: El segundo punto es opcional.
 */
public class DxfText extends DxfEntity {
	 ...
	 * 
	 * @param proj
	 *            , proyección cartográfica en la que se encuentra el DxfText.
	 * @param layer
	 *            , capa del DXF en la que se encuentra el DxfText.
	 * @param txt
	 *            , texto.
	 */
	public DxfText(CoordinateReferenceSystem crs, DxfLayer layer, String txt) {
		super(crs, layer);
	...
	/**
	 * Establece si el texto se situa a través de dos puntos de inserción. Estos
	 * dos puntos definirán su orientación.
	 * 
	 * @param f
	 */
	 ...
	 * Estos dos puntos definirán su orientación.
	 * 
	 * @return boolean
	 */
	...
	/**
	 * Establece el primer punto de inserción del texto cuando este se inserta a
	 * través de dos puntos de inserción.
	 * 
	 * @param pt
	 */
	...
	/**
	 * Obtiene el primer punto de inserción del texto cuando este se inserta a
	 * través de dos puntos de inserción.
	 * 
	 * @return Point2D
	 */
	...
	/**
	 * Establece el segundo punto de inserción del texto cuando este se inserta
	 * a través de dos puntos de inserción.
	 * 
	 * @param pt
	 */
	...
	/**
	 * Obtiene el segundo punto de inserción del texto cuando este se inserta a
	 * través de dos puntos de inserción.
	 * 
	 * @return Point2D
	 */
	 ...
	 * 
	 * @param r
	 *            , ángulo de inclinación del texto.
	 */
	...
	/**
	 * Permite reproyectar un DxfText dado un conjunto de coordenadas de
	 * transformación.
	 * 
	 * @param rp
	...
	public void reProject(MathTransform trans, CoordinateReferenceSystem target) {
		...
		Point2D ptOrig = new Point2D.Double(savePts[0].getX(),
				savePts[0].getY() + h);
		ptDest = ProjectionUtils.transform(ptOrig, trans);
	...
	public void draw(Graphics2D g, ViewPortData vp) {
		...
		// Falta depurar.
		/*
		 * System.out.println("040906: rot = " + rot); //angle =
		 * pathLen.angleAtLength(midDistance); rot = Math.toRadians(rot); if
		 * (rot < 0) rot = rot + 2.0*Math.PI; if ((rot > (Math.PI/2)) && (rot <
		 * (3 * Math.PI /2))) rot = rot - (Math.PI/2.0); rot =
		 * Math.toDegrees(rot); //theLabel.setRotation(Math.toDegrees(angle));
		 * AffineTransform transfRot = AffineTransform.getRotateInstance(rot,
		 * ptT0.getX(), ptT0.getY()); AffineTransform ant = g.getTransform();
	 ...
	 * 
	 * @return String, la cadena que se escribirá en el fichero con la
	 *         información del DxfText.
	 */
