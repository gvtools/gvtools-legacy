...
/* CVS MESSAGES:
 *
 * $Id: PrintlnMultiCurve.java,v 1.2 2008/03/25 08:47:41 cvs Exp $
 * $Log: PrintlnMultiCurve.java,v $
 ...
 */
public class PrintlnMultiCurveOperation extends PrintlnDefaultOperation {
	...
	public Object operate(AbstractGeometry multiGeometry) throws GeometryOperationException {
		printGeometry(multiGeometry, "MultiCurve");
