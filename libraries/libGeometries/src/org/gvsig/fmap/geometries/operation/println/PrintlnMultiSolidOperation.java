...
/* CVS MESSAGES:
 *
 * $Id: PrintlnMultiSolid.java,v 1.2 2008/03/25 08:47:41 cvs Exp $
 * $Log: PrintlnMultiSolid.java,v $
 ...
 */
public class PrintlnMultiSolidOperation extends PrintlnDefaultOperation {

	/*
	 * (non-Javadoc)
	 * @see org.gvsig.geometries.operation.GeometryOperation#operate(com.iver.cit.gvsig.fmap.core.AbstractGeometry)
	 */
	public Object operate(AbstractGeometry multiSolid) throws GeometryOperationException {
		printGeometry(multiSolid, "MultiSolid");	
		operateChildren((MultiGeometry)multiSolid);
		return null;		
	}
