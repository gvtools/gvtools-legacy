...
/* CVS MESSAGES:
 *
 * $Id: PrintlnPoint.java,v 1.2 2008/03/25 08:47:41 cvs Exp $
 * $Log: PrintlnPoint.java,v $
 ...
 */
public class PrintlnPointOperation extends PrintlnDefaultOperation{

	/*
	 * (non-Javadoc)
	 * @see org.gvsig.geometries.operation.GeometryOperation#operate(com.iver.cit.gvsig.fmap.core.AbstractGeometry)
	 */
	public Object operate(AbstractGeometry point) {
		printGeometry(point, "Point");		
		return null;
	}
