...
/* CVS MESSAGES:
 *
 * $Id: PrintlnMultiSurface.java,v 1.2 2008/03/25 08:47:41 cvs Exp $
 * $Log: PrintlnMultiSurface.java,v $
 ...
 */
public class PrintlnMultiSurfaceOperation extends PrintlnDefaultOperation {

	/*
	 * (non-Javadoc)
	 * @see org.gvsig.geometries.operation.GeometryOperation#operate(com.iver.cit.gvsig.fmap.core.AbstractGeometry)
	 */
	public Object operate(AbstractGeometry multiSurface) throws GeometryOperationException {
		printGeometry(multiSurface, "MultiSurface");	
		operateChildren((MultiGeometry)multiSurface);
		return null;		
	}
