...
/* CVS MESSAGES:
 *
 * $Id: PrintlnMultiPoint.java,v 1.2 2008/03/25 08:47:41 cvs Exp $
 * $Log: PrintlnMultiPoint.java,v $
 ...
 */
public class PrintlnMultiPointOperation extends PrintlnDefaultOperation {

	/*
	 * (non-Javadoc)
	 * @see org.gvsig.geometries.operation.GeometryOperation#operate(com.iver.cit.gvsig.fmap.core.AbstractGeometry)
	 */
	public Object operate(AbstractGeometry multiPoint) throws GeometryOperationException {
		printGeometry(multiPoint, "MultiPoint");
		operateChildren((MultiGeometry)multiPoint);
		return null;
	}
}
