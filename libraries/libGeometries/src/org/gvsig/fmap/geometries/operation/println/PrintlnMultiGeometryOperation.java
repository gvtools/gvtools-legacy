...
/* CVS MESSAGES:
 *
 * $Id: PrintlnMultiGeometry.java,v 1.2 2008/03/25 08:47:41 cvs Exp $
 * $Log: PrintlnMultiGeometry.java,v $
 ...
 */
public class PrintlnMultiGeometryOperation extends PrintlnDefaultOperation {

	/*
	 * (non-Javadoc)
	 * @see org.gvsig.geometries.operation.GeometryOperation#operate(com.iver.cit.gvsig.fmap.core.AbstractGeometry)
	 */
	public Object operate(AbstractGeometry multiGeometry) throws GeometryOperationException {
		printGeometry(multiGeometry, "MultiGeometry");		
		operateChildren((MultiGeometry)multiGeometry);
		return null;		
	}
