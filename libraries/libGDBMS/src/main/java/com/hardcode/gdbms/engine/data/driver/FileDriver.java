...
public interface FileDriver extends ReadAccess, GDBMSDriver {
	 ...
	 * The data must be written to a buffer (memory or disk) and then copied to
	 * the file because if the file is modified the dataWare data may be
	 ...
	 */
	void writeFile(FileDataWare dataWare) throws WriteDriverException,
			ReadDriverException;
	 ...
	 *             TODO
	 */
	void createSource(String path, String[] fieldNames, int[] fieldTypes)
			throws ReadDriverException;
}
