...
public interface DataSource extends ReadAccess {
	...
	/**
	 * Devuelve el filtro que resultó de la cláusula where de la instrucción que
	 * dió como resultado este DataSource.
	 * 
	 ...
	 * 
	 * @param i
	 *            índice del campo cuyo tipo se quiere conocer
	 * 
	 * @return Class
	 * @throws ReadDriverException
	 *             TODO
	 ...
	 * 
	 * @param mode
	 *            One of DataSourceFactory.DATA_WARE_DIRECT_MODE,
