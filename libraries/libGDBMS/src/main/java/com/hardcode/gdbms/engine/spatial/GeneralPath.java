...
public final class GeneralPath implements Shape, Cloneable {
	 ...
	 * 
	 * @param x1
	 *            the coordinates of the first quadratic control point
	 * @param y1
	 ...
	 * 
	 * @param x1
	 *            the coordinates of the first B&eacute;ezier control point
	 * @param y1
	 *            the coordinates of the second B&eacute;zier control point
	 * @param x2
	 *            the coordinates of the final endpoint
	 * @param y2
	 *            DOCUMENT ME!
	 ...
	 * 
	 * @exception IllegalArgumentExceptionIllegalArgumentException
	 *                </code> if <code>rule</code> is not either
	 *                <code>WIND_EVEN_ODD</code> or <code>WIND_NON_ZERO</code>
	 * 
	 * @see #WIND_EVEN_ODD
	 * @see #WIND_NON_ZERO
	 * @see #getWindingRule
	...
	public Geometry getJTSGeometry() {
		...
		if ((numTypes == 1) && (pointTypes[0] == SEG_MOVETO)) {
			...
			for (int i = 0; i < numTypes - 1; i++) {
				coords[i] = new Coordinate(pointCoords[index],
						pointCoords[index + 1]);
				index = index + 2;
			}
