...
public class EditionTests extends DataSourceTestCase {
	...
	private void testDelete(String dsName, int mode) throws Exception {
		...
		dw.insertEmptyRow(ValueFactory.createValue(new Value[] { ValueFactory
				.createValue(4) }));
		dw.deleteRow(0); // 0
		dw.deleteRow(0); // 1
		dw.deleteRow(1); // 3
		...
		d.start();
		assertTrue(((BooleanValue) d.getFieldValue(0, 0).equals(
				ValueFactory.createValue(2))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(0, 1).equals(
				ValueFactory.createValue("fernan"))).getValue());
	...
	private void testUpdate(String dsName, int mode) throws Exception {
		...
		d.start();
		assertTrue(((BooleanValue) d.getFieldValue(0, 0).equals(
				ValueFactory.createValue(0))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(0, 1).equals(
				ValueFactory.createValue("edicion1"))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(0, 2).equals(
		...
		assertTrue(((BooleanValue) d.getFieldValue(1, 1).equals(
				ValueFactory.createValue("edicion2"))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(1, 2).equals(
				ValueFactory.createValue("edicion2"))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(2, 0).equals(
				ValueFactory.createValue(2))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(2, 1).equals(
				ValueFactory.createValue("fernan"))).getValue());
		assertTrue(d.getFieldValue(2, 2) instanceof NullValue);
		assertTrue(((BooleanValue) d.getFieldValue(3, 0).equals(
				ValueFactory.createValue(3))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(3, 1).equals(
				ValueFactory.createValue("edicion3"))).getValue());
	...
	private void testUpdatePKUpdatedRow(String dsName, int mode)
			throws Exception {
		DataSource d = ds.createRandomDataSource(dsName,
				DataSourceFactory.MANUAL_OPENING);
		...
		assertTrue(((BooleanValue) d.getFieldValue(0, 0).equals(
				ValueFactory.createValue(10))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(0, 1).equals(
				ValueFactory.createValue("nombre"))).getValue());
		d.stop();
	}

	public void testUpdatePKUpdatedRowFakeTransaction() throws Exception {
		testUpdatePKUpdatedRow("hsqldbpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testUpdatePKUpdatedRow("persona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testUpdatePKUpdatedRow("objectpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}

	public void testUpdatePKUpdatedRowCoherentRowTransaction() throws Exception {
		testUpdatePKUpdatedRow("hsqldbpersonatransactional",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}

	private void testValuesDuringEdition(String dsName, int mode)
			throws Exception {
		DataSource d = ds.createRandomDataSource(dsName,
				DataSourceFactory.MANUAL_OPENING);
		...
		assertTrue(((BooleanValue) dw.getFieldValue(0, 6).equals(
				ValueFactory.createValue(10))).getValue());
		assertTrue(((BooleanValue) dw.getFieldValue(0, 1).equals(
				ValueFactory.createValue("fernando"))).getValue());
		assertTrue(((BooleanValue) dw.getPKValue(0).getValues()[0]
				.equals(ValueFactory.createValue(10))).getValue());
		dw.setFieldValue(0, 1, ValueFactory.createValue("nombre"));
		assertTrue(((BooleanValue) dw.getFieldValue(0, 1).equals(
				ValueFactory.createValue("nombre"))).getValue());
		dw.insertEmptyRow(ValueFactory.createValue(new Value[] { ValueFactory
				.createValue(4) }));
		assertTrue(((BooleanValue) dw.getFieldValue(3, 6).equals(
				ValueFactory.createValue(4))).getValue());
		dw.rollBackTrans();
	}

	public void testValuesDuringEditionFakeTransaction() throws Exception {
		testValuesDuringEdition("hsqldbpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testValuesDuringEdition("persona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testValuesDuringEdition("objectpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}

	public void testValuesDuringEditionCoherentRowTransaction()
			throws Exception {
		testValuesDuringEdition("hsqldbpersonatransactional",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}
	...
	public void testValuesDuringEditionDirectTransaction() throws Exception {
		...
		assertTrue(((BooleanValue) dw.getFieldValue(0, 2).equals(
				ValueFactory.createValue(10))).getValue());
		assertTrue(((BooleanValue) dw.getFieldValue(0, 1).equals(
				ValueFactory.createValue("fernando"))).getValue());
		dw.setFieldValue(0, 1, ValueFactory.createValue("nombre"));
	...
	private void testAdd(String dsName, int mode) throws Exception {
		...
		assertTrue(((BooleanValue) d.getFieldValue(1, 0).equals(
				ValueFactory.createValue(1))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(1, 1).equals(
				ValueFactory.createValue("huracán"))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(1, 2).equals(
				ValueFactory.createValue("gonsales"))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(2, 0).equals(
				ValueFactory.createValue(2))).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(2, 1).equals(
				ValueFactory.createValue("fernan"))).getValue());
		assertTrue(d.getFieldValue(2, 2) instanceof NullValue);
		assertTrue(((BooleanValue) d.getFieldValue(3,
				d.getFieldIndexByName("PK"))
				.equals(ValueFactory.createValue(3))).getValue());
	...
	public void testAddCoherentRowTransaction() throws Exception {
		testAdd("hsqldbpersonatransactional",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}
	...
	private void testSQLInjection(String dsName, int mode) throws Exception {
		...
		d.start();
		assertTrue(((BooleanValue) d.getFieldValue(0, 1).equals(value))
				.getValue());
		d.stop();
	}

	public void testSQLInjectionFakeTransaction() throws Exception {
		testSQLInjection("hsqldbpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testSQLInjection("persona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testSQLInjection("objectpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}

	public void testSQLInjectionCoherentRowTransaction() throws Exception {
		testSQLInjection("hsqldbpersonatransactional",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}
	...
	private void testInsertFilledRow(String dsName, int mode) throws Exception {
		...
		Value v6 = ValueFactory.createValue(Timestamp
				.valueOf("2005-09-05 4:30:01.666666666"));
	...
	public void testInsertFilledRowFakeTransaction() throws Exception {
		testInsertFilledRow("hsqldbpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testInsertFilledRow("persona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testInsertFilledRow("objectpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}

	public void testInsertFilledRowCoherentRowTransaction() throws Exception {
		testInsertFilledRow("hsqldbpersonatransactional",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}
	...
	private void testEditingNullValues(String dsName, int mode)
			throws Exception {
		DataSource d = ds.createRandomDataSource(dsName,
				DataSourceFactory.MANUAL_OPENING);
		...
		d.start();
		assertTrue(((BooleanValue) d.getFieldValue(3, 0).equals(v1)).getValue());
		assertTrue(((BooleanValue) ValueFactory.createValue(d.getFieldValue(3,
				1) instanceof NullValue)).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(3, 2).equals(v3)).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(3, 3).equals(v4)).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(3, 4).equals(v5)).getValue());
		assertTrue(((BooleanValue) d.getFieldValue(3, 5).equals(v6)).getValue());
	...
	public void testEditingNullValuesFakeTransaction() throws Exception {
		testEditingNullValues("hsqldbpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testEditingNullValues("persona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testEditingNullValues("objectpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}

	public void testEditingNullValuesCoherentRowTransaction() throws Exception {
		testEditingNullValues("hsqldbpersonatransactional",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}
	...
	public void testEditingDatesFakeTransaction() throws Exception {
		testEditingDates("hsqldbpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testEditingDates("persona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
		testEditingDates("objectpersona",
				DataSourceFactory.DATA_WARE_COHERENT_ROW_ORDER);
	}
