...
public class SetUp {
	...
	public static DataSourceFactory setUp() throws Exception {
		...
		// Setup de las tablas
		dsf.addDBDataSourceByTable("hsqldbpersona", null, 0, "sa", "",
				"src/test/resources/testdb", "persona", "GDBMS HSQLDB driver");
		dsf.addDBDataSourceByTable("hsqldbpersonatransactional", null, 0, "sa",
				"", "src/test/resources/testdb", "persona",
				"GDBMS HSQLDB Transactional driver");
		dsf.addDBDataSourceBySQL("hsqldbapellido", null, 0, "sa", "",
				"src/test/resources/testdb", "select apellido from persona",
				"GDBMS HSQLDB driver");

		dsf.addSpatialDBDataSource("poligonos", "127.0.0.1", 5432, "root", "",
				"sigusal", "polygon0", "the_geom", "GDBMS PostGIS driver");

		dsf.addDBDataSourceByTable("foo", null, 0, null, null, null, null,
				"FooDriver");
		dsf.addSpatialFileDataSource("GDBMS shapefile driver", "shppuntos",
				"src/test/resources/puntos.shp");
		dsf.addSpatialFileDataSource("FMap ShapeFile Driver", "shplineas",
				"src/test/resources/lineas.shp");
		dsf.addSpatialFileDataSource("FMap ShapeFile Driver", "shppoligonos",
				"src/test/resources/poligonos.shp");
		dsf.addDataSource(new FakeObjectDriver(), "objectpersona");

		dsf.initialize("/tmp");

		InternalExceptionCatcher
				.addInternalExceptionListener(new InternalExceptionListener() {
					/**
