...
public class ValuesTest extends DataSourceTestCase {
	...
	public void testArrayValue() throws Exception {
		...
		ValueCollection av1 = ValueFactory
				.createValue(new Value[] { ValueFactory.createValue(0) });
		...
		/*
		 * This assertion may fail when the code is right. Pass the test again
		 */
	...
	public void testCreateByType() throws Exception {
		...
		assertTrue(((BooleanValue) ValueFactory.createValueByType("true",
				Types.BOOLEAN).equals(ValueFactory.createValue(true)))
				.getValue());
		assertTrue(((BooleanValue) ValueFactory.createValueByType("false",
				Types.BOOLEAN).equals(ValueFactory.createValue(false)))
				.getValue());

		assertTrue(((BooleanValue) ValueFactory.createValueByType("carajo",
				Types.CHAR).equals(ValueFactory.createValue("carajo")))
				.getValue());
		assertTrue(((BooleanValue) ValueFactory.createValueByType("carajo",
				Types.VARCHAR).equals(ValueFactory.createValue("carajo")))
				.getValue());
		assertTrue(((BooleanValue) ValueFactory.createValueByType("carajo",
				Types.LONGVARCHAR).equals(ValueFactory.createValue("carajo")))
				.getValue());
		...
		assertTrue(((BooleanValue) ValueFactory.createValueByType(
				DateFormat.getDateInstance().format(d), Types.DATE).equals(
				ValueFactory.createValue(d))).getValue());

		assertTrue(((BooleanValue) ValueFactory.createValueByType("1.1",
				Types.DECIMAL).equals(ValueFactory.createValue(1.1d)))
				.getValue());
		assertTrue(((BooleanValue) ValueFactory.createValueByType("1.1",
				Types.NUMERIC).equals(ValueFactory.createValue(1.1d)))
				.getValue());
		assertTrue(((BooleanValue) ValueFactory.createValueByType("1.1",
				Types.DOUBLE).equals(ValueFactory.createValue(1.1d)))
				.getValue());
		assertTrue(((BooleanValue) ValueFactory.createValueByType("1.1",
		...
		assertTrue(((BooleanValue) ValueFactory.createValueByType("FFA007",
				Types.BINARY).equals(ValueFactory.createValue(array)))
				.getValue());
		...
		assertTrue(((BooleanValue) ValueFactory.createValueByType(
				DateFormat.getTimeInstance().format(t), Types.TIME).equals(
		...
		assertTrue(((BooleanValue) ValueFactory.createValueByType(
				ts.toString(), Types.TIMESTAMP).equals(
	...
	public void testToStringFromStringCoherente() throws Exception {
		...
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.DOUBLE))).getValue());

		v = ValueFactory.createValue(13.5f);
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.REAL))).getValue());

		v = ValueFactory.createValue(13L);
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.BIGINT))).getValue());

		v = ValueFactory.createValue(true);
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.BIT))).getValue());
		...
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.VARCHAR))).getValue());
		...
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.DATE))).getValue());

		v = ValueFactory.createValue(15);
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.INTEGER))).getValue());

		v = ValueFactory.createValue((short) 13);
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.SMALLINT))).getValue());

		v = ValueFactory.createValue((byte) 5);
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.TINYINT))).getValue());

		v = ValueFactory.createValue(new byte[] { 4, 5, 7, 8, 3, 8 });
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.BINARY))).getValue());
		...
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.TIME))).getValue());

		v = ValueFactory.createValue(new Timestamp(2465));
		assertTrue(((BooleanValue) v.equals(ValueFactory.createValueByType(
				v.toString(), Types.TIMESTAMP))).getValue());
	}
}
