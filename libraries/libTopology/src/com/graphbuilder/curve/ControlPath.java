...
/**
 * <p>
 * A ControlPath is a container of Point objects and Curve objects. The
 * control-path uses arrays to store the points and curves. Methods that accept
 * objects will throw an IllegalArgumentException if those objects are null.
 * Methods that accept index values will throw an IllegalArgumentException if
 * those index values are out of range.
 */
public class ControlPath {
	 ...
	 *             If the specified curve is null.
	 */
	...
	/**
	 * Sets a curve at the specified index in the curve array, returning the
	 * curve that was at that index.
	 * 
	 * @throws IllegalArgumentException
	 *             If the specified curve is null.
	 */
	...
	/**
	 * Sets a point at the specified index in the point array, returning the
	 * point that was at that index.
	 * 
	 * @throws IllegalArgumentException
	 *             If the specified point is null.
	 */
	...
	/**
	 * Checks that the curve array has the specified capacity, otherwise the
	 * capacity of the curve array is increased to be the maximum between twice
	 * the current capacity or the specified capacity.
	 */
	...
	/**
	 * Creates a new curve array of exact size, copying the curves from the old
