 ...
 * 
 * FIXME azabala: This class exists in appGvSig project. I think we must move it
 * to libFMap project, to avoid to create dependencies with appGvSig in
 * libraries (by the moment, I copy the source code)
 * 
 * 
 * 
 * 
...
public class CoordinateArrays {
	...
	// MD: Geometry#reversePointOrder could delegate to this method. Can't do it
	// other way around.
	 ...
	 * 
	 * @param coords
	 *            the coordinates of a line or point
	 * @param fact
	 *            a factory used to create the Geometry
	 ...
	 * 
	 * @param coordArrays
	 *            a collection of Coordinate[]
	 * @param fact
	 *            a factory used to create the Geometry's
	 ...
	 * @param coordArrayList
	 *            the List to add the coordinate arrays to
	 * @param orientPolygons
	 *            whether or not the arrays in the List should be oriented
	 *            (clockwise for the shell, counterclockwise for the holes)
	 */
	 ...
	 * 
	 * @param coord
	 *            the coordinates to inspect
	 * @param desiredOrientation
	 *            CGAlgorithms.CLOCKWISE or CGAlgorithms.COUNTERCLOCKWISE
	 ...
	 *            the Geometry to extract from
	 * @param orientPolygons
	 *            ensure that Polygons are correctly oriented
