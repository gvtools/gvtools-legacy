...
public class TriangleDT {
	 ...
	 * Constructor
	 * 
	 * @param double[] - array of vertexes index 0-2 - Coordinate of vertex A
	 *        (x,y,z) index 3-5 - Coordinate of vertex B (x,y,z) index 6-8 -
	 *        Coordinate of vertex C (x,y,z)
	 */
	...
	public String toString() {
		...
		/*
		 * System.out.print("Triangle  "); A.printPoint(); B.printPoint();
		 * C.printPoint();
		 * System.out.print(" k:"+key[0]+" "+key[1]+"   "+key[2]);
		 * System.out.println(); if (neighbour[0]!=null){
		 * System.out.print("           Soused0   ");
		 * neighbour[0].A.printPoint(); neighbour[0].B.printPoint();
		 * neighbour[0].C.printPoint(); System.out.println(); } if
		 * (neighbour[1]!=null){ System.out.print("           Soused1   ");
		 * neighbour[1].A.printPoint(); neighbour[1].B.printPoint();
		 * neighbour[1].C.printPoint(); System.out.println(); } if
		 * (neighbour[2]!=null){ System.out.print("           Soused2   ");
		 * neighbour[2].A.printPoint(); neighbour[2].B.printPoint();
		 * neighbour[2].C.printPoint(); System.out.println(); }
		 */
