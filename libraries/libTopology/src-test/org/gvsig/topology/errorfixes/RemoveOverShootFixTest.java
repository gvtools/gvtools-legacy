...
public class RemoveOverShootFixTest extends TestCase {
	...
	public void testPolygon() throws ParseException {
		...
		// Polygon polygon = JtsUtil.GEOMETRY_FACTORY.createPolygon((LinearRing)
		// shellG, new LinearRing[]{(LinearRing) holeG});
		...
		FGeometry newGeometry = (FGeometry) FGeometryUtil.removeOvershoot(
				geometry, 0d);
