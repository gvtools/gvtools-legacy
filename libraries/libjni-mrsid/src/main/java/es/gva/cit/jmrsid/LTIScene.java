...
public class LTIScene extends JNIBase {
	...
	private native long LTISceneNat(double xinic, double yinic, double tamx,
			double tamy, double magnification);
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto LTIScene de C.
	 */
	...
	/**
	 * Este constructor produce una escena con los parámetros dados usando doble
	 * precision.
	 * 
	 * @param xinic
	 *            Esquina superior izquierda en la escena
	 * @param yinic
	 *            Esquina superior derecha en la escena
	 * @param width
	 *            ancho de la escena
	 * @param height
	 *            alto de la escena
	...
	public LTIScene(double xinic, double yinic, double tamx, double tamy,
			double magnification) throws MrSIDException {
