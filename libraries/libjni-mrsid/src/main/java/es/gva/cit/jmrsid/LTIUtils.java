...
public class LTIUtils extends JNIBase {
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto OGRCurve de C.
	 */
	...
	public static double levelToMag(int level) throws MrSIDException {
		...
		if (mag < 0)
			throw new MrSIDException(
					"Error LTIUtils::levelToMag. Se obtuvo un valor erroneoen la llamada nativa levelToMag.");
		else
			return mag;
	}
