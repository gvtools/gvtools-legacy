...
public class LTIImage extends JNIBase{
	...
	/**
	 * Constructor
	 * @param cPtr	dirección de memoria al objeto LTIImage de C. 
	 */
	...
	public void initialize()throws MrSIDException{
		...
		if( codigo > 0)
			throw new MrSIDException("La llamada nativa a initialize ha devuelto el código de error "+codigo);
	 ...
	 * @throws MrSIDException, IOException
	 * @return Objeto LTIMetadataDatabase que contiene los metadatos de la imágen
	 */
	public LTIMetadataDatabase getMetadata()throws MrSIDException{

		if(cPtr == 0)
			throw new MrSIDException("Error en getMetadataDatabase. El Open del MrSID no tuvo éxito");
	...
	public int[] getDimsAtMag(double mag)throws MrSIDException{
		...
		if(cPtr == 0)
		 	throw new MrSIDException("Error en getDimsAtMag. El Open del MrSID no tuvo éxito");
	 ...
	 */
	 public LTIPixel getPixelProps()throws MrSIDException{
	 	...
	 	if(cPtr == 0)
		 	throw new MrSIDException("Error en getPixelProps. El Open del MrSID no tuvo éxito");
	  ...
	  * @throws MrSIDException
	  * @return un objeto de tipo LTIGeoCoord con la información de georeferenciación 
	  */
	 public LTIGeoCoord getGeoCoord()throws MrSIDException{
	 	...
	 	if(cPtr == 0)
		 	throw new MrSIDException("Error en getGeoCoord. El Open del MrSID no tuvo éxito");
	 ...
	 public LTIPixel getBackgroundPixel()throws MrSIDException{
	 	...
	 	if(cPtr == 0)
		 	throw new MrSIDException("Error en getBackgroundPixel. El Open del MrSID no tuvo éxito");
	 ...
	 /**
	  * Obtiene los valores de transparencia de un pixel. Si devuelve null es que la imágen no tiene
	 ...
	 public LTIPixel getNoDataPixel()throws MrSIDException{
	 	...
	 	if(cPtr == 0)
		 	throw new MrSIDException("Error en getNoData. El Open del MrSID no tuvo éxito");
	 ...
	 public double getMinMagnification()throws MrSIDException{
		 ...
		 if(cPtr == 0)
			 throw new MrSIDException("Error en getMinMagnification(). El Open del MrSID no tuvo éxito");
	   ...
	   */
	   public double getMaxMagnification()throws MrSIDException{
		...
		if(cPtr == 0)
		 	throw new MrSIDException("Error en getMaxMagnification(). El Open del MrSID no tuvo éxito");
