...
public class LTIMetadataDatabase extends JNIBase {
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto LTIMetadataDatabase de C.
	 */
	...
	public LTIMetadataRecord getDataByIndex(int i) throws MrSIDException {
		...
		if (cPtr == 0)
			throw new MrSIDException(
					"Error en getDataByIndex. La referencia al objeto no es valida.");

		LTIMetadataRecord metadata = new LTIMetadataRecord(getDataByIndexNat(
				cPtr, i));
