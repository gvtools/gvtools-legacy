/* $Id: lti_navigator.h 3539 2006-01-09 12:23:20Z nacho $ */
/* //////////////////////////////////////////////////////////////////////////
//                                                                         //
...
public:
   ...
   /**
    * @name Functions to set scene explicitly, using "resolution-relative" coordinates.
    */
   /*@{*/
    ...
    *
    * Sets the scene to the given position.  The position is specified using
    * upper-left/width-height values.  The values are in "resolution-relative"
    * space.
    *
    * @param   upperLeftX     the upper-left x-position of the new scene
    * @param   upperLeftY     the upper-left y-position of the new scene
    ...
    * @return status code indicating success or failure
    */
   LT_STATUS setSceneAsResRelULWH(double upperLeftX, double upperLeftY,
                                  double width, double height,
                                  double magnification);
    ...
    *
    * Sets the scene to the given position.  The position is specified using
    * upper-left/lower-right values. The values are in "resolution-relative"
    * space.
    *
    * @param   upperLeftX     the upper-left x-position of the new scene
    * @param   upperLeftY     the upper-left y-position of the new scene
    ...
    * @return status code indicating success or failure
    */
   LT_STATUS setSceneAsResRelULLR(double upperLeftX, double upperLeftY,
                                  double lowerRightX, double lowerRightY,
                                  double magnification);
    ...
    *
    * Sets the scene to the given position.  The position is specified using
    * center/width-height values. The values are in "resolution-relative"
    * space.
    *
    * @param   centerX        the center x-position of the new scene
    * @param   centerY        the center y-position of the new scene
    ...
    * @return status code indicating success or failure
    */
   LT_STATUS setSceneAsResRelCWH(double centerX, double centerY,
                                 double width, double height,
                                 double magnification);
   /*@}*/
