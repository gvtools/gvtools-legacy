 ...
 *
 */
public class RasterShieldSymbol extends RasterMarkerSymbol
    implements IArcIMSSymbol {
    public static final String TAG = ServiceInfoTags.tRASTERSHIELDSYMBOL;

    public RasterShieldSymbol(String murl) {
        super(murl);
    }
