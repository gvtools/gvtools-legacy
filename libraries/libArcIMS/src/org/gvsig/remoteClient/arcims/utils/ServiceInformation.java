...
public class ServiceInformation implements Cloneable {
	 ...
	 * 
	 * @param i
	 *            Index of the vector of layers
	 * @return @see ServiceInformationLayer
	 */
	public ServiceInformationLayer getLayer(int i) {
		ServiceInformationLayer sil = (ServiceInformationLayer) this.layers
				.get(i);
	...
	/**
	 * @param imagelimit_pixelcount
	 *            The imagelimit_pixelcount to set.
	 */
	...
	public class ServiceInformationSeparators implements Cloneable {
		/**
		 * Coordinate separator is used to separate an x-coordinate from a
		 * y-coordinate.
		 */
		private String cs;

		/**
		 * Tuple separator is used to separate coordinate pairs and string
		 * lists.
		 */
		private String ts;

		/**
		 * Decimal separator is used to separate integer part from the decimal
		 * part of a float/double number. It will be determined from the
		 * language/country information of the service. The default value is
		 * '.'.
		 */
		private char ds;
