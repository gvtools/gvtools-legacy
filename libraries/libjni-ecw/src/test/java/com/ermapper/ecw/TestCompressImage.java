...
* . Esto obliga a crear un método loadBuffer. En el hay que meter la funcionalidad para que
* llene el buffer. El buffer esta en la clase cliente y tendrá una longitud de 
* ancho de una línea * número de bandas
*/
