 ...
 * <ol>
 * <li><b>Unsupported set of settings</b>: getType() ==
 * SymbolDrawingException.UNSUPPORTED_SET_OF_SETTINGS</li>
 * <li><b>Shape type mismatch</b>: getType() ==
 * SymbolDrawingException.SHAPETYPE_MISMATCH</li>
 * </ol>
 * 
...
public class SymbolDrawingException extends Exception {
	...
	public static final String STR_UNSUPPORTED_SET_OF_SETTINGS = Messages
			.getString("unsupported_set_of_settings");
