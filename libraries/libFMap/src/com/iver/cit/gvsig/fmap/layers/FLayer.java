...
/**
 * <p>
 * Definition of the basic functionality that all kind of <i>FMap</i> layers
 * should implement.
 * </p>
 * 
 * <p>
 * This kind of layers store their data, are drawable, projectable (with a
 * projection), can be a node of a tree of layers, and could be editable and
 * have a cache with previous draws. They also can be visible or not, and active
 * or not.
 * </p>
 * 
 * <p>
 * A layer can also store information about errors produced working with it, and
 * have a name (kind of layer) and a brief summary explaining what's for.
 * </p>
 * 
 * <p>
 * Each particular implementation can add new properties, and limit or expand
 * the functionality.
 * </p>
 * 
 * @see Georeferenced
...
public interface FLayer extends Georeferenced {
	...
	/**
	 * <p>
	 * Inserts information to this layer from an XML entity.
	 * </p>
	 * 
	 * <p>
	 * This XML entity has elements that represent and store information about
	 ...
	 * </p>
	 * 
	 * @return <code>true</code> if this layer is active; <code>false</code>
	 *         otherwise
	 * 
	 ...
	 * 
	 * @param name
	 *            the string that is to be this layer's name
	 * 
	 * @see #getName()
	 */
	...
	/**
	 * <p>
	 * Executes the initialization operations of this layer. This method is
	 * invoked only one time during the life of this layer and just before
	 * visualize it.
	 * </p>
	 * 
	 * @throws com.iver.cit.gvsig.fmap.drivers.DriverIOException
	 *             if fails loading the layer.
	 * 
	 * @see #reload()
	 */
	 ...
	 * that layer will tried to be painted. If the data associated isn't
	 * available, then this property will change to <code>false</code>.
	 * </p>
	 * 
	 * @param visibility
	 *            the boolean to be set
	 ...
	 * <p>
	 * One layer is visible if it's check box associated is selected. This means
	 * that layer will tried to be painted.
	 * </p>
	 * <p>
	 * One layer is available if the source of data is on-line.
	 * </p>
	 * <p>
	 * It's probably that one layer selected hadn't available it's data, for
	 * example in a remote service.
	 * </p>
	 * 
	 * @return <code>true</code> if this layer is visible and available;
	...
	/**
	 * <p>
	 * Returns a reference to the model of this layer, or null if this layer has
	 * no model.
	 * </p>
	 * 
	 ...
	 * 
	 * @param image
	 *            an image used to accelerate the screen draw
	 * @param g
	 *            for rendering 2-dimensional shapes, text and images on the
	 *            Java(tm) platform
	 * @param viewPort
	 *            information for drawing this layer
	 * @param cancel
	 *            an object thread that implements the <code>Cancellable</code>
	 *            interface, and will allow to cancel the draw
	 * @param scale
	 ...
	 *            to all the docs in the print job
	 * 
	 * @throws com.iver.cit.gvsig.fmap.DriverException
	 *             if fails the driver used in this method.
	 * 
	 ...
	 *            a layer listener
	 * 
	 * @return <code>true</code> if hasn't been any problem during the insertion
	 *         of the listener
	 * 
	...
	/**
	 * <p>
	 * Returns if the value of <code>scale</code> argument is within the maximum
	 * and minimum scale of this layer.
	 * </p>
	 * 
	 * @param scale
	 *            the scale > 0
	 * 
	 * @return <code>true</code> if the <code>scale</code> argument is within
	 *         the range of scales of this layer; <code>false</code> otherwise
	 * 
	 ...
	 * </p>
	 * <p>
	 * One layer is editable if user can modify its information with graphical
	 * tools.
	 * </p>
	 * 
	 * @param b
	 *            the boolean to be set
	 * 
	 * @throws com.iver.cit.gvsig.fmap.edition.EditionException
	 *             if fails enabling for edition this kind of layer.
	 * 
	 * @see #isEditing()
	 */
	 ...
	 * </p>
	 * 
	 * @return <code>true</code> if this layer is editable; <code>false</code>
	 *         otherwise
	 * 
	 ...
	 * 
	 * @return a reference to the image icon, or <code>null</code> if there
	 *         isn't any
	 */
	 ...
	 * </p>
	 * 
	 * @return <code>true</code> if this layer appears in the TOC;
	 *         <code>false</code> otherwise
	 */
	boolean isInTOC();
	 ...
	 * 
	 * @param b
	 *            <code>true</code> if appears in the TOC; <code>false</code>
	 *            otherwise
	 */
	 ...
	 * 
	 * @param status
	 *            information of the status for this layer
	 * 
	 * @see #getFLayerStatus()
	 */
	 ...
	 * </p>
	 * 
	 * @return <code>true</code> if this layer hasn't got errors;
	 *         <code>false</code> otherwise
	 */
	public boolean isOk();

	/**
	 * Returns the number of errors which causes this layer to be in unavailable
	 * status.
	 * 
	 ...
	 * 
	 * @param i
	 *            index of the error >= 0 && < <code>getNumErrors</code>
	 * 
	 ...
	 * 
	 * @param error
	 *            a <code>DriverException</code> with the information of the
	 *            error
	 * 
	 * @see #getNumErrors()
	 * @see #getError(int)
	 ...
	 * </p>
	 * 
	 * @return <code>true</code> if the source of data is on-line;
	 *         <code>false</code> otherwise
	 * 
	 * @see #setAvailable(boolean)
	 * @see #isVisible()
	 ...
	 *             if it's thrown a <code>DriverException</code> or an
	 ...
	 * 
	 * @return <code>true</code> if visible this layer has the visible status
	 ...
	 * </p>
	 * 
	 * @return <code>true</code> if there is a writing driver for this layer;
	 *         <code>false</code> otherwise
	 */
	 ...
	 * </p>
	 * <p>
	 * The implementations should take care of not recreate this layer. Instead
	 * of this, is better to use the same source (driver) and <i>deepclone</i>
	 * the legend. Exception: the labels aren't <i>deepcloned</i> to avoid
	 * memory consumption.
	 * </p>
	 * <p>
	 * <i>Note</i>: Labels are memory consuming to speed up layers like PostGIS
	 * and so on.
	 * </p>
	 * 
	 ...
	 *             any exception produced during the cloning of this layer.
	 */
	 ...
	 * check if a layer has a network loaded using
	 * <i>getAssociatedObject("network")</i> and that it's not null.
	 * </p>
	 * 
	 * @param key
	...
	/**
	 * <p>
	 * Returns a new instance of {@link ComposedLayer ComposedLayer}.
	 * </p>
	 * 
	 * <p>
	 * This allows make a single draw for a group of layers with the same
	 * source.
	 * </p>
	 * 
	 * <p>
	 * If this operation isn't applicable for this kind of layer, this method
	 * returns null.
	 * </p>
	 * 
	 * <p>
