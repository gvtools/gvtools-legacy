...
/**
 * This is an abstract class to keep the properties of the HyperLink. One layer
 * may have one or zero LinkProperties. The properties of a Link are: -
 * fieldName, the field큦 name of the selected column of the table associated to
 * the layer - extName, the name of the extension that the usser indicates -
 * typeLink, the type of the Link The class implements 'IPersistance' interface
 * to provide persistance to the properties of HyperLink
 */
public abstract class AbstractLinkProperties implements IPersistence {
	 ...
	 */
	public abstract URI[] getLink(FLayer layer, Point2D point, double tolerance)
			throws BehaviorException;
	...
	/**
	 * Gets the extension of the files that the user has indicated like
	 * properties of the HyperLink, this extension is added to the content of
	 * the field selected in the table
	 * 
	...
	/**
	 * Sets the properties of the HyperLink using a XMLEntity that contains the
	 * information
	 * 
	 * @param XMLEntity
	 */
