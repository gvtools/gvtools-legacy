...
public interface IEditableSource {
	 ...
	 *             Si no se logra poner la fuente de datos en edición
	 */
	 ...
	 * 
	 * @throws EditionException
	 *             Si no se consiguen llevar a cabo las modificaciones
	 */
	void stopEdition(IWriter writer, int sourceType)
			throws StopWriterVisitorException;
	 ...
	 * 
	 * @throws IOException
	 *             Si se produce un error con el fichero de expansión
	 * @throws DriverIOException
	 *             Si se produce un error accediendo a las geometrías originales
	 */
	IRowEdited getRow(int index) throws ReadDriverException,
	 ...
	 * 
	 * @throws DriverIOException
	 *             Si se produce un error accediendo a la capa
	 ...
	 *             Si se produce un error con el fichero de expansión
	 */
	int addRow(IRow row, String descrip, int sourceType)
	 ...
	 * 
	 * @throws DriverIOException
	 *             Si se produce un error accediendo a las filas originales
	 */
	 ...
	 * 
	 * @param index
	 *            Índice de la geometría que se quiere eliminar
	 * @throws ExpansionFileReadException
	 * @throws ReadDriverException
	 * 
	 * @throws DriverIOException
	 ...
	 *             Si se produce un error con el fichero de expansión
	 */
	void removeRow(int index, String descrip, int sourceType)
	 ...
	 * cuidado al invocar este método ya que cualquier tipo de asociación entre
	 * geometrías y otro tipo de objetos (comandos de edición, snapping, ...)
	...
	public void undoAddRow(int index, int sourceType)
			throws EditionCommandException;
	...
	/**
	 * Please, use this if you need support for defaultValues. Don't user
	 * getRecordset().getFieldsDescription()!!. The reason is ResultSetMetadata
	 * has no information about defaultValues in fields.
	 * 
	 * @return
	 */
