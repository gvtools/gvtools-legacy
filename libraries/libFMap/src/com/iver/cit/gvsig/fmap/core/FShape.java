...
/**
 * <p>
 * <code>FShape</code> extends <code>Shape</code> adding shape types, and
 * allowing to work with it as a geometry.
 * </p>
 */
public interface FShape extends Shape, Serializable {
	...
	/**
	 * <p>
	 * A geometric element that has zero dimensions and a location determinable
	...
	/**
	 * <p>
	 * A closed plane curve generated by a point moving in such a way that the
	 * sums of its distances from two fixed points is a constant : a plane
	 * section of a right circular cone that is a closed curve.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Indicates third coordinate. And can be combined with other geometries via
	 * the bits enabled.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Indicates M coordinate. And can be combined with other geometries via the
	 * bits enabled.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Gets the geometry type that identifies this shape.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Re-projects this shape using <code>ct</code> as transformation
	 * coordinates.
	 * </p>
	 * 
	 * @param crsTransform
