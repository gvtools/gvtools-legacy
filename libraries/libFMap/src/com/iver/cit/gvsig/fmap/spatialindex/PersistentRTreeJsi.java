...
//				output.writeFloat(nr.minX);
//				output.writeFloat(nr.minY);
//				output.writeFloat(nr.maxX);
//				output.writeFloat(nr.maxY);
//				
...
//		return (List) rtree.nearest(toJsiRect(rect), null, numberOfNearest);
//	}
//	
