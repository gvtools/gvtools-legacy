...
/* CVS MESSAGES:
 *
 * $Id: IStyle.java 22640 2008-07-30 11:56:24Z vcaballero $
 * $Log$
 ...
 * methods to stablish a description and get it,to specify if an object that
 * implements this interface is suitable for a kind of symbol and other methods
 * to draw symbols.
 * 
...
public interface IStyle extends IPersistence {
	 ...
	 * will need to specify a size in pixels. Of course. You may also preffer to
	 * render a prepared image, etc.
	 * 
	 * @param g
	 *            Graphics2D
	 * @param r
	 ...
	 * 
	 * @param g
	 *            , the Graphics2D where to draw
	 * @param r
	 *            , the bounds of the style inside such Graphics2D
	 */
