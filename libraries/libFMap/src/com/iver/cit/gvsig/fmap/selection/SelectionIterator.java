...
/**
 * <p>
 * Convenience class which allows to access a selection of rows in a DataSource,
 * using an Iterator interface (instead of the painful BitSet interface).
 * </p>
 * 
 * <p>
 ...
 * 
 */
public class SelectionIterator implements ResettableIterator<Value[]>,
		Cloneable {
	DataSource ds = null;
