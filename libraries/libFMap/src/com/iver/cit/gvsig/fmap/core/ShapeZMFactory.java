...
public class ShapeZMFactory {
	// TODO implement
	// public static IGeometry createPoint3DM(double x, double y,double z,
	// double m) {
	...
	public static IGeometry createPolygon3DM(GeneralPathX shape, double[] pZ,
			double[] pM) {
		throw new UnsupportedOperationException();
	}

	public static IGeometry createMultipoint3DM(double[] x, double[] y,
			double[] z, double[] m) {
		throw new UnsupportedOperationException();
	}
	 ...
	 */
	public static IGeometry createPolyline3DM(GeneralPathX shape, double[] pZ,
			double[] pM) {
