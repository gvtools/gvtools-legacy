...
/**
 * IMarkerFillPropertiesStyle is an interface used by classes that are trying to
 * fill a polygon using marker symbols for that. In order to permit a big mount
 * of possibilities for the filling, this interface has the options to modify
 * the rotation of the markers that compose the padding, the x and y offset, the
 * x and y separation,and the style of the fill.
 * 
...
public interface IMarkerFillPropertiesStyle extends IStyle {
	...
	/**
	 * <p>
	 * Defines an utility symbol to show up a thumbnail by default, this symbol
	...
	/**
	 * Return the separation (x axis) between the markers that compose the
	 * padding
	 * 
	 * @return x separation
	 */
	...
	/**
	 * Return the separation (y axis) between the markers that compose the
	 * padding
	 * 
	 * @return y separation
	 */
	...
	/**
	 * Returns the style of the fill that use marker symbols to do it(the
	 * filled).
	 * 
