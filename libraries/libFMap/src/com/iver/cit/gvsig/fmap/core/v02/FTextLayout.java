...
public class FTextLayout {
	 ...
	 * @return
	 */
	public Rectangle2D getBoundBox(Point2D p, Graphics2D g, int justification,
			ViewPort vp) {
		...
		return bounding;
		/*
		 * Point2D pOrigen=vp.fromMapPoint(p); return
		 * vp.toMapRectangle(getBoundingBox(pOrigen,justification,g));
		 */
	}
	 ...
	 *            DOCUMENT ME!
	 */
	private Rectangle2D justification(Point2D p, Rectangle2D r, double x,
			double y) {
	...
	public void draw(Graphics2D g2, int justification) {
		...
		switch (justification) {
		/*
		 * case FLabel.LEFT_BOTTOM: tl.draw(g2, 0, -3);
		 * 
		 * break;
		 * 
		 * case FLabel.LEFT_CENTER: tl.draw(g2, 0, -(height / 2));
		 * 
		 * break;
		 * 
		 * case FLabel.LEFT_TOP: tl.draw(g2, 0, -height);
		 * 
		 * break;
		 * 
		 * case FLabel.CENTER_BOTTOM: tl.draw(g2, -(width / 2), -3);
		 * 
		 * break;
		 * 
		 * case FLabel.CENTER_CENTER: tl.draw(g2, -(width / 2), -(height / 2));
		 * 
		 * break;
		 * 
		 * case FLabel.CENTER_TOP: tl.draw(g2, -(width / 2), -height);
		 * 
		 * break;
		 * 
		 * case FLabel.RIGHT_BOTTOM: tl.draw(g2, -width, -3);
		 * 
		 * break;
		 * 
		 * case FLabel.RIGHT_CENTER: tl.draw(g2, -width, -(height / 2));
		 * 
		 * break;
		 * 
		 * case FLabel.RIGHT_TOP: tl.draw(g2, -width, -height);
		 * 
		 * break;
		 */
		case FLabel.LEFT_BOTTOM:
		...
		case FLabel.CENTER_CENTER:
			g2.drawString(s, 0 - (width / 2), 0 - (height / 2));

			break;

		case FLabel.CENTER_TOP:
			g2.drawString(s, 0 - (width / 2), 0 - height);
		...
		case FLabel.RIGHT_CENTER:
			g2.drawString(s, 0 - width, 0 - (height / 2));
	...
	public Rectangle2D getBoundingBox(Point2D p1, int justification,
			Graphics2D g, ViewPort vp) {
		...
		/*
		 * Rectangle2D rtl=tl.getBounds(); Rectangle2D r=new
		 * Rectangle2D.Double(rtl
		 * .getX(),rtl.getY()-rtl.getHeight()/2,rtl.getWidth(),rtl.getHeight());
		 */
		return bounding;
	}
