...
/**
 * A LabelingStrategy is a way to define how the labels are painted in a map, or
 * potentially other object implementing ILabelable. It contains methods for
 * allowing the definition of labeling classes through the labeling method (see
 * <b>ILabelingMethod</b>), the placement of such labels (see
 * <b>IPlacementConstraints</b>), and the zoom properties (see
 * <b>ZoomConstraints</b>)
 * 
...
public interface ILabelingStrategy extends IPersistence {
	...
	/**
	 * Sets the labeling method that will be used the next time the the draw is
	 * invoked.
	 * 
	 * @param method
	 ...
	 * labels. The change will take effect next time the draw(...) method is
	 * invoked.
	 * 
	 * @param constraints
	 */
	 ...
	 * attributes. The result is manifested in the Graphics2D g which is the
	 * object sent to the printer.
	 * 
	 * @param g
	 * @param viewPort
	 * @param cancel
	 ...
	 * in the labeling. If this strategy contains more than one LabelClass the
	 * result is an array with all the names of the fields used by all the
	 * LabelClass, with no duplicates.
	 * 
	 * @return
	 */
