...
/**
 * Abstract class for the classes that make able a single draw for a layers
 * group
 * 
...
public abstract class ComposedLayer {
	...
	/**
	 * Adds the layer to the draw group. You have to implements the
	 * doAdd(FLayer) method.
	 * 
	 * 
	 ...
	 * 
	 * @see com.iver.cit.gvsig.fmap.layers.FLayer#draw(BufferedImage,
	 *      Graphics2D, ViewPort, Cancellable, double)
	 */
	public final void draw(BufferedImage image, Graphics2D g,
	...
	/**
	 * Prints all the group in one pass You have to implements the doDraw
	 * method.
	 * 
	 * @see com.iver.cit.gvsig.fmap.layers.FLayer#draw(BufferedImage,
	 *      Graphics2D, ViewPort, Cancellable, double)
	...
	/**
	 * Fires the event LayerDrawEvent.LAYER_AFTER_DRAW for every layers of the
	 * group.
	 * 
	 * 
	...
	private void fireLayerDrawingEvents(Graphics2D g, ViewPort viewPort) {
		...
		while (iter.hasNext()) {
			...
			afterEvent = new LayerDrawEvent(layer, g, viewPort,
	 ...
	 * 
	 * @see com.iver.cit.gvsig.fmap.layers.layerOperations.ComposedLayer#draw(BufferedImage,
	 *      Graphics2D, ViewPort, Cancellable, double)
	 * 
	 * @see com.iver.cit.gvsig.fmap.layers.FLayer#draw(BufferedImage,
	 *      Graphics2D, ViewPort, Cancellable, double)
	 */
	protected abstract void doDraw(BufferedImage image, Graphics2D g,
			ViewPort viewPort, Cancellable cancel, double scale)
			throws ReadDriverException;
	 ...
	 * 
	 * @see com.iver.cit.gvsig.fmap.layers.layerOperations.ComposedLayer#print(Graphics2D,
	 *      ViewPort, Cancellable, double)
	 * 
	 * @see com.iver.cit.gvsig.fmap.layers.FLayer#print(Graphics2D, ViewPort,
	 *      Cancellable, double)
	 */
