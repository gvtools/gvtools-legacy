...
public interface LayerCollection {
	 ...
	 * 
	 * @param listener
	 *            a <code>LayerCollectionListener</code>
	 * 
	 ...
	 *             any exception produced loading the layer.
	 * 
	...
	/**
	 * <p>
	 * Moves a layer of the collection to another position in internal list. It
	 * doesn't consider sub-nodes of layers.
	 * </p>
	 * 
	 * @param from
	 *            origin position
	 ...
	 * </p>
	 * 
	 * @return array with first-level visible layer nodes, or <code>null</code>
	 *         if no there is no layer visible
	 * 
	 ...
	 * </p>
	 * 
	 * @return array with first-level active layer nodes, or <code>null</code>
	 *         if no there is no layer actived
	 * 
	 ...
	 * 
	 * @param index
	 *            index of the ith-output layer in this collection.
	 * 
	 * @return a layer
	 * 
	 * @see #getLayer(String)
	 ...
	 * 
	 * @param layerName
	 *            name of a layer of this collection
	 * 
	 * @return a layer
	 * 
	 * @see #getLayer(int)
	 ...
	 * 
	 * <p>
	 * Doesn't counts the sublayers (of <code>FLayers</code> subnodes).
	 * </p>
	 * 
