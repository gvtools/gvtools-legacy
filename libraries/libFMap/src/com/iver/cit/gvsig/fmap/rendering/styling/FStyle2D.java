...
public class FStyle2D {
	...
	/**
	 * @return Returns the rgb (incluye transparencia) que se utilizará para la
	 *         aceleración gráfica.
	 * @uml.property name="rgbPoint"
	 */
	...
	public XMLEntity getXMLEntity() {
		...
		if (lineStyle2D.getContour() instanceof Color) {
			xml.putProperty("lContour", StringUtilities
					.color2String((Color) lineStyle2D.getContour()));
		} else if (lineStyle2D.getContour() instanceof GradientPaint) {
			xml.putProperty("lTransparency", ((GradientPaint) lineStyle2D
					.getContour()).getTransparency());
			xml.putProperty("lColor1", StringUtilities
					.color2String(((GradientPaint) lineStyle2D.getContour())
							.getColor1()));
			xml.putProperty("lColor2", StringUtilities
					.color2String(((GradientPaint) lineStyle2D.getContour())
							.getColor2()));
			xml.putProperty("lPoint1X", ((GradientPaint) lineStyle2D
					.getContour()).getPoint1().getX());
			xml.putProperty("lPoint1Y", ((GradientPaint) lineStyle2D
					.getContour()).getPoint1().getY());
			xml.putProperty("lPoint2X", ((GradientPaint) lineStyle2D
					.getContour()).getPoint2().getX());
			xml.putProperty("lPoint2Y", ((GradientPaint) lineStyle2D
					.getContour()).getPoint2().getY());
		} else if (lineStyle2D.getContour() instanceof TexturePaint) {
			xml.putProperty("lTransparency",
					((TexturePaint) lineStyle2D.getContour()).getTransparency());
			xml.putProperty("lAnchorRectX", ((TexturePaint) lineStyle2D
					.getContour()).getAnchorRect().getX());
			xml.putProperty("lAnchorRectY", ((TexturePaint) lineStyle2D
					.getContour()).getAnchorRect().getY());
			xml.putProperty("lAnchorRectW", ((TexturePaint) lineStyle2D
					.getContour()).getAnchorRect().getWidth());
			xml.putProperty("lAnchorRectH", ((TexturePaint) lineStyle2D
					.getContour()).getAnchorRect().getHeight());
		...
		if (polygonStyle2D.getContour() instanceof Color) {
			xml.putProperty("pContour", StringUtilities
					.color2String((Color) polygonStyle2D.getContour()));
		} else if (polygonStyle2D.getContour() instanceof GradientPaint) {
			xml.putProperty("pContourTransparency",
					((GradientPaint) polygonStyle2D.getContour())
							.getTransparency());
			xml.putProperty("pContourColor1", StringUtilities
					.color2String(((GradientPaint) polygonStyle2D.getContour())
							.getColor1()));
			xml.putProperty("pContourColor2", StringUtilities
					.color2String(((GradientPaint) polygonStyle2D.getContour())
							.getColor2()));
			xml.putProperty("pContourPoint1X", ((GradientPaint) polygonStyle2D
					.getContour()).getPoint1().getX());
			xml.putProperty("pContourPoint1Y", ((GradientPaint) polygonStyle2D
					.getContour()).getPoint1().getY());
			xml.putProperty("pContourPoint2X", ((GradientPaint) polygonStyle2D
					.getContour()).getPoint2().getX());
			xml.putProperty("pContourPoint2Y", ((GradientPaint) polygonStyle2D
					.getContour()).getPoint2().getY());
		} else if (polygonStyle2D.getContour() instanceof TexturePaint) {
			xml.putProperty("pContourTransparency",
					((TexturePaint) polygonStyle2D.getContour())
							.getTransparency());
			xml.putProperty("pContourAnchorRectX",
					((TexturePaint) polygonStyle2D.getContour())
							.getAnchorRect().getX());
			xml.putProperty("pContourAnchorRectY",
					((TexturePaint) polygonStyle2D.getContour())
							.getAnchorRect().getY());
			xml.putProperty("pContourAnchorRectW",
					((TexturePaint) polygonStyle2D.getContour())
							.getAnchorRect().getWidth());
			xml.putProperty("pContourAnchorRectH",
					((TexturePaint) polygonStyle2D.getContour())
							.getAnchorRect().getHeight());
			// TODO falta que guardar la imagen
		}
		if (polygonStyle2D.getFill() instanceof Color) {
			xml.putProperty("pFill", StringUtilities
					.color2String((Color) polygonStyle2D.getContour()));
		} else if (polygonStyle2D.getContour() instanceof GradientPaint) {
			xml.putProperty("pFillTransparency",
					((GradientPaint) polygonStyle2D.getContour())
							.getTransparency());
			xml.putProperty("pFillColor1", StringUtilities
					.color2String(((GradientPaint) polygonStyle2D.getContour())
							.getColor1()));
			xml.putProperty("pFillColor2", StringUtilities
					.color2String(((GradientPaint) polygonStyle2D.getContour())
							.getColor2()));
			xml.putProperty("pFillPoint1X", ((GradientPaint) polygonStyle2D
					.getContour()).getPoint1().getX());
			xml.putProperty("pFillPoint1Y", ((GradientPaint) polygonStyle2D
					.getContour()).getPoint1().getY());
			xml.putProperty("pFillPoint2X", ((GradientPaint) polygonStyle2D
					.getContour()).getPoint2().getX());
			xml.putProperty("pFillPoint2Y", ((GradientPaint) polygonStyle2D
					.getContour()).getPoint2().getY());
		} else if (polygonStyle2D.getContour() instanceof TexturePaint) {
			xml.putProperty("pFillTransparency", ((TexturePaint) polygonStyle2D
					.getContour()).getTransparency());
			xml.putProperty("pFillAnchorRectX", ((TexturePaint) polygonStyle2D
					.getContour()).getAnchorRect().getX());
			xml.putProperty("pFillAnchorRectY", ((TexturePaint) polygonStyle2D
					.getContour()).getAnchorRect().getY());
			xml.putProperty("pFillAnchorRectW", ((TexturePaint) polygonStyle2D
					.getContour()).getAnchorRect().getWidth());
			xml.putProperty("pFillAnchorRectH", ((TexturePaint) polygonStyle2D
					.getContour()).getAnchorRect().getHeight());
			// TODO falta que guardar la imagen
		}
