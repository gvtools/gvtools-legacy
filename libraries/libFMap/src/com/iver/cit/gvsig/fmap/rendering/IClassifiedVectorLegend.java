 ...
 */
public interface IClassifiedVectorLegend extends IClassifiedLegend,
		IVectorLegend {
	/**
	 * Deletes all the information of classification: intervals, values, or
	 * other classifying elements
	 */
	 ...
	 * 
	 * @param fieldNames
	 *            Names of the fields. TODO refactor to allow more than one
	 *            field name
	 */
	...
	/**
	 * Removes <b>oldSymbol</b> from the Legend and substitutes it with the
	 * <b>newSymbol</b>
	 * 
	 * @param oldSymbol
	 * @param newSymbol
