...
public class FLyrText extends FLyrDefault implements ClassifiableVectorial {
	...
	//
	// if (elExtent.contains(theShape.getX(), theShape.getY())) // TODO: Aqui
	// hay que
	// // ponerle al FLabel un
	// // getExtent()
	// {
	 ...
	 * 
	 * @see
	 * com.iver.cit.gvsig.fmap.layers.layerOperations.ClassifiableVectorial#
	 * setLegend(com.iver.cit.gvsig.fmap.rendering.VectorialLegend)
	 */
	 ...
	 * 
	 * @see
	 * com.iver.cit.gvsig.fmap.layers.layerOperations.Classifiable#getLegend()
	 */
	 ...
	 */
	/*
	 * public ArrayList getLabels() { return m_labels; }
	 */
	 ...
	 */
	/*
	 * public void setLabels(ArrayList m_labels) { this.m_labels = m_labels; }
	 */
}
