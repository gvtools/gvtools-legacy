 ...
 * <li>The area of a spherical polygon in spherical degrees, given the latitudes
 * and longitudes of <i>n</i> points, according the <a
 * href="http://en.wikipedia.org/wiki/Haversine_formula">Haversine function</a>.
 * </ul>
 * </p>
 * 
...
public class Geo {
	...
	/**
	 * <p>
	 * Gets the decimal degrees equivalent to the <i>m</i> meters.
	 * </p>
	 * <p>
	 * Uses this formula:</br> <b><i>m * R * PI</i></b>, having R = Radius of
	...
	/**
	 * <p>
	 * Operation for calculate the <a
	 * href="http://en.wikipedia.org/wiki/Haversine_formula">Haversine
	 * function</a>: <b><i>hav(x)= (1-cos(x))/2</i></b>.
	 * </p>
	 * 
	 * @param X
	 *            length between the difference of a coordinate of two points
	 */
	...
	/**
	 * <p>
	 * Returns the area of a spherical polygon in spherical degrees, given the
	 * latitudes and longitudes in <i>lat</i> and <i>lon</i>, respectively.
	 * </p>
	 * 
	 * <p>
	 * The <i>n</i> data points have indexes which range from 0 to N-1.
	 * </p>
	 * 
	 * <p>
	 * Uses the <a
	 * href="http://en.wikipedia.org/wiki/Haversine_formula">Haversine
	 * function</a> for calculating the spherical area of the polygon.
	 * </p>
	 * 
	 * @param lat
	 *            latitude of the vertexes <i>(must be in radians)</i>
	 * @param lon
	 *            longitude of the vertexes <i>(must be in radians)</i>
	 * @param n
