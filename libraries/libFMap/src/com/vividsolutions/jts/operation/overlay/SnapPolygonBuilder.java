...
public class SnapPolygonBuilder extends PolygonBuilder {
	 ...
	 * the <code>findEdgeRingContaining</code> method. (This is the case because
	 * any holes which are NOT properly contained (i.e. are connected to their
	 * parent shell) would have formed part of a MaximalEdgeRing and been
	...
	private EdgeRing findEdgeRingContaining(EdgeRing testEr, List shellList) {
		...
		for (Iterator it = shellList.iterator(); it.hasNext();) {
			...
			if (tryEnv.contains(testEnv)
					&& CGAlgorithms.isPointInRing(testPt,
