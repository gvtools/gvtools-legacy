...
/* CVS MESSAGES:
 *
 * $Id: SnappingEdge.java 10627 2007-03-06 17:10:21Z caballero $
 * $Log$
...
public class SnappingEdge extends Edge {
	...
	/**
	 * TODO->Esto es una cagada???? El problema es que no estoy aplicando SNAP
	 * en el compute de intersecciones colineales
	 * 
	 * 
	 * 
	 * Nos permite snapear las coordenadas del Edge, para que antes de añadir un
	 * SnapEdgeIntersection se verifique si coincide con un vertice (y snapearlo
	 * al vertice para evitar que salgan cosas raras)
	 * */
	...
	public void addIntersection(LineIntersector li, int segmentIndex,
		...
		// intPt es una coordenada, que puede estar muy cerca de alguna
		// coordenada
		...
		if (nextSegIndex < super.getNumPoints()) {
			...
			if (intPt.distance(nextPt) <= snapTolerance) {
				...
				Coordinate previousPoint = this
						.getCoordinate(normalizedSegmentIndex);
			...
			/*
			 * TODO Esto lo añado porque cuando la interseccion es un snapping,
			 * me conserva todos los puntos y me salen dos puntos seguidos
			 * iguales (probar) y luego la clase Quadrant me tira excepciones
			 */
	...
	/**
	 * Util para volver a calcular intersecciones de este Edge con los Edges de
	 * un geometrygraph distinto al original
	 * 
	 * */
