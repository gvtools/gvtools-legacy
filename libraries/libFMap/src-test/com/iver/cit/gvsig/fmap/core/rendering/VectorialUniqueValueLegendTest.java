...
/**
 * this is an initializer for the VectorialUniqueValueLegend legend for the
 * integration tests.
 * 
 ...
 * 
 */
public class VectorialUniqueValueLegendTest extends
		AbstractVectorLegendTestCase {

	public VectorialUniqueValueLegendTest() {
		super(VectorialUniqueValueLegend.class, new Value[] {
				TestClassifiedVectorLegend.v0, TestClassifiedVectorLegend.v1,
				TestClassifiedVectorLegend.v2, TestClassifiedVectorLegend.v3, });
	}
	...
	public void initLegend(ILegend leg) {
		...
		try {
			vuvl.setClassifyingFieldTypes(new int[] { TestClassifiedVectorLegend.mockDataSource
		...
		vuvl.setClassifyingFieldNames(new String[] { TestClassifiedVectorLegend.mockDataSource.fieldNames[classificationFieldIndex] });
	}
