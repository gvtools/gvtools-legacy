...
public class SourceManagerTest extends TestCase {
	...
	public void testCachedDataStore() throws Exception {
		...
		DataStore dataStore = SourceManager.instance.getDataStore(new DefaultSource(url));
		assertTrue(dataStore != null);
		assertTrue(dataStore == SourceManager.instance.getDataStore(new DefaultSource(url)));
	}
}
