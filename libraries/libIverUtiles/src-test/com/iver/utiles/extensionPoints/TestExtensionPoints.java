...
public class TestExtensionPoints extends TestCase {
	...
	public void test() {
		...
		extensionPointLayerWizars = (ExtensionPoint) extensionPoints
				.get("LayerWizars");
		...
		ExtensionPoint extensionPointLayerWizars2 = new ExtensionPoint(
				"LayerWizars");
		...
		assertEquals(
				((ExtensionPoint) extensionPoints.get("OtherWizars")).size(), 2);
		...
		assertEquals((extensionPointLayerWizars.get("JDBC")),
				UnaExtensionDePrueba4.class);
		assertEquals((extensionPointLayerWizars.get("WMS")),
				UnaExtensionDePrueba1.class);

		assertEquals(
				((ExtensionPoint) extensionPoints.get("OtherWizars"))
						.get("uno"),
				UnaExtensionDePrueba1.class);
		...
		ExtensionPoint extensionPointOther = (ExtensionPoint) extensionPoints
				.get("OtherWizars");
		assertEquals(extensionPoints.size(), 2);
		assertEquals(extensionPointLayerWizars.size(), 4);
		...
		assertEquals((extensionPointOther.get("tres")),
				UnaExtensionDePrueba3.class);
		assertEquals((extensionPointOther.get("dos")),
	...
	public void testSingleton() {
		ExtensionPoints extensionPoints1 = ExtensionPointsSingleton
				.getInstance();
		...
		ExtensionPoints extensionPoints2 = ExtensionPointsSingleton
				.getInstance();
		assertEquals(extensionPoints2.size(), 2);

		ExtensionPoint extensionPointLayerWizars;
		extensionPointLayerWizars = (ExtensionPoint) extensionPoints2
				.get("LayerWizars");
		assertTrue(extensionPointLayerWizars.containsKey("WMS"));
		assertTrue(extensionPointLayerWizars.containsKey("WCS"));
	}
