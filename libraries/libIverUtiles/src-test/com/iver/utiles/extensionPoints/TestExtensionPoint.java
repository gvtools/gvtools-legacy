...
public class TestExtensionPoint extends TestCase {
	...
	public void testCreacion() {
		...
		try {
			...
			TestExtensionPoint
					.fail("Ha petado la creacion de WCSLayer con InstantiationException");
		} catch (IllegalAccessException e) {
			TestExtensionPoint
					.fail("Ha petado la creacion de WCSLayer con IllegalAccessException");
		}
		...
		try {
			...
			TestExtensionPoint
					.fail("Ha petado la creacion de WMSLayer con InstantiationException");
		} catch (IllegalAccessException e) {
			TestExtensionPoint
					.fail("Ha petado la creacion de WMSLayer con IllegalAccessException");
		} catch (SecurityException e) {
			TestExtensionPoint
					.fail("Ha petado la creacion de WMSLayer con SecurityException");
		} catch (IllegalArgumentException e) {
			TestExtensionPoint
					.fail("Ha petado la creacion de WMSLayer con IllegalArgumentException");
		} catch (NoSuchMethodException e) {
			TestExtensionPoint
					.fail("Ha petado la creacion de WMSLayer con NoSuchMethodException");
		} catch (InvocationTargetException e) {
			TestExtensionPoint
					.fail("Ha petado la creacion de WMSLayer con InvocationTargetException");
		}
