...
public class TestCenterComponent {
	...
	public static void main(String args[]) {
		try {
			// Creates the main JFrame and configures it for test. Adds a
			// JDesktopPane
			...
			Dimension screenDimension = Toolkit.getDefaultToolkit()
					.getScreenSize();
			Rectangle screenRectangle = new Rectangle(screenTopLeftCorner,
					screenDimension);
	...
	private static void createComponentsForTest() {
		...
		JInternalFrame jInternalFrame1 = new JInternalFrame("JInternalFrame"
				+ i, true, // resizable
				true, // closable
				true, // maximizable
				false); // iconizable
		...
		CenterComponent.centerComponent(jInternalFrame1,
				jDesktopPane.getBounds());
