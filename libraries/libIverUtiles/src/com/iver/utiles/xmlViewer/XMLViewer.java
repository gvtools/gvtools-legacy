 ...
 * los attributos de cada nodo en una tabla y el texto contenido entre los tags
 * en un area de texto
 * 
...
public class XMLViewer extends JPanel {
	 ...
	 * 
	 * @param content
	 *            Objeto que lanzará los eventos del XML a representar
	 * 
	 * @throws SAXException
	 *             Si se produce algún error en el parseado del contenido
	 */
	 ...
	 * 
	 * @throws SAXException
	 *             Si se produce un error de SAX parseando el XMLContent
	 */
			...
			xmlTree.addTreeSelectionListener(new javax.swing.event.TreeSelectionListener() {
				...
				public void valueChanged(javax.swing.event.TreeSelectionEvent e) {
					...
					for (int i = 0; i < atts.size(); i++) {
						...
						tableModel
								.addRow(new Object[] { pair.field, pair.value });
					}
	 ...
	 */
	/*
	 * private javax.swing.JPanel getJPanel1() { if (jPanel1 == null) { jPanel1
	 * = new javax.swing.JPanel(); jPanel1.setLayout(new
	 * java.awt.BorderLayout()); jPanel1.add(getAttributeTable(),
