...
public class JConsole extends JPanel {
				...
				public void keyReleased(KeyEvent e) {
					if (e.getKeyCode() == KeyEvent.VK_ENTER) {
						...
						String response = texto
								.substring(startingCaretPosition);
	 ...
	 * 
	 * @param text
	 *            Texto que se añade a la consola
	 */
	...
	/**
	 * Añade un texto a la consola que es tomado como si lo hubiese escrito el
	 * usuario. Formará parte de la respuesta
	 * 
	 * @param text
	 *            Texto que se añade a la consola
	 */
	 ...
	 * jScrollPane = new JScrollPane(); jScrollPane.setViewportView(getTxt()); }
	 * 
	 * return jScrollPane; }
	 */
