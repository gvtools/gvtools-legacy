 ...
 * <code>AfterSavingListener</code> interface, you have to define all of the
 ...
 * component using the component's <code>addAfterSavingListener</code> method.
 * When an object that provides support of notification about has saved a file,
 * the relevant method in the listener object is invoked, and the
 * <code>SaveEvent</code> is passed to it.
 * 
...
public abstract class AfterSavingAdapter implements AfterSavingListener {
	 ...
	 * 
	 * @see
	 * com.iver.utiles.save.AfterSavingListener#afterSaving(com.iver.utiles.
	 * save.SaveEvent)
	 */
