...
/**
 * <p>
 * A simple, static class to display a URL in the system browser.<br>
 * </p>
 * 
 * <p>
 * Under <b>Unix</b> systems, it will open one of the browser set through the
 * <b>setBrowserCommand(String)</b>. The argument of this method must be a fully
 * qualified command or one of the commands returned by
 * <b>getSupportedBrowsers()</b>.<br>
 * By default, the browser is Firefox, which is included in the list of
 * supported browsers.<br>
 * </p>
 * 
 * <p>
 * Under <b>Windows</b>, this will bring up the default browser under windows,
 * usually either Netscape or Microsoft IE. The default browser is determined by
 * the OS so no config is necessary.<br>
 * This has been tested under Windows 95/98/NT/XP.
 * </p>
 * <p>
 * Notice that <b>you must include</b> the url type -- either "http://" or
 * "file://".
 * </p>
 * 
 * <p>
 * Under <b>Mac</b>, the usability of this class is pending of test. So probably
 * it does not work
 * </p>
...
public class BrowserControl {
	private static Logger logger = Logger.getLogger(BrowserControl.class
			.getName());
		...
		try {
			if (windows) {
				...
				if (browserCommand.equals(NETSCAPE)
					...
					cmd = browserCommand.toLowerCase() + " -remote openURL("
							+ url + ")";
					Process p = Runtime.getRuntime().exec(cmd);
					try {
					...
					logger.log(Level.FINEST,
							"Executing system runtime command: " + cmd);
