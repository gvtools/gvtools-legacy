...
public class ExtensionPoint extends LinkedHashMap {
	...
	/**
	 * Retorna el nombre de punto de extension. <br>
	 * 
	...
	/**
	 * Retorna la descripcion asociada al punto de extension. <br>
	 * 
	...
	/**
	 * Asocia una descripcion al punto de extension. <br>
	 * 
	 * @param description
	 */
	...
	/**
	 * Retorna la descripcion asociada a una extension. <br>
	 * 
	 * @param key
	 * <br>
	 * @return descripcion del punto de extension
	...
	/**
	 * Asocia una descripcion a una extension registrada. <br>
	 * 
	 * @param key
	...
	/**
	 * Añade una extension antes de la indicada con beforeKey, con su
	 * descripcion asociada
	 * 
	 * @param key
	 *            clave de la extension
	 * @param decription
	...
	/**
	 * Crea una extension. <br>
	 * Dado un nombre de extension asociada a este punto de extension, crea el
	 * objeto registrado para manejar la extension. <br>
	 * Si el objeto registrado para esa extension implementa el interface
	 * <i>IExtensionBuilder</i>, se invoca al metodo create para crear la
	 * instancia de la extension. <br>
	 * Si no implementa este interface, debera ser una clase, y se creara una
	 * instancia de esa clase. <br>
	 * 
	 * @param name
	 *            Nombre de la extension a crear.
	 ...
	 * indicados en <i>args</i>. <br>
	 * Debido a que los argumentos se pasan como un array de objetos, no es
	 * posible pasar al constructor de la extension parametros de tipos basicos
	 * como <i>int</i> o <i>long</i>. Se deberan pasar como objetos y existir un
	 * constructor de la clase que los pueda recibir de esta manera. <br>
	 * 
	 * @param name
	 *            Nombre de la extension a crear.
	 * @param args
	 *            Array de objetos a pasar como parametros en la construccion de
	 *            la instancia de la extension.
	 * @return La instancia creada de la extension.
	 * 
	...
	/**
	 * Crea un alias para una extension registrada. <br>
	 * 
	 * @param item
	 *            Nombre de la extension registrada.
	 * @param alias
	 *            alias a añadir.
	 * 
	 **/
