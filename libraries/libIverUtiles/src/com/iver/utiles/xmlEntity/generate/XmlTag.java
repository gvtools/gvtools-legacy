...
public class XmlTag implements java.io.Serializable {
	...
	public void addProperty(
			com.iver.utiles.xmlEntity.generate.Property vProperty)
	 ...
	 * @param vXmlTag
	 */
	public void addXmlTag(int index,
			com.iver.utiles.xmlEntity.generate.XmlTag vXmlTag)
			throws java.lang.IndexOutOfBoundsException {
	...
	public com.iver.utiles.xmlEntity.generate.Property getProperty(int index)
		...
		return (com.iver.utiles.xmlEntity.generate.Property) _propertyList
				.elementAt(index);
	...
	public com.iver.utiles.xmlEntity.generate.Property[] getProperty() {
		...
		for (int index = 0; index < size; index++) {
			mArray[index] = (com.iver.utiles.xmlEntity.generate.Property) _propertyList
					.elementAt(index);
		}
		return mArray;
	...
	public com.iver.utiles.xmlEntity.generate.XmlTag getXmlTag(int index)
		...
		return (com.iver.utiles.xmlEntity.generate.XmlTag) _xmlTagList
				.elementAt(index);
	...
	public com.iver.utiles.xmlEntity.generate.XmlTag[] getXmlTag() {
		...
		for (int index = 0; index < size; index++) {
			mArray[index] = (com.iver.utiles.xmlEntity.generate.XmlTag) _xmlTagList
					.elementAt(index);
		}
		return mArray;
	...
	public void setProperty(
			com.iver.utiles.xmlEntity.generate.Property[] propertyArray) {
		// -- copy array
		_propertyList.removeAllElements();
	 ...
	 * @param vXmlTag
	 */
	public void setXmlTag(int index,
			com.iver.utiles.xmlEntity.generate.XmlTag vXmlTag)
			throws java.lang.IndexOutOfBoundsException {
		// -- check bounds for index
		if ((index < 0) || (index > _xmlTagList.size())) {
	 ...
	 * @param xmlTagArray
	 */
	public void setXmlTag(
			com.iver.utiles.xmlEntity.generate.XmlTag[] xmlTagArray) {
		// -- copy array
		_xmlTagList.removeAllElements();
	...
	public static java.lang.Object unmarshal(java.io.Reader reader)
			throws org.exolab.castor.xml.MarshalException,
			org.exolab.castor.xml.ValidationException {
		return (com.iver.utiles.xmlEntity.generate.XmlTag) Unmarshaller
				.unmarshal(com.iver.utiles.xmlEntity.generate.XmlTag.class,
						reader);
