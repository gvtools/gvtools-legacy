...
public class StringUtilities {
	 ...
	 * 
	 * @param base
	 *            String donde se inserta
	 * @param position
	 *            posición de "base" donde se inserta la String
	 * @param injerto
	 *            String que se inserta en "base"
	 * 
	 ...
	 * 
	 * @param string
	 *            Cadena donde se busca
	 * @param position
	 *            posición que se está evaluando
	 * @param startSymbol
	 *            símbolo de apertura
	 * @param endSymbol
	 *            símbolo de clausura
	 * 
	 * @return true si la posición dada está entre un símbolo de apertura y otro
	 *         de clausura
	 */
	public static boolean isBetweenSymbols(String string, int position,
		...
		// Itera sobre la cadena almacenando las posiciones de los símbolos de
		// apertura hasta posición
	 ...
	 *            posición que se está evaluando
	 * @param symbol
	 *            símbolo que se toma para la comprobación
	 * 
	 ...
	 * 
	 * @param string
	 *            Cadena de la que se obtendrá la subcadena
	 * @param symbolSet
	 *            Conjunto de símbolos delimitadores
	 * @param position
	 *            Posición a partir de la cual se busca la subcadena
	 * 
	 ...
	 * @param start
	 *            Cadena de inicio de la delimitación
	 * @param end
	 *            Cadena de final de la delimitación
	 * @param startingPosition
	 *            Posición en la que se empieza a buscar
	 * 
	...
	public static Rectangle2D string2Rect(String rect) {
		...
		Rectangle2D.Double ret = new Rectangle2D.Double(
				new Double(coords[0]).doubleValue(),
	...
	public static Color string2Color(String stringColor) {
		...
		/*
		 * long color = new Long(stringColor).longValue(); long alpha = color /
		 * 16777216; color = color % 16777216;
		 * 
		 * long red = color / 65536; color = color % 65536; long green = color /
		 * 256; color = color % 256; long blue = color; return new Color(red,
		 * green, blue, alpha);
		 */
	}
	...
	public static String generateRandomString(int length) {
		...
		final String sorigen = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
	 ...
	 * 
	 * @param str
	 *            The string where find into
	 * @param subStr
	 *            The chain of characters that we want to know how many times
	 *            occurs
	 * @param caseSensitive
	 *            <code>true</code> if has to do case sensitive each search or
	 ...
	 */
	public static int numberOfOccurrencesOfSubStringInString(String str,
			String subStr, boolean caseSensitive) {
		int aux = 0;
	...
	/**
	 * Returns the number of occurrences of a chain of characters in an String,
	 * between a rank of positions (If the subString finishes before
	 * 'end_position' -> don't count that occurrence)
	 * 
	 * @param str
	 *            The string where find into
	 * @param subStr
	 ...
	 *            occurs
	 * @param caseSensitive
	 *            <code>true<code> if has to do case sensitive at each search or <code>false</code>
	 *            if not
	 * @param start_position
	 *            the initial position used by the search
	 * @param end_position
	...
	public static int numberOfOccurrencesOfSubStringInStringBetweenPositions(
			String str, String subStr, boolean caseSensitive,
