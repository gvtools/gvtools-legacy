 ...
 * @author Fjp
 * 
 *         Clase para trabajar con ficheros grandes. Mapea solo un trozo de
 *         fichero en memoria, y cuando intentas acceder fuera de esa zona, se
 *         ocupa de leer automáticamente el trozo que le falta.
 */
public class BigByteBuffer {
	...
	/**
	 * Revisa la posición absoluta, y si hace falta, carga el buffer con la
	 * parte de fichero que toca.
	 * 
	 * @throws IOException
	 */
	...
	public BigByteBuffer(FileChannel fc, FileChannel.MapMode mode,
