...
public class JComboBox<T> extends javax.swing.JComboBox<T> {
	...
	public class MyKeyListener implements KeyListener {
		 ...
		 * 
		 * @param text
		 *            texto que se busca en el modelo
		 * 
		 * @return String del modelo o null
		 */
		private String isInModel(String text) {
			DefaultComboBoxModel model = (DefaultComboBoxModel) JComboBox.this
					.getModel();
		...
		public void keyPressed(KeyEvent e) {
			...
			if ((e.getKeyCode() == KeyEvent.VK_BACK_SPACE)
				...
				/*
				 * if ((lastCaretPosition >=0) && (lastCaretPosition <=
		...
		public void keyReleased(KeyEvent e) {
			JTextField jtext = (JTextField) JComboBox.this.getEditor()
					.getEditorComponent();
			String texto = jtext.getText().substring(0,
