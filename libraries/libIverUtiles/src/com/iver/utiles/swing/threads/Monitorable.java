...
/**
 * Interface to monitorize a long process, which operates in many individual
 * steps
 * 
 * @author azabala
 * 
...
public interface Monitorable {
	...
	/**
	 * report monitor what number has the initial step of the process is
	 * monitoring
	 * 
	 * @param step
	 */
	...
	/**
	 * report monitor what number has the final step of the process is
	 * monitoring (no apply to undefined process)
	 * 
	 * @param step
	 */
	...
	/**
	 * Reports to the monitor that the process is monitoring is (or not) a
	 * defined process. A defined process is a process whose number of step is
	 * predefined (in front of not defined process, which may run in an unknown
	 * number of steps)
	 * 
	 * @param defined
	 */
