...
/**
 * Long time task that could be monitored. The monitorization information that
 * this task could offer is:<br>
 * <ul>
...
public interface IMonitorableTask extends ICancelableTask, ICancelMonitor {
	...
	/**
	 * This method is executed <b>from the Event Dispatch Thread</b> when the
	 * background task finishes. Any interaction with SWing objects should be
	 * placed here.
	 */
