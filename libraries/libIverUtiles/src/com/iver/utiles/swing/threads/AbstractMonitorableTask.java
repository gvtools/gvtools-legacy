 ...
 * @author fjp
 * 
 *         Basada en el trabajo de A. Zabala. Para usarla, extender de
 *         AbstractMonitorableTask e implementar el método run(). Ejemplo:
 * 
 *         La tarea se lanza con:
 * 
 *         PluginServices.cancelableBackgroundExecution(new WriterTask(layer,
 *         writer)); <br>
 * 
 ...
 *         IWriter writer; <br>
 *         int rowCount; <br>
 *         public WriterTask(FLyrVect lyr, IWriter writer) throws
 *         DriverException, DriverIOException <br>
 *         { <br>
 *         this.lyrVect = lyr; <br>
 ...
 *         "exportando_features")); <br>
 * 
 *         setFinalStep(rowCount); // Importante: Fijarlo en el constructor,
 *         para que esté establecido antes del run() <br>
 * 
 *         } <br>
 ...
 *         } <br>
 */
public abstract class AbstractMonitorableTask extends
