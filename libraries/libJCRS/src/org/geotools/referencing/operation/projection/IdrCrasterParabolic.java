	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptor LONGITUDE_OF_CENTER = createDescriptor(
                new NamedIdentifier[] {
                    ...
                    new NamedIdentifier(Citations.EPSG,    "NatOriginLong"),
                    new NamedIdentifier(Citations.EPSG,    "central_meridian"),		
                    new NamedIdentifier(Citations.EPSG,    "CenterLong")
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(Citations.OGC,      "CrasterParabolic"),
    			new NamedIdentifier(Citations.EPSG,     "Craster-Parabolic"),
    			new NamedIdentifier(Citations.EPSG,     "Craster_Parabolic"),
