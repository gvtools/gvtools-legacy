...
/**
 * Test para validar la lectura por líneas de un ecw. Muestrea valores sobre
 * toda la extensión leida y comprueba que el resultado sea correcto
 * 
...
public class TestReadLineEcw extends TestCase {
	 ...
	 * System.out.print("Línea: " + nLine + "| "); for (int i = 0; i <
	 * line.length; i++) System.out.print((int)(line[i] & 0x000000ff) + " ");
	 * System.out.println(); }
	 */

	public void testLine0_Banda0(byte[] line) throws InvalidSetViewException,
			FileNotOpenException, GridException {
	...
	public void testLine9_Banda0(byte[] line) throws InvalidSetViewException,
			FileNotOpenException, GridException {
	...
	public void testLine19_Banda0(byte[] line) throws InvalidSetViewException,
			FileNotOpenException, GridException {
	...
	public void testLine29_Banda0(byte[] line) throws InvalidSetViewException,
			FileNotOpenException, GridException {
	...
	public void testLine0_Banda2(byte[] line) throws InvalidSetViewException,
			FileNotOpenException, GridException {
	...
	public void testLine9_Banda2(byte[] line) throws InvalidSetViewException,
			FileNotOpenException, GridException {
	...
	public void testLine19_Banda2(byte[] line) throws InvalidSetViewException,
			FileNotOpenException, GridException {
	...
	public void testLine29_Banda2(byte[] line) throws InvalidSetViewException,
			FileNotOpenException, GridException {
