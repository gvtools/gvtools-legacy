...
/**
 * Este test prueba el calculo de estadisticas de un dataset. Comprueba que los
 * valores obtenidos en las estadisticas son correctos.
 * 
 * Algunos costes del calculo de estadistica en el raster completo
 * 
 * Ordenador: AMD Athlon(tm) XP 1800+ 1540MHz, 256KB Caché, 500M RAM Coste 1:
 * Raster: 17910x16062, 275M (GTiff), 1 Banda byte Tiempo: 74.295 segs (sgtes
 * igual) Coste 2: Raster: 8955x8031, 69M (GTiff), 1 Banda byte Tiempo: 18.905
 * segs (sgtes 3.362s) Coste 3: Raster: 812x586, 2.8M (GTiff), 3 Banda short
 * Tiempo: 0.925 segs (sgtes 0.152s) Coste 4: Raster: 870x870, 210K (Jpeg), 3
 * Banda byte Tiempo: 0.318 segs (sgtes 0.255s)
 * 
