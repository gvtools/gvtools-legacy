...
/**
 * Test de comparativa de datos cacheados con datos sin cachear. Leemos un
 * raster 1..n veces cacheandolo por páginas. Una vez cacheado recorreremos la
 * cache recuperando los datos y comparandolos con los originales para comprobar
 * que no ha habido perdida y que lo que se obtiene es igual a lo inicial.
 * 
...
public class TestRasterCache extends TestCase {
	...
	public void testStack() {
		...
		// Número de veces que cacheamos la imagen. Esto hace que el número de
		// líneas totales se multiplique por este número
		int nTimes = 1;
		...
		RasterCache rc = new RasterCache(f.getDataType()[0], f.getWidth(),
				f.getHeight() * nTimes, 3);
