 ...
 * imagen. Después hace selecciona un área dentro de la imagen de 2x2 y compara
 * que los valores leidos sean correctos.
 * 
...
public class TDSDoubleAdjustToExtentBufferGdal extends TestCase {
	...
	public void testStack() {
		...
		try {
			ds.setAreaOfInterest(645817.0, 4923851.0, 645853.0, 4923815.0, 10,
					10);
		} catch (RasterDriverException e) {
			e.printStackTrace();
