...
/**
 * La clase VectorizationBinding se usa para poder vectorizar una capa raster.
 * <p>
 * 
 ...
 * defecto y se invoca al metodo VectorizeBuffer()
 * <p>
 * 
 * Este ultimo metodo, devuelve un array de doubles indicando si lo que se ha
 * devuelto son operaciones tipicas de shapes... MoveTo, LineTo, CurveTo, etc...
 * <p>
 * 
 * En la primera posicion se devuelve el tamaño del array.
 * <p>
 * 
 * 03/09/2008
 * 
...
public class VectorizationBinding {
	 ...
	 */
	public VectorizationBinding(String file)
	 ...
	 * @throws RasterDriverException
	 */
	public VectorizationBinding(RasterDataset dataset)
	 ...
	 * @throws RasterDriverException
	 */
	public VectorizationBinding(BufferFactory bufferFactory)
			throws InterruptedException, RasterDriverException {
	 ...
	 * @throws InterruptedException
	 */
	private void setFile(String file) throws NotSupportedExtensionException,
	 ...
	 * @throws RasterDriverException
	 */
	private void setRasterDataset(RasterDataset dataset)
			throws InterruptedException, RasterDriverException {
	 ...
	 * @throws RasterDriverException
	 */
	private void setBufferFactory(BufferFactory bufferFactory)
			throws InterruptedException, RasterDriverException {
	...
	/**
	 * Pone a 1 la posición del bit pasado por parametro en el value. Operación
	 * binaria OR
	 * 
	 * @param value
	 * @param pos
	...
	public double[] VectorizeBuffer() throws InterruptedException {
		...
		try {
			return Potrace.vectorizeBufferRaster(bufferBits, buffer.getWidth(),
					buffer.getHeight(), getParams());
