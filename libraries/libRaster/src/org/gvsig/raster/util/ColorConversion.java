...
public class ColorConversion {
	 ...
	 * 
	 * @param rojo
	 *            Banda del rojo del pixel de entrada
	 * @param verde
	 *            Banda del verde del pixel de entrada
	 * @param azul
	 *            Banda del azul del pixel de entrada
	 * @return array de 3 valores con los datos HSL correspondiente al pixel de
	 *         entrada.
	 */
	...
	/**
	 * Conversión de RGB a HSV (Hue, Saturation, Value). El valor de H es el
	 * mismo que en HSL pero difiere en el calculo de la S y la V.
	 * 
	 * @param rojo
	 *            Banda del rojo del pixel de entrada
	 * @param verde
	 ...
	 * 
	 * @param h
	 *            Banda de matiz del pixel de entrada
	 * @param s
	 *            Banda de saturación del pixel de entrada
	 * @param azul
	 *            Banda de brillo del pixel de entrada
	 * @return array de 3 valores con los datos RGB correspondiente al pixel de
	 *         entrada.
	 */
	 ...
	 * 
	 * @param h
	 *            Banda de matiz del pixel de entrada. Valor entre 0 y 1.
	 * @param s
	 *            Banda de saturación del pixel de entrada. Valor entre 0 y 1.
	 * @param i
	 *            Banda de brillo del pixel de entrada. Valor entre 0 y 1.
	 * @return array de 3 valores con los datos RGB correspondiente al pixel de
	 *         entrada.
	 */
	 ...
	 * @param kScale
	 *            valor entre 0 y 1
	 * @return array de 4 valores con los datos CMYK correspondiente al pixel de
	 *         entrada.
	 */
	 ...
	 *         entrada.
	 */
	public double[] CMYKtoRGB(double cyan, double magenta, double yellow,
			double key) {
	 ...
	 * @param blue
	 *            Banda del azul del pixel de entrada
	 * @return double que representa la luminosidad. Para tenerlo en un rango de
	 *         255 hay que aplicar (lum * 255. + 0.5);
	 */
