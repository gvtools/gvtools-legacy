...
/**
 * Interfaz que deben implementar los grid en los que se puede consultar sus
 * datos.
 * 
...
public interface IQueryableGrid {
	...
	/**
	 * Obtiene el valor de una celda de tipo byte. Si el punto excede los
	 * límites del grid devuelve un valor NoData. La excepción será lanzada si
	 * intentamos acceder a un tipo de dato erroneo.
	 * 
	 * @param x
	 *            Posición X a recuperar
	 * @param y
	 *            Posición Y a recuperar
	...
	/**
	 * Obtiene el valor de una celda de tipo short. Si el punto excede los
	 * límites del grid devuelve un valor NoData. La excepción será lanzada si
	 * intentamos acceder a un tipo de dato erroneo.
	 * 
	 * @param x
	 ...
	 * del grid devuelve un valor NoData. La excepción será lanzada si
	 * intentamos acceder a un tipo de dato erroneo.
	 * 
	 * @param x
	 *            Posición X a recuperar
	...
	/**
	 * Obtiene el valor de una celda de tipo float. Si el punto excede los
	 * límites del grid devuelve un valor NoData. La excepción será lanzada si
	 * intentamos acceder a un tipo de dato erroneo.
	 * 
	 * @param x
	...
	/**
	 * Obtiene el valor de una celda de tipo double. Si el punto excede los
	 * límites del grid devuelve un valor NoData. La excepción será lanzada si
	 * intentamos acceder a un tipo de dato erroneo.
	 * 
	 * @param x
	...
	/**
	 * Asigna el método de interpolación. Si el lector no es interpolado se
	 * instanciará como interpolado sin necesidad de llamar a
	 * switchToInterpolationMethod. Los métodos de interpolación soportados
	 * están definidos en la clase GridInterpolated como variables estáticas.
	 * 
	 * @param iMethod
	 */
	...
	/**
	 * Consulta al grid si el valor pasado por parámetro coincide con el valor
	 * NoData del buffer.
	 * 
	 * @param dValue
	 *            valor para comparar con el NoData del buffer
	 ...
	 * 
	 * @param x
	 *            Coordenada X del punto a consultar
	 * @param y
	 *            Coordenada Y del punto a consultar
	...
	/**
	 * Obtiene la pendiente de un área de 3x3 píxeles que tiene como centro las
	 * coordenadas que se le indican
	 * 
	 * @param x
	 *            Coordenada pixel X
	 * @param y
