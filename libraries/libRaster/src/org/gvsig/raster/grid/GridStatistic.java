...
public class GridStatistic {
	...
	private double getValue(int x, int y) throws GridException,
		...
		case IBuffer.TYPE_BYTE:
			return (double) (grid.getCellValueAsByte(x, y) & 0xff);
		case IBuffer.TYPE_SHORT:
			return (double) (grid.getCellValueAsShort(x, y) & 0xffff);
		case IBuffer.TYPE_INT:
			return (double) (grid.getCellValueAsInt(x, y) & 0xffffffff);
		case IBuffer.TYPE_FLOAT:
			return (double) grid.getCellValueAsFloat(x, y);
		case IBuffer.TYPE_DOUBLE:
			return (double) grid.getCellValueAsDouble(x, y);
		}
		return 0;
	}
