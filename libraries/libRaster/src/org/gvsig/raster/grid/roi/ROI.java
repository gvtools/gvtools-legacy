...
public abstract class ROI implements IQueryableGrid {
	...
	/**
	 * Coord. x del grid donde está laz esquina sup. iz. del roi (coords.
	 * pixel).
	 */
	 ...
	 * 
	 * @param rois
	 *            Lista de ROIs para calcular la extensión máxima que ocupan
	 ...
	 * 
	 * @param x
	 *            Posici?n X en coordenadas pixel del ROI
	 * @param y
	 *            Posici?n Y en coordenadas pixel del ROI
	...
	/**
	 * Devuelve la matriz de varianza-covarianza, si no se encuentra calculada
	 * se calcula
	 * 
	...
	/**
	 * Comprueba si el rectangulo pasado como parámetro cae dentro del ROI o
	 * fuera
	 * 
	 * @param x
