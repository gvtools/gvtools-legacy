...
/**
 * Esta clase representa una página de disco. Una página de disco tendrá un
 * número de página asociado y un servidor de datos de disco por cada banda.
 * 
...
public class HddPage {
	 ...
	 *            Número de página
	 * @param nBands
	 *            Número de bandas del dataset
	 * @throws RasterDriverException
	 * @throws NotSupportedExtensionException
	 * @throws FileNotFoundException
	 */
	public HddPage(int nPag, RasterDataset dataset, Extent extent)
	...
	/**
	 * Constructor: crea un objeto dataSource para cada banda. Para todos los
	 * datasource de un mismo HddPage se usa el mismo identificador.
	 * 
	 * @param nPag
	 *            Número de página
	 * @param nBands
	...
	public HddPage(int nPag, int nBands) {
		...
		for (int iBand = 0; iBand < nBands; iBand++)
			dataSource[iBand] = new CacheDataServer(Long.toString(System
					.currentTimeMillis()), iBand, nPag);
	}
