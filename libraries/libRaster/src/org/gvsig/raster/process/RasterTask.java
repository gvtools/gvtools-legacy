 ...
 * al arrancar y eliminarse al terminar o ser cancelado. El proceso debe ser el
 * encargado de realizar estas acciones.
 * 
 * @version 30/08/2007
...
public class RasterTask {
	 ...
	 * cada señal. No es necesario utilizar estas. Se puede en cada caso, hacer
	 * un método manageEvent en el que se gestione las acciones concretas de una
	 * señal.
	 * 
	 * @param ev
	 *            Evento a gestionar
	...
	public void manageEvent(EventObject ev) throws InterruptedException {
		if (ev instanceof CancelEvent)
			throw new InterruptedException(
					"Proceso cancelado por señal del usuario.");
	}
}