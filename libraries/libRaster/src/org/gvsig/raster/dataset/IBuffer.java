...
public interface IBuffer extends IHistogramable {
	...
	/*
	 * public static int TYPE_UNDEFINED = 32; public static int TYPE_Byte = 0;
	 * //Buffer byte (8) public static int TYPE_UInt16 = 1; //Buffer short (16)
	 * public static int TYPE_Int16 = 2; //Buffer short (16) public static int
	 * TYPE_UInt32 = 6; //Buffer int (32) public static int TYPE_Int32 = 3;
	 * //Buffer int (32) public static int TYPE_Float32 = 4; //Buffer float (32)
	 * public static int TYPE_Float64 = 5; //Buffer double (64) public static
	 * int TYPE_CInt16 = 7; //Buffer short (16) public static int TYPE_CInt32 =
	 * 8; //Buffer int (32) public static int TYPE_CFloat32 = 9; //Buffer float
	 * (32) public static int TYPE_CFloat64 = 10;
	 */// Buffer double (64)
	 ...
	 * 
	 * @param x
	 *            Posición X del pixel a averiguar
	 * @param y
	 *            Posición Y del pixel a averiguar
	...
	/**
	 * Informa de si el buffer tiene la capacidad de intercambio de bandas o no
	 * la tiene.
	 * 
	...
	/**
	 * Obtiene una línea de datos con todas las bandas para buffers con tipo de
	 * dato byte.
	 * 
	 * @param line
	 *            Número de línea del buffer a recuperar
	 * @return Array bidimensional conteniendo la línea de datos donde la
	 *         primera dimensión representa las bandas y la segunda la posición
	 *         en la línea
	 * @throws InterruptedException
	 */
	...
	/**
	 * Sustituye una banda completa copiando los datos de la que se pasa por
	 * parámetro
	 * 
	 * @param nBand
	 *            Número de banda a sustituir
	 * @param banda
	 *            a copiar
	 */
	...
	/**
	 * Crea un buffer banda inicializado con el valor pasado por parámetro. Las
	 * dimensiones corresponden a las del buffer existente.
	 * 
	 * @param defaultValue
	 *            Valor con el que se inicializa la banda creada
	 * @throws InterruptedException
	 */
	 ...
	 * 
	 * @param band1
	 *            Banda 1 a intercambiar
	 * @param band2
	 *            Banda 2 a intercambiar
	 * @throws InterruptedException
	 */
	...
	/**
	 * Intercambia la posición de las bandas. La nueva posición viene dada por
	 * el vector pasado por parámetro. Cada posición del vector es una banda del
	 * buffer y el contenido de esa posición es la banda que se dibujará sobre
	 * ese buffer.
	 * <P>
	 * Por ejemplo un array con los valores: [2, 0, 1] significa que la banda
	 * que ocupa ahora la posición 2 pasará a ocupar la 0, la que tiene la
	 * posición 0 pasa a ocupar la 1 y la que tiene la posición 1 pasa a ocupar
	 * la 2.
	 * </P>
	 * 
	 * @param bands
	 *            Array con la nueva distribución de bandas
	 */
	...
	/**
	 * Asigna una banda al valor especificado como no valido. Esta banda es
	 * común para todas las bandas del buffer, es decir se asigna por
	 * referencia. No tiene el mismo resultado que asignar una banda a un valor
	 * fijo.
	 * 
	 * @param iBand
	 *            Número de banda
