...
/**
 * Clase que contiene la interpretación de color por banda. Inicialmente es
 * inicializada con los valores contenidos en el raster si los tiene. Después
...
public class DatasetColorInterpretation {
	...
	/**
	 * true si la imagen tiene una banda con el identificador de interpretación
	 * de color a Alpha
	 */
	...
	public static DatasetColorInterpretation createARGBInterpretation() {
		return new DatasetColorInterpretation(new String[] { ALPHA_BAND,
	...
	public static DatasetColorInterpretation createRGBInterpretation() {
		return new DatasetColorInterpretation(new String[] { RED_BAND,
	...
	/**
	 * Inicializa el vector de cadenas que contendrán el nombre de la
	 * interpretación de color asignada a cada banda. Este valor es el devuelto
	 * por la imagen.
	 * 
	 * @param values
	 *            Número de valores
	...
	/**
	 * Obtiene la posición de la banda que contiene el identificador pasado por
	 * parámetro o -1 si no tiene dicho identificador.
	 * 
	 * @return Posición de la banda que contiene el identificador o -1 si no lo
	 *         tiene.
	 */
		...
		if (colorInterpretation != null) {
			for (int i = 0; i < colorInterpretation.length; i++)
				if (colorInterpretation[i] != null
						&& colorInterpretation[i].equals(id))
					return i;
		}
		return -1;
	}
	...
	/**
	 * Obtiene la posición de las bandas que contienen el identificador pasado
	 * por parámetro o null si no tiene dicho identificador.
	 * 
	 * @return Lista con las posiciones de las bandas que contienen el
	 *         identificador o null si no lo tiene.
	 */
	...
	/**
	 * Obtiene el número de entradas de interpretación de color por banda en la
	 * lista.
	 * 
	 * @return
	 */
	...
	/**
	 * Añade un objeto DatasetColorInterpretation al actual. El resultado es la
	 * suma de ambos.
	 * 
	 * @param ci
	 */
	public void addColorInterpretation(DatasetColorInterpretation ci) {
		...
		for (int i = 0; i < ci.length(); i++) {
			...
			if (newCI[colorInterpretation.length + i] != null
					&& newCI[colorInterpretation.length + i].equals("Alpha"))
				isAlphaBand = true;
		}
