...
/**
 * Interfaz de operaciones aplicadas sobre un raster renderizable. Las
 * propiedades ofrecidas son las aplicadas en la renderización. No quiere decir
 * que sean las del propio raster ya que estas han podido ser modificadas.
 * 
...
public interface IRasterRendering {
	 ...
	 * 
	 * @return Entero que representa la transparencia aplicada en la
	 *         renderización.
	 */
