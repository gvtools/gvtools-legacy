...
public interface IRasterDataset extends IRasterFile {
	 ...
	 */
	public void addFile(String pathName) throws NotSupportedExtensionException,
	...
	/**
	 * Obtiene información registrada en el dataset a partir de una clave. Esta
	 * llamada es util para devolver información que no es contenida en la
	 * librería de raster y que puede ser registrada por la aplicación que hace
	 * uso de esta.
	 * 
	 * @param key
	 *            Nombre del parámetro registrado
