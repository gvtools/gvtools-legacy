...
public interface IRasterOperations {
	 ...
	 * 
	 * @return Entero que informa de la suma del número de bandas de todos los
	 *         ficheros que componen el raster.
	 */
	public int getBandCount();

	/**
	 * Obtiene una lista con el número de bandas del raster para todos los
	 * datasets.
	 * 
