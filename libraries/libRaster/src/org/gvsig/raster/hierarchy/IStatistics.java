...
public interface IStatistics {
	...
	/**
	 * Asigna un valor de recorte de colas para un porcentaje dado. El valor
	 * será un array bidimensional ([Número de bandas][2]) donde para cada banda
	 * se almacena el valor en esa posición del recorte de colas. Este recorte
	 * consiste en ordenar los elementos del raster (o una muestra de ellos) y
	 * devolver el valor que corresponde al porcentaje comenzando desde el
	 * principio del array ordenado y desde el final de él (mínimo y máximo).
	 * 
	 * @param percent
	 *            Porcentaje de recorte
	 * @param valueByBand
	 *            array bidimensional de enteros o doubles. Depende del tipo de
	 *            dato del raster.
	 */
	public void setTailTrimValue(double percent, Object valueByBand);

	/**
	 * Obtiene un valor de recorte de colas para un porcentaje dado. El valor
	 * será un array bidimensional ([Número de bandas][2]) donde para cada banda
	 * se almacena el valor en esa posición del recorte de colas. Este recorte
	 * consiste en ordenar los elementos del raster (o una muestra de ellos) y
	 * devolver el valor que corresponde al porcentaje comenzando desde el
	...
	/**
	 * Obtiene un valor de recorte de colas para una posición dada. El valor
	 * será un array bidimensional ([Número de bandas][2]) donde para cada banda
	 * se almacena el valor en esa posición del recorte de colas. Este recorte
	 * consiste en ordenar los elementos del raster (o una muestra de ellos) y
	 * devolver el valor que corresponde al porcentaje comenzando desde el
