...
public interface IRasterFile {
	...
	/**
	 * Obtiene el nombre de de cada fichero de que consta el raster. En caso de
	 * estar en disco debe ofrecerse con la ruta completa.
	 * 
	...
	/**
	 * Formato del fichero raster. Puede devolver la extensión correspondiente
	 * al fichero
	 * 
