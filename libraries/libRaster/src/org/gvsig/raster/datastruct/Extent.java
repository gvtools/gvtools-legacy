...
public class Extent {
	 ...
	 * 
	 * @param pt1
	 *            punto que representa la esquina superior izquierda
	 * @param pt2
	 *            punto que representa la esquina inferior derecha
	 */
	 ...
	 *            punto que representa la esquina inferior derecha
	 * @param ur
	 *            punto que representa la esquina superior derecha
	 * @param ll
	 *            punto que representa la esquina inferior izquierda
	 */
	public Extent(Point2D ul, Point2D lr, Point2D ur, Point2D ll) {
		...
		this.ur = ur;
		this.ll = ll;
		min = new Point2D.Double(Math.min(Math.min(ul.getX(), lr.getX()),
				Math.min(ur.getX(), ll.getX())), Math.min(
				Math.min(ul.getY(), lr.getY()), Math.min(ur.getY(), ll.getY())));
		max = new Point2D.Double(Math.max(Math.max(ul.getX(), lr.getX()),
				Math.max(ur.getX(), ll.getX())), Math.max(
				Math.max(ul.getY(), lr.getY()), Math.max(ur.getY(), ll.getY())));
	}
	 ...
	 * 
	 * @param x1
	 *            punto que representa la coordenada X de la esquina superior
	 *            izquierda
	 * @param y1
	 *            punto que representa la coordenada Y de la esquina superior
	 *            izquierda
	 * @param x2
	 *            punto que representa la coordenada X de la esquina inferior
	 *            derecha
	 * @param y2
	 *            punto que representa la coordenada Y de la esquina inferior
	 *            derecha
	 */
	...
	public void add(Point2D pt) {
		...
		min.setLocation(Math.min(pt.getX(), minX()),
				Math.min(pt.getY(), minY()));
		max.setLocation(Math.max(pt.getX(), maxX()),
				Math.max(pt.getY(), maxY()));
	}
	...
	/**
	 * Obtiene la coordenada X de la esquina superior izquierda. Esta, en
	 * condiciones normales conincide con el minimo en X pero cuando un raster
	 * está rotado esto puede variar.
	 * 
	 * @return ulx
	 */
	...
	/**
	 * Obtiene la coordenada Y de la esquina superior izquierda. Esta, en
	 * condiciones normales conincide con el maximo en Y pero cuando un raster
	 * está rotado esto puede variar.
	 * 
	 * @return uly
	 */
	...
	/**
	 * Obtiene la coordenada X de la esquina inferior derecha. Esta, en
	 * condiciones normales conincide con el máximo en X pero cuando un raster
	 * está rotado esto puede variar.
	 * 
	 * @return lrx
	 */
	...
	/**
	 * Obtiene la coordenada Y de la esquina inferior derecha. Esta, en
	 * condiciones normales conincide con el minimo en Y pero cuando un raster
	 * está rotado esto puede variar.
	 * 
	 * @return lry
	 */
