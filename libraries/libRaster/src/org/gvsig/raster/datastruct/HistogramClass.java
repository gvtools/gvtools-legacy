 ...
 * histogramas con tipo de datos en coma flotante en el cual hay que dividir los
 * intervalos en clases. Las clases se tendrán en cuenta como un intervalo el
 * cual el menor es cerrado y el mayor abierto, es decir
 * 
 * <PRE>
 * En las clases:
 * 0-1000
...
public class HistogramClass {
	 ...
	 * 
	 * @param a
	 *            Entero que representa al un valor de la clase
	 * @param b
	 *            Entero que representa al un valor de la clase
	 */
	 ...
	 * 
	 * @param max
	 *            Entero que representa al valor máximo de la clase
	 */
	 ...
	 * 
	 * @param min
	 *            Entero que representa al valor mínimo de la clase
	 */
