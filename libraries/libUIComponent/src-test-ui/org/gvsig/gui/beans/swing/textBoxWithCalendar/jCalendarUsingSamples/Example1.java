...
public class Example1 extends JFrame {
	...
	public Example1() {
		...
		JCalendar calendar1 = new JCalendar(JCalendar.DISPLAY_DATE
		...
		JCalendar calendar3 = new JCalendar(Calendar.getInstance(),
		...
		JCalendar calendar4 = new JCalendar(
				Calendar.getInstance(Locale.FRENCH), Locale.FRENCH,
				JCalendar.DISPLAY_DATE | JCalendar.DISPLAY_TIME, false);
