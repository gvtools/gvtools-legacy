...
class Example2 extends JFrame {
	...
	public Example2() {
		...
		JCalendarCombo calendar1 = new JCalendarCombo(
		...
		JCalendarCombo calendar2 = new JCalendarCombo(
				JCalendarCombo.DISPLAY_DATE, false);
		calendar2.addDateListener(listener);

		// Display time only and set the time pattern to use as a duration
		// from 00:00 to 23:59

		JCalendarCombo calendar3 = new JCalendarCombo(Calendar.getInstance(),
				Locale.getDefault(), JCalendarCombo.DISPLAY_TIME, false,
				"HH:mm:ss");
		...
		JCalendarCombo calendar4 = new JCalendarCombo(
				Calendar.getInstance(Locale.FRENCH), Locale.FRENCH,
