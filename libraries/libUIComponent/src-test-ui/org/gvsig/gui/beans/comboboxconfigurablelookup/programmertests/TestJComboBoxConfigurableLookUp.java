...
/**
 * <p>
 * Tests the class {@link JComboBoxConfigurableLookUp
...
public class TestJComboBoxConfigurableLookUp extends JFrame {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Create a TestJComboBoxConfigurableLookUp, sets the behavior
			// configuration and add Items
			...
			// DefaultComboBoxConfigurableLookUpModel model = new
			...
			// DefaultComboBoxConfigurableLookUpModel model =
			// (DefaultComboBoxConfigurableLookUpModel) jCBSD.getModel();
			...
			// Add some items to test if has too much delay with an average
			// number of items
			...
			// System.out.println("Index of LIBUI: " +
			// ((DefaultComboBoxConfigurableLookUpModel)jCBSD.getModel()).getIndexOf("LIBUI"));
			// jCBSD.addItem("AÑADIDO");
			// jCBSD.removeItemAt(0);
			// jCBSD.removeAllItems();
			// ((DefaultComboBoxConfigurableLookUpModel)jCBSD.getModel()).removeAllElements();
			// System.out.println("Number of elements (list box): " +
			// jCBSD.getItemCount());
			...
			// More tests
			// jCBSD.setSelectedIndex(0); // Failures before the component could
			// be showed
			// System.out.println("Selected: " + jCBSD.getSelectedItem());
			// jCBSD.setSelectedIndex(3); // Failures before the component could
			// be showed
			// System.out.println("Item at 3: " + jCBSD.getItemAt(3));
			// jCBSD.setSelectedItem("ÑANDÚ"); // Failures before the component
			// could be showed
			...
			JOptionPane.showMessageDialog(null, Messages
					.getText("testJComboBoxConfigurableLookUpErrorMessage"),
