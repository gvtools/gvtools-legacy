...
/**
 * <p>
 * Sample of personalized combo box cell renderer.
 * </p>
 * 
 * @version 08/02/2008
...
public class SampleBasicComboBoxRenderer extends BasicComboBoxRenderer {
	...
	/**
	 * <p>
	 * Creates a new instance of the <code>SampleBasicComboBoxRenderer</code>
	 * class.
	 * </p>
	 */
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		if (isSelected)
			...
			component.setBackground(new Color(((17 * index) % 256),
					((31 * index) % 256), ((7 * index) % 256)));
