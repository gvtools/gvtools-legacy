...
/**
 * <p>
 * Creates and launches an application for testing
 * {@link JComboBoxConfigurableLookUp JComboBoxConfigurableLookUp}.
 * </p>
 * 
 * @author Pablo Piqueras Bartolomé (pablo.piqueras@iver.es)
 * @version 07/02/2008
 */
public class JFrameUserTestOfJComboBoxConfigurableLookUp implements
		Serializable {
	...
	/**
	 * <p>
	 * Creates the main <code>JFrame</code> for execute the application, and
	 * adds to it the <code>JPanel</code> test application.
	 * </p>
	 */
	private void createFrame() {
		...
		frame.setTitle(Messages
				.getText("jComboBoxConfigurableLookUpByTheUser_frameTitle"));
		frame.getContentPane().add(
				getJPanelUserTestOfJComboBoxConfigurableLookUp());
	...
	/**
	 * <p>
	 * Initializes <code>mainPanel</code>.
	 * </p>
	 * 
