...
public class NumberRange extends Panel {
	...
	/**
	 * Constructor to set the field size (digits) and an initial, minimal and
	 * maximal value.
	 * 
	 * @param dig
	 *            Field size (digits)
 ...
 * 
 * Revision 1.2 2007/08/21 08:37:22 bsanchez - Quitados warnings en imports
 * innecesarios
 * 
 ...
 * 
 * Revision 1.1.1.1 2001/02/07 15:24:01 rtfm initial
 * 
 * Revision 1.4 1998/05/15 08:45:04 js added setValue
 * 
 * Revision 1.3 1998/04/21 15:39:25 js More comments.
 * 
 * Revision 1.2 1998/04/17 12:49:13 js Changes for layout of CardViews (missing
 * right line...)
 * 
 * Revision 1.1 1998/04/17 07:58:20 js A textfield (NumberField) with two
 * buttons to increment/decrement the numerical value.
 */
