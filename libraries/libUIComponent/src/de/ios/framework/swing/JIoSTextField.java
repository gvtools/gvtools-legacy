 ...
 */
public abstract class JIoSTextField extends JTextField implements
		DocumentListener, FocusListener, MouseListener {

	// FIXME: NOT SUPPORTED !!!!!!
	public void setEchoChar(char c) {
		new Exception(
				"Depricated call to setEchoChar,. Use JPasswordField instead.")
				.printStackTrace();
	}
	 ...
	 */
	public JIoSTextField(int cols, String _charSet, boolean _autoFormat,
			boolean _keepFocus) {
		super(cols);
		setCharSet(_charSet);
	 ...
	 */
	public synchronized JIoSTextField manuallyHandle(String _keys,
			String _replace) {
		keys = _keys;
		replace = _replace;
		if (keys == null)
	...
	/**
	 * Flag that indicated that a text-check is already involed at the end of
