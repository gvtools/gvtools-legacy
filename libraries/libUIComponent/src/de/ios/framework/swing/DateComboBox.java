...
public class DateComboBox extends JComboBox {
	...
	static java.util.ResourceBundle resource = java.util.ResourceBundle
			.getBundle("resources.Traduction")/* #BundleType=List */;
	...
	class DatePopup implements ComboPopup, MouseMotionListener, MouseListener,
		...
		protected JLabel createUpdateButton(final int field, final int amount) {
			...
			final Border unselectedBorder = new EmptyBorder(
