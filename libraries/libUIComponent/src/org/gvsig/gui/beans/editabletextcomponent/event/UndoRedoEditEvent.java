...
public class UndoRedoEditEvent extends java.util.EventObject {
	 ...
	 *            <code>this</code>)
	 * @param type
	 *            type of operation done <i>(undo or redo)</i>
	 * @param oldText
	 *            text before the operation
	 * @param newText
	 *            text after the operation
	 */
	public UndoRedoEditEvent(Object source, short type, String oldText,
			String newText) {
		super(source);
		myType = type;
		myOldText = oldText;
	 ...
	 * <code>UndoRedoEditEvent</code>.
	 * 
	 * @return a <code>String</code> representation of this
	 *         <code>UndoRedoEditEvent</code>
	 */
	public String toString() {
		return getClass().getName() + "[source=" + source + ",myType=" + myType
				+ ",myOldText=" + myOldText + ",myNewText=" + myNewText + "]";
	}
}