...
/**
 * <p>
 * All graphical components which inherit from {@link JTextComponent
 * JTextComponent} can enhance their functionality with graphical edition
 * options support implementing this interface.
 * </p>
 * 
 * @version 03/01/2008
...
public interface IEditableText {
	/**
	 * Sets the limit of actions that can hold the UndoManager of this
	 * component.
	 * 
	 * @param limit
	 *            sets the limit of actions that can hold
	 */
	...
	/**
	 * Adds a listener for notification of an <i>undo</i> or <i>redo</i>
	 * operation executed.
	 * 
	 * @param listener
	...
	/**
	 * Removes a listener for notification of an <i>undo</i> or <i>redo</i>
	 * operation executed.
	 * 
	 * @param listener
	...
	/**
	 * Returns an array of all the <code>UndoRedoEditListener</code> registered
	 * on this text component.
	 * 
	 * @return all of this component's <code>UndoRedoEditListener</code>s or an
	 *         empty array if no listeners of that kind are currently registered
	 * 
