...
/**
 * <p>
 * Agent that looks up items of an locale-rules alphabetically sort ordered
 * <code>Vector</code> that start with a text. Those items will be returned as a
 * {@link List List}.
 * </p>
 * 
 * <p>
...
public class StartsWithLookUpAgent implements ILookUp {
	 ...
	 */
	public synchronized List<Object> doLookUpConsideringCaseSensitive(
			String text, Vector<Object> sortOrderedItems, StringComparator comp) {
		if (text == null)
			return null;

		List<Object> results_list = doLookUpIgnoringCaseSensitive(text,
	 ...
	 * org.gvsig.gui.beans.comboboxconfigurablelookup.StringComparator)
	 */
	public synchronized List<Object> doLookUpIgnoringCaseSensitive(String text,
