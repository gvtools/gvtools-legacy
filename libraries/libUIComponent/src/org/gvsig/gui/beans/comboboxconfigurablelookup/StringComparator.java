...
public class StringComparator implements Comparator<Object> {
	...
	/**
	 * Determines if the comparator is sensitive to upper case and down case
	 * characters or not.
	 * 
	 * @return <code>true</code> if the comparator is sensitive to upper case
	 *         and down case characters; otherwise not
	 */
	...
	/**
	 * Sets the comparator sensitive or insensitive to upper case and down case
	 * characters.
	 * 
	 * @param b
	 *            <code>true</code> if the comparator is sensitive to upper case
	 *            and down case characters; <code>false</code> if not
	 */
