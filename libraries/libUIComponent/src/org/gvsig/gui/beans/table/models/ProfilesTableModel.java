...
public class ProfilesTableModel extends DefaultTableModel implements IModel {
	...
	private static boolean[] canEdit = new boolean[] { true, true, false,
			false, false };
	private static Class[] types = new Class[] { String.class, JButton.class,
	...
	public Object[] getNewLine() {
		...
		return new Object[] { "", color, new Double(0), new Double(0),
				new Double(0) };
	}
