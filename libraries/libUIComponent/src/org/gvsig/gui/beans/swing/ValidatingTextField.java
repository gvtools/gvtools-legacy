...
public class ValidatingTextField extends JTextField {
		...
		public String clean(String text) {
			if (text != null) {
				try {
					...
					int truncatedDecimalPart = Math.abs((int) Math
							.round(decimalPart * 100));
					text = "";
	...
	// public static class NumberWithDefinedDecimalNumberCuntCleaner extends
	// NumberCleaner {
	// private int decimalCount = 2;
	// public NumberWithDefinedDecimalNumberCuntCleaner(String textToAppend) {
	// this(textToAppend, 2);
	// }
	// public NumberWithDefinedDecimalNumberCuntCleaner(String textToAppend, int
	// decimalCount) {
	// super(textToAppend);
		...
		public String clean(String text) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null,
						Messages.getText("numero_incorrecto"));
			}
