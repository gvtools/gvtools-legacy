 ...
 */
public class JCalendarDatePanel extends JPanel implements
	...
	/**
	 * This is the default constructor with 2 parameters for set the size of the
	 * inner button
	 */
	...
	private JButton getJButton() {
		if (jButton == null) {
			...
			jButton.setText(this.getFormattedDate(this.getJCalendarDateDialog()
					.getDate()));
		}
		return jButton;
	}
	...
	public void setDefaultTitle() {
		this.getJCalendarDateDialog().setTitle(
				Messages.getText("calendarTitle"));
	}
	...
	/**
	 * Adds a component listener for the inner JDialog that cointins the
	 * calendar interface
	 * 
	 * @param componentListener
	 */
	public void addComponentListenerForJDialogCalendar(
