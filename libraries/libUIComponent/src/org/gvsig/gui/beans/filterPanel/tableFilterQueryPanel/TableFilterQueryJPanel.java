...
/**
 * This class is the graphical interface of the "FilterDialog" which was made by
 * Fernando and is in 'appgvSIG' project. It's supposed that other classes will
 * extend from this and will add the logic as is in the "FilterDialog" class.
 * 
 * @author Pablo Piqueras Bartolomé (p_queras@hotmail.com)
 */
public class TableFilterQueryJPanel extends AbstractFilterQueryJPanel implements
		Serializable {
	...
	protected int filterJScrollPanelWidth = defaultBottomJPanelWidth - 10
			- defaultButtonsSetPanelWidth;
	 ...
	 * 
	 * @see
	 * org.gvsig.gui.beans.filterPanel.AbstractFilterQueryJPanel#getFieldsJPanel
	 * ()
	 */
	protected JPanel getFieldsJPanel() {
		if (fieldsJPanel == null) {
			fieldsJPanel = new JPanelML();
			fieldsJPanel.setPreferredSize(new java.awt.Dimension(
					fieldsJPanelWidth, fieldsJPanelHeight));
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.gvsig.gui.beans.filterPanel.AbstractFilterQueryJPanel#
	...
	protected javax.swing.JScrollPane getFieldsJScrollPane() {
		if (fieldsJScrollPane == null) {
			...
			fieldsJScrollPane.setPreferredSize(new java.awt.Dimension(
	 ...
	 * 
	 * @see
	 * org.gvsig.gui.beans.filterPanel.AbstractFilterQueryJPanel#getValuesJPanel
	 * ()
	 */
	protected JPanel getValuesJPanel() {
		if (valuesJPanel == null) {
			valuesJPanel = new JPanelML();
			valuesJPanel.setPreferredSize(new java.awt.Dimension(
					valuesJPanelWidth, valuesJPanelHeight));
	...
	protected javax.swing.JScrollPane getValuesJScrollPane() {
		if (valuesJScrollPane == null) {
			...
			valuesJScrollPane.setPreferredSize(new Dimension(
					fieldsAndValuesJScrollPaneWidth,
					fieldsAndValuesJScrollPaneHeight));
	...
	protected JScrollPane getFilterJScrollPane() {
		if (filterJScrollPane == null) {
			...
			filterJScrollPane.setPreferredSize(new java.awt.Dimension(
					filterJScrollPanelWidth, filterJScrollPaneHeight));
	...
	protected javax.swing.JPanel getButtonsSetJPanel() {
		if (buttonsSetJPanel == null) {
			...
			buttonsSetJPanel.setPreferredSize(new java.awt.Dimension(
					defaultButtonsSetPanelWidth, defaultButtonsSetPanelHeight));
	...
	protected javax.swing.JButton getBtnNewSet() {
		if (btnNewSet == null) {
			...
			btnNewSet.setPreferredSize(new Dimension(this.setButtonWidth,
	...
	protected javax.swing.JButton getBtnAddToCurrentSet() {
		if (btnAddToCurrentSet == null) {
			...
			btnAddToCurrentSet.setPreferredSize(new Dimension(
					this.setButtonWidth, this.setButtonHeight));
	...
	protected javax.swing.JButton getBtnFromSet() {
		if (btnFromSet == null) {
			...
			btnFromSet.setPreferredSize(new Dimension(this.setButtonWidth,
					this.setButtonHeight));
			btnFromSet.setText(Messages.getText("Seleccionar_del_conjunto"));
	 ...
	 * 
	 * @see
	 * org.gvsig.gui.beans.filterPanel.AbstractFilterQueryJPanel#getTxtExpression
	 * ()
	 */
	protected javax.swing.JTextArea getTxtExpression() {
		if (txtExpression == null) {
			...
			txtExpression.setToolTipText(Messages
					.getText("write_here_a_filter_expression"));
		}
	 ...
	 * 
	 * @see
	 * org.gvsig.gui.beans.filterPanel.AbstractFilterQueryJPanel#getTopJPanel()
	 */
	protected JPanel getTopJPanel() {
		if (topJPanel == null) {
			topJPanel = new JPanelML();

			topJPanel.setPreferredSize(new Dimension(defaultTopJPanelWidth,
	 ...
	 * 
	 * @see
	 * org.gvsig.gui.beans.filterPanel.AbstractFilterQueryJPanel#getBottomJPanel
	 * ()
	 */
	protected JPanel getBottomJPanel() {
		if (bottomJPanel == null) {
			...
			bottomJPanel.setPreferredSize(new Dimension(
					defaultBottomJPanelWidth, defaultBottomJPanelHeight));
	 ...
	 * 
	 * @see
	 * org.gvsig.gui.beans.filterPanel.AbstractFilterQueryJPanel#resizeWidth
	 * (int)
	 */
	public void resizeWidth(int new_Width) {
		...
		if (difference != 0) {
			this.setPreferredSize(new Dimension(this.getPreferredSize().width
					+ difference, this.getPreferredSize().height));
			getTopJPanel().setPreferredSize(
					new Dimension(getTopJPanel().getPreferredSize().width
							+ difference,
							getTopJPanel().getPreferredSize().height));
			getBottomJPanel().setPreferredSize(
					new Dimension(getBottomJPanel().getPreferredSize().width
							+ difference,
							getBottomJPanel().getPreferredSize().height));
			int halfDifference = difference / 2;

			getFilterJScrollPane().setPreferredSize(
					new Dimension(
							getFilterJScrollPane().getPreferredSize().width
									+ halfDifference, getFilterJScrollPane()
									.getPreferredSize().height));

			getButtonsSetJPanel().setPreferredSize(
					new Dimension(
							getButtonsSetJPanel().getPreferredSize().width
									+ halfDifference, getButtonsSetJPanel()
									.getPreferredSize().height));
			getBtnNewSet().setPreferredSize(
					new Dimension(getBtnNewSet().getPreferredSize().width
							+ halfDifference,
							getBtnNewSet().getPreferredSize().height));
			getBtnAddToCurrentSet().setPreferredSize(
					new Dimension(
							getBtnAddToCurrentSet().getPreferredSize().width
									+ halfDifference, getBtnAddToCurrentSet()
									.getPreferredSize().height));
			getBtnFromSet().setPreferredSize(
					new Dimension(getBtnFromSet().getPreferredSize().width
							+ halfDifference, getBtnFromSet()
							.getPreferredSize().height));

			getFieldsJLabel().setPreferredSize(
					new Dimension(getFieldsJLabel().getPreferredSize().width
							+ halfDifference, getFieldsJLabel()
							.getPreferredSize().height));
			getFieldsJPanel().setPreferredSize(
					new Dimension(getFieldsJPanel().getPreferredSize().width
							+ halfDifference, getFieldsJPanel()
							.getPreferredSize().height));
			getFieldsJScrollPane().setPreferredSize(
					new Dimension(
							getFieldsJScrollPane().getPreferredSize().width
									+ halfDifference, getFieldsJScrollPane()
									.getPreferredSize().height));

			getValuesJLabel().setPreferredSize(
					new Dimension(getValuesJLabel().getPreferredSize().width
							+ halfDifference, getValuesJLabel()
							.getPreferredSize().height));
			getValuesJPanel().setPreferredSize(
					new Dimension(getValuesJPanel().getPreferredSize().width
							+ halfDifference, getValuesJPanel()
							.getPreferredSize().height));
			getValuesJScrollPane().setPreferredSize(
					new Dimension(
							getValuesJScrollPane().getPreferredSize().width
									+ halfDifference, getValuesJScrollPane()
									.getPreferredSize().height));
		}
	}
}