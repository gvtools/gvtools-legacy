...
/**
 * A JPanel representing a normative sized and aligned Ok and Cancel buttons
 * according on the gvSIG's style sheet. The buttons size is automatically
 * handled as far as the panel is BorderLayout-ed.
 * 
...
public class AcceptCancelPanel extends JPanel {
	 ...
	 * 
	 * @param okAction
	 *            , the handler for the ok button clicking.
	 * @param cancelAction
	 *            , the handler for the cancel button clicking.
	 * 
	 */
