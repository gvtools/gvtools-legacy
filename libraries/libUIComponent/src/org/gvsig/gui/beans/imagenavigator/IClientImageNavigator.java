...
public interface IClientImageNavigator {
	...
	/**
	 * Metodo que es invocado cuando ImageNavigator va a pintar la imagen. Pasa
	 * un Graphics para hacer el dibujado, y luego todas las posibles posiciones
	 * para hacer el pintado.
	 * 
	 * @param g
	 * @param x1
	 * @param y1
