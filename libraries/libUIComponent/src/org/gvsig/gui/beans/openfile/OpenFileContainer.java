...
public class OpenFileContainer extends JPanel {
	...
	public JTextField getTOpen() {
		if (tOpen == null) {
			...
			if (isButtonVisible) {
				...
				tOpen.setPreferredSize(new java.awt.Dimension((int) Math
						.floor(wComp * 0.95), hButton));
			}
		}
		return tOpen;
	}
	 ...
	 */
	/*
	 * public void setBorderText(String text){ this.borderText = text; }
	 */
	...
	public void setComponentSize(int w, int h) {
		...
		if (isButtonVisible) {
			this.getTOpen().setPreferredSize(
					new java.awt.Dimension(wText, hButton));
		} else {
			this.getTOpen().setPreferredSize(
					new java.awt.Dimension((int) Math.floor(wComp * 0.95),
							hButton));
		}
	}
