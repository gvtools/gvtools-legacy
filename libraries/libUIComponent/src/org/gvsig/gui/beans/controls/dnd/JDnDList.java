...
/**
 * <p>
 * A JList that allows drag'n'drop elements. It accepts changing position of one
 * or more elements within the list, adding other from other JDnDList's,
 ...
 */
public class JDnDList extends JList implements DragSourceListener,
	...
	/**
	 * Constructs a <b>JDnDListModel</b> from an array of objects and then
	 * applies setModel to it.
	 * 
	 * @param listData
	 *            an array of Objects containing the items to display in the
	 *            list
	 * @see setModel
	 * @author jaume
	 */
