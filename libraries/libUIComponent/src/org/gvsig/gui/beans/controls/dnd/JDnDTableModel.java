...
public class JDnDTableModel extends AbstractTableModel {
	...
	public void itemsMoved(CellCoordinates newCellCoord,
		...
		case ONLY_ALLOW_MOVING_COLUMNS:
			...
			System.out.println("movent columna " + srcColumnIndex
					+ " a columna " + dstColumnIndex);
			for (int i = 0; i < getRowCount(); i++) {
				CellCoordinates srcCoord = new CellCoordinates(i,
						srcColumnIndex);
				CellCoordinates dstCoord = new CellCoordinates(i,
						dstColumnIndex);
