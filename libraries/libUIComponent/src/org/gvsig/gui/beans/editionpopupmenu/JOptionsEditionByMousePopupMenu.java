 ...
 * </p>
 * <p>
 * The items showed in this menu are for editing: UNDO, REDO, CUT, COPY, PASTE,
 * DELETE and SELECT ALL.
 * </p>
 * <p>
 * When the user clicks on a item, this Component fires a property change event
 * that its value allows identify the item clicked.
 * </p>
 * <p>
 * (The icons used are from the open-source 'Tango Icon Library' project:
 * (http://tango.freedesktop.org/Tango_Icon_Library)).
 * </p>
 * 
 * @author Pablo Piqueras Bartolomé (p_queras@hotmail.com)
 */
public class JOptionsEditionByMousePopupMenu extends JPopupMenu implements
		Serializable {
	...
	private JMenuItem getJMenuItemUndo() {
		if (jMenuItemUndo == null) {
			ImageIcon undoIcon = new ImageIcon(
					JOptionsEditionByMousePopupMenu.class
							.getResource("images/edit-undo.png"),
					Messages.getText("edit_undo"));
			jMenuItemUndo = new JMenuItem(Messages.getText("edit_undo"),
					undoIcon);
			jMenuItemUndo.setHorizontalTextPosition(JMenuItem.RIGHT);
			jMenuItemUndo.addActionListener(this.getMenuListener());
			map.put(Messages.getText("edit_undo"),
					Integer.toString(JOptionsEditionByMousePopupMenu.UNDO));
		}
	...
	private JMenuItem getJMenuItemRedo() {
		if (jMenuItemRedo == null) {
			ImageIcon redoIcon = new ImageIcon(
					JOptionsEditionByMousePopupMenu.class
							.getResource("images/edit-redo.png"),
					Messages.getText("edit_redo"));
			jMenuItemRedo = new JMenuItem(Messages.getText("edit_redo"),
					redoIcon);
			jMenuItemRedo.setHorizontalTextPosition(JMenuItem.RIGHT);
			jMenuItemRedo.addActionListener(this.getMenuListener());
			map.put(Messages.getText("edit_redo"),
					Integer.toString(JOptionsEditionByMousePopupMenu.REDO));
		}
	...
	private JMenuItem getJMenuItemCut() {
		if (jMenuItemCut == null) {
			...
			map.put(Messages.getText("edit_cut"),
					Integer.toString(JOptionsEditionByMousePopupMenu.CUT));
		}
		return jMenuItemCut;
	}
	...
	private JMenuItem getJMenuItemCopy() {
		if (jMenuItemCopy == null) {
			ImageIcon copyIcon = new ImageIcon(
					...
					Messages.getText("edit_copy"));
			jMenuItemCopy = new JMenuItem(Messages.getText("edit_copy"),
					copyIcon);
			jMenuItemCopy.setHorizontalTextPosition(JMenuItem.RIGHT);
			jMenuItemCopy.addActionListener(this.getMenuListener());
			map.put(Messages.getText("edit_copy"),
					Integer.toString(JOptionsEditionByMousePopupMenu.COPY));
		}
	...
	private JMenuItem getJMenuItemPaste() {
		if (jMenuItemPaste == null) {
			ImageIcon pasteIcon = new ImageIcon(
					...
					Messages.getText("edit_paste"));
			jMenuItemPaste = new JMenuItem(Messages.getText("edit_paste"),
					pasteIcon);
			jMenuItemPaste.setHorizontalTextPosition(JMenuItem.RIGHT);
			jMenuItemPaste.addActionListener(this.getMenuListener());
			map.put(Messages.getText("edit_paste"),
					Integer.toString(JOptionsEditionByMousePopupMenu.PASTE));
		}
	...
	private JMenuItem getJMenuItemDelete() {
		if (jMenuItemDelete == null) {
			ImageIcon deleteIcon = new ImageIcon(
					JOptionsEditionByMousePopupMenu.class
							.getResource("images/edit-delete.png"),
					Messages.getText("edit_delete"));
			jMenuItemDelete = new JMenuItem(Messages.getText("edit_delete"),
					deleteIcon);
			jMenuItemDelete.setHorizontalTextPosition(JMenuItem.RIGHT);
			jMenuItemDelete.addActionListener(this.getMenuListener());
			map.put(Messages.getText("edit_delete"),
					Integer.toString(JOptionsEditionByMousePopupMenu.DELETE));
		}
	...
	private JMenuItem getJMenuItemSelectAll() {
		if (jMenuItemSelectAll == null) {
			ImageIcon selectAllIcon = new ImageIcon(
					JOptionsEditionByMousePopupMenu.class
							.getResource("images/edit-select-all.png"),
					Messages.getText("edit_select_all"));
			jMenuItemSelectAll = new JMenuItem(
					Messages.getText("edit_select_all"), selectAllIcon);
			jMenuItemSelectAll.setHorizontalTextPosition(JMenuItem.RIGHT);
			jMenuItemSelectAll.addActionListener(this.getMenuListener());
			map.put(Messages.getText("edit_select_all"), Integer
					.toString(JOptionsEditionByMousePopupMenu.SELECT_ALL));
		}
		...
		if (menuListener == null) {
			menuListener = new ActionListener() {
				...
				public void actionPerformed(ActionEvent event) {
					// Notifies that the Visibility of this component has
					// changed
					if (event.getActionCommand().equals(
						...
						// Notifies that has been clicked on an item
						changes.firePropertyChange(
	...
	public void setVisible(boolean b) {
		...
		super.setVisible(b);
		this.getMenuListener().actionPerformed(
