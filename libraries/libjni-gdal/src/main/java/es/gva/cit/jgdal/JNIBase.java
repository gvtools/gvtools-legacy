...
public class JNIBase {
	...
	protected int baseSimpleFunctions(int n, String msg1, String msg2)
		...
		switch (n) {
		case 0:
			res = getRasterBandXSizeNat(cPtr);
			break;
		case 1:
			res = getRasterBandYSizeNat(cPtr);
			break;
		case 2:
			res = getOverviewCountNat(cPtr);
			break;
		case 3:
			res = getBlockXSizeNat(cPtr);
			break;
		case 4:
			res = getBlockYSizeNat(cPtr);
			break;
		case 5:
			res = getRasterXSizeNat(cPtr);
			break;
		case 6:
			res = getRasterYSizeNat(cPtr);
			break;
		case 7:
			res = getRasterCountNat(cPtr);
			break;
		case 8:
			res = getGCPCountNat(cPtr);
			break;
		case 9:
			res = getRasterDataTypeNat(cPtr);
			break;
		}
