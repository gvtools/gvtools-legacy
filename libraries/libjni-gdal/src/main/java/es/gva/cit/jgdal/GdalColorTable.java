...
public class GdalColorTable extends JNIBase {
	...
	/**
	 * Constructor de ColorTable pasandole como parámetro la referencia al
	 * objeto GdalColorTable en C
	 * 
	 * @param cPtr
	...
	/**
	 * Obtiene la entrada de la tabla de color de la posición pasada por
	 * parámetro y la devuelve en forma de objeto GdalColorEntry.
	 * 
	 * @param pos
	 *            Posición de la entrada de la tabla
	...
	public GdalColorEntry getColorEntryAsRGB(int pos) throws GdalException {
		...
		if ((pos < 0) || (pos >= getColorEntryCount()))
			throw new GdalException(
					"Entrada de la tabla de color fuera de rango");
