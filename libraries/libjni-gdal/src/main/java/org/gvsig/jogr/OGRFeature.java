...
public class OGRFeature extends JNIBase {
	...
	private native int getFieldAsIntegerListNat(long cPtr, String pszFName,
			int pnCount);

	private native double getFieldAsDoubleListNat(long cPtr, String pszFName,
			int pnCount);
	...
	private native void setFieldNat(long cPtr, int i, int nCount,
			double padfValues);
	...
	private native void setFieldNat(long cPtr, String pszFName, int nCount,
			int panValues);

	private native void setFieldNat(long cPtr, String pszFName, int nCount,
			double padfValues);

	private native void setFieldNat(long cPtr, String pszFName,
			String[] papszValues);
	...
	private native int remapFieldsNat(long cPtr, OGRFeatureDefn poNewDefn,
			int panRemapSource);// Excepciones
	...
	private native static OGRFeature createFeatureNat(long cPtr,
			OGRFeatureDefn feature);
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto OGRFeature de C.
	 */
	...
	public void dumpReadable(String file) throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en dumpReadable(). El constructor ha fallado." + h);
	...
	public int getFieldAsIntegerList(String pszFName, int pnCount)
			throws OGRException {
		return 0;
	}
	...
	public double getFieldAsDoubleList(String pszFName, int pnCount)
			throws OGRException {
		return 0;
	}
	...
	public void setField(int i, int nCount, double padfValues)
			throws OGRException {
	...
	public void setField(String pszFName, int nCount, int panValues)
			throws OGRException {
	...
	public void setField(String pszFName, int nCount, double padfValues)
			throws OGRException {
	...
	public void setField(String pszFName, String[] papszValues)
			throws OGRException {
	...
	public void remapFields(OGRFeatureDefn poNewDefn, int panRemapSource)
	...
	public static OGRFeature createFeature(OGRFeatureDefn feature)
			throws OGRException {
		return null;
	}
