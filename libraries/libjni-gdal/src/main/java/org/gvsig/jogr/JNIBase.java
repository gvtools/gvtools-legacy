...
public class JNIBase {
	...
	/**
	 * Función que sirve como base para funcionalidades de ogr que admiten como
	 * parámetro un long y devuelven un entero.
	 * 
	 * @throws OGRException.
	 * @param msg1
	...
	protected int baseSimpleFunctions(int n, String msg1, String msg2)
		...
		switch (n) {
		case 0:
			res = getDriverCountNat(cPtr);
			break;
		case 1:
			res = getLayerCountNat(cPtr);
			break;
		case 2:
			res = getFeatureCountNat(cPtr);
			break;
		case 3:
			res = getFieldCountNat(cPtr);
			break;
		case 4:
			res = getWidthNat(cPtr);
			break;
		case 5:
			res = getPrecisionNat(cPtr);
			break;
		case 6:
			res = referenceNat(cPtr);
			break;
		case 7:
			res = dereferenceNat(cPtr);
			break;
		case 8:
			res = getRefCountNat(cPtr);
			break;
		case 9:
			res = getSummaryRefCountNat(cPtr);
			break;
		case 10:
			res = referenceFeatureDefnNat(cPtr);
			break;
		case 11:
			res = dereferenceFeatureDefnNat(cPtr);
			break;
		case 12:
			res = getReferenceCountNat(cPtr);
			break;
		case 13:
			res = getFieldCountFeatureNat(cPtr);
			break;
		...
		case 18:
			res = referenceLayerNat(cPtr);
			break;
		case 19:
			res = dereferenceLayerNat(cPtr);
			break;
		case 20:
			res = getRefCountLayerNat(cPtr);
			break;
		case 21:
			res = getOpenDSCountNat(cPtr);
			break;
		case 22:
			res = getDimensionNat(cPtr);
			break;
		case 23:
			res = isSimpleNat(cPtr);
			break;
		case 24:
			res = wkbSizeNat(cPtr);
			break;
		case 25:
			res = isEmptyPointNat(cPtr);
			break; // return OGRBoolean
		case 26:
			res = getCoordinateDimensionPointNat(cPtr);
			break;
		case 27:
			res = getNumPointsNat(cPtr);
			break;
		case 28:
			res = isEmptyLineStringNat(cPtr);
			break; // return OGRBoolean
		case 29:
			res = getCoordinateDimensionLineStringNat(cPtr);
			break;
		case 30:
			res = isClockwiseNat(cPtr);
			break;
		case 31:
			res = WkbSizeNat(cPtr);
			break;
		case 32:
			res = getNumInteriorRingsNat(cPtr);
			break;
		case 33:
			res = wkbSizeNat(cPtr);
			break;
		case 34:
			...
			break;
		case 35:
			res = getCoordinateDimensionNat(cPtr);
			break;
		}
	...
	protected void throwException(int err, String mensaje)
			throws OGRCorruptDataException, OGRFailureException,
			OGRNotEnoughDataException, OGRNotEnoughMemoryException,
			OGRUnsupportedGeometryTypeException,
			OGRUnsupportedOperationException, OGRUnsupportedSRSException {

		switch (err) {
		case 1:
			throw new OGRNotEnoughDataException(mensaje);
		case 2:
			throw new OGRNotEnoughMemoryException(mensaje);
		case 3:
			throw new OGRUnsupportedGeometryTypeException(mensaje);
		case 4:
			throw new OGRUnsupportedOperationException(mensaje);
		case 5:
			throw new OGRCorruptDataException(mensaje);
		case 6:
			throw new OGRFailureException(mensaje);
		case 7:
			throw new OGRUnsupportedSRSException(mensaje);
		default:
			return;
		}
	}
	 ...
	 * 
	 * @param cPtr
	 *            long con la dirección de memoria del objeto
	 */
	public long getPtro() {
		return cPtr;
	}
