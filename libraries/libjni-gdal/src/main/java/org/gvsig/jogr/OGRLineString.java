...
public class OGRLineString extends JNIBase {
	...
	private native int exportToWkbNat(long cPtr, boolean ogrwkbByteOrder,
	...
	private native int getGeometryTypeNat(long cPtr);// return
														// OGRwkbGeometryType
	...
	private native void setPointNat(long cPtr, int i, double x, double y,
			double z);

	private native void setPointsNat(long cPtr, int i, double padfX,
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto OGRLineString de C.
	 */
	...
	public int getGeometryType() throws OGRException { // return
														// OGRwkbGeometryType
		return 0;
	}
	...
	public void setPoints(int i, double padfX, double padfY, double padfZ)
			throws OGRException {
