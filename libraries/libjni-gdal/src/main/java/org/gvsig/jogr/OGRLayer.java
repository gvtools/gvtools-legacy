...
public class OGRLayer extends JNIBase {
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto OGRLayer de C.
	 */
	...
	public OGRFeatureDefn getLayerDefn() throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en getLayerDefn(). El constructor no tuvo exito");

		long layer = getLayerDefnNat(cPtr);

		if (layer == 0)
			throw new OGRException(
					"Error en getLayerDefn(). No se ha podido obtener el objeto OGRFeatureDefn.");
	...
	public void resetReading() throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en resetReading(). El constructor no tuvo exito");
	...
	public OGREnvelope getExtent(boolean bForce) throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en getExtent(). El constructor no tuvo exito");
	...
	public OGRFeature getNextFeature() throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en getNextFeature(). El constructor no tuvo exito");
	...
	public OGRGeometry getSpatialFilter() throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en getSpatialFilter(). El constructor no tuvo exito");

		long ptr_sf = getSpatialFilterNat(cPtr);

		if (ptr_sf == 0)
			throw new OGRException(
					"Error en getSpatialFilter(). No se ha podido obtener un OGRGeometry valido.");
	...
	public void setSpatialFilter(OGRGeometry geom) throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en setSpatialFilter(). El constructor no tuvo exito");

		if (geom.getPtro() == 0)
			throw new OGRException(
					"Error en setSpatialFilter(). El objeto OGRGeometry no tiene un puntero valido.");
	...
	public void setAttributeFilter(String att) throws OGRException { // Excepciones
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en setAttributeFilter(). El constructor no tuvo exito");
	...
	public OGRFeature getFeature(long nFID) throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en getFeature(). El constructor no tuvo exito");

		long ptr_f = getFeatureNat(cPtr, nFID);

		if (ptr_f == 0)
			throw new OGRException(
					"Error en getFeature(). No se ha podido obtener un OGRFeature valido.");
	...
	public void setFeature(OGRFeature poFeature) throws OGRException {// Excepciones
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en setFeature(). El constructor no tuvo exito");

		if (poFeature.getPtro() == 0)
			throw new OGRException(
					"Error en setFeature(). El objeto OGRFeature no tiene un puntero valido.");
	...
	public void createFeature(OGRFeature poFeature) throws OGRException {// Excepciones
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en createFeature(). El constructor no tuvo exito");

		if (poFeature.getPtro() == 0)
			throw new OGRException(
					"Error en createFeature(). El objeto OGRFeature no tiene un puntero valido.");
	...
	public void deleteFeature(long nFID) throws OGRException {// Excepciones
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en deleteFeature(). El constructor no tuvo exito");
	...
	/**
	 * Obtiene el sistema de referencia espacial para esta capa o nulo si no
	 * tiene.
	 * 
	 * @throws OGRException
	...
	public OGRSpatialReference getSpatialRef() throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en getSpatialRef(). El constructor no tuvo exito");
	...
	public int testCapability(String od) throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en testCapability(). El constructor ha fallado.");
	...
	public String getInfo(String s) throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en getInfo(). El constructor no tuvo exito");

		String info = getInfoNat(cPtr, s);

		if (info == null)
			throw new OGRException(
					"Error en getInfo(). No se ha podido obtener información valida.");
	...
	public void createField(OGRFieldDefn poField, int bApproxOK)
			throws OGRException {// Excepciones

		if (cPtr == 0)
			throw new OGRException(
					"Error en greateField(). El constructor no tuvo exito");

		if (poField.getPtro() == 0)
			throw new OGRException(
					"Error en greateField(). El objeto OGRFieldDefn no tiene una dirección de memoria valida.");
	...
	public OGRStyleTable getStyleTable() throws OGRException {
		...
		if (ptr_st == 0)
			throw new OGRException(
					"Error en getStyleTable(). No se ha podido obtener un objeto OGRStyleTable valido.");
	...
	public void setStyleTable(OGRStyleTable poStyleTable) throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en setStyleTable(). El constructor no tuvo exito");
	...
	public void startTransaction() throws OGRException {// Excepciones
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en startTransaction(). El constructor no tuvo exito");
	...
	public void commitTransaction() throws OGRException {// Excepciones
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en commitTransaction(). El constructor no tuvo exito");
	...
	public void rollbackTransaction() throws OGRException {// Excepciones
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en rollbackTransaction(). El constructor no tuvo exito");
	...
	public int reference() throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en reference(). El constructor no tuvo exito");
	...
	public int dereference() throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en dereference(). El constructor no tuvo exito");
	...
	public void initializeIndexSupport(String s) throws OGRException {// Excepciones
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en initializeIndexSupport(). El constructor no tuvo exito");
	...
	public OGRLayerAttrIndex getIndex() throws OGRException {
		...
		if (cPtr == 0)
			throw new OGRException(
					"Error en getIndex(). El constructor no tuvo exito");

		long ptr_lai = getIndexNat(cPtr);

		if (ptr_lai == 0)
			throw new OGRException(
					"Error en getIndex(). No se ha podido obtener un OGRLayerAttrIndex valido.");
