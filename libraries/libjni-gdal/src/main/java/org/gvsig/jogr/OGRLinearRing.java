...
public class OGRLinearRing extends OGRLineString {
	...
	private native int importFromWkbNat(long cPtr, String wkt, int i); // return
																		// OGRErr

	private native int exportToWkbNat(long cPtr, boolean wktborder, String wkt); // return
																					// OGRErr.
																					// boolean=OGRwkbByteOrder
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto OGRLinearRing de C.
	 */
	...
	public void exportToWkb(boolean wktborder, String wkt) throws OGRException { // return
																					// OGRErr.
																					// boolean=OGRwkbByteOrder
