...
public class OGRStyleTable extends JNIBase {
	...
	private native boolean addStyleNat(long cPtr, String pszName,
			String pszStyleString);

	private native boolean removeStyleNat(long cPtr, String pszName);

	private native boolean modifyStyleNat(long cPtr, String pszName,
			String pszStyleString);
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto OGRStyleTable de C.
	 */
	...
	public boolean addStyle(String pszName, String pszStyleString)
			throws OGRException {
		return true;
	}
	...
	public boolean modifyStyle(String pszName, String pszStyleString)
			throws OGRException {
		return true;
	}
