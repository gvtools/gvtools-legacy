...
public class OGRSpatialReference extends JNIBase {
	...
	protected static native int importFromPCINat(long cPtr, String cod,
			String cs, double[] coord);

	protected static native int importFromUSGSNat(long cPtr, long code,
			long zone, double[] params, long datum);
	...
	protected static native String getAuthorityCodeNat(long cPtr,
			String targetKey);

	protected static native String getAuthorityNameNat(long cPtr,
			String targetKey);
	...
	public void setUTM(int zona, boolean norte_sur) throws OGRException {
		...
		if (res < 0)
			throw new OGRException(
					"Error en setUTM(). No se ha podido asignar la zona especificada.");
	}
	...
	public int getUTMZone() throws OGRException {
		...
		if (res < 0)
			throw new OGRException(
					"Error en getUTMZone(). Valor de zona devuelto erroneo.");
	...
	public boolean getHemisphere() throws OGRException {
		...
		if (hemis < 0)
			throw new OGRException(
					"Error en getHemisphere(). Valor de hemisferio devuelto erroneo.");
	 ...
	 * 
	 * @param cs
	 *            Coordenadas geograficas soportadas:<BR>
	 *            <UL>
	 *            <LI>WGS84</LI>
	 *            <LI>WGS72</LI>
	 *            <LI>NAD27</LI>
	...
	public void setWellKnownGeogCS(String cs) throws OGRException {
		...
		if ((cs == null) || (cs.equals("")))
			throw new OGRException(
					"Parametro incorrecto en OGRSpatialReference.setWllKnownGeoCS");

		int res = setWellKnownGeogCSNat(cPtr, cs);

		if (res < 0)
			throw new OGRException(
					"Error en setWellKnownGeoCS(). No se ha podido asignar el sistema de coordenadas especificado.");
	}
	...
	public String exportToWkt() throws OGRException {
		...
		if (wkt == null)
			throw new OGRException(
					"Error en exportToWkt(). No se ha podido obtener la proyección.");
	...
	public void setFromUserInput(String a_srs) throws OGRException {
		...
		if ((a_srs == null) || (a_srs.equals("")))
			throw new OGRException(
					"Parametro incorrecto en OGRSpatialReference.setFromUserInput");
	 ...
	 * @throws CrsGdalException
	 */
	public static String exportToWkt(OGRSpatialReference ORGSpace)
			throws CrsGdalException {
		if (ORGSpace.cPtr == 0)
			throw new CrsGdalException();
	 ...
	 * @throws OGRException
	 */
	public static int importFromWkt(OGRSpatialReference ORGSpace, String cadenas)
			throws OGRException {
		...
		if (result != 0)
			throw new OGRException(result,
					"Error en Wkt().La creacion del objeto no tuvo exito. ",
					ORGSpace);
		return result;
	}
	 ...
	 * @throws OGRException
	 */
	public static int setUTM(OGRSpatialReference ORGSpace, int zona,
			boolean norte_sur) throws OGRException {
		if ((zona <= 0) || (zona > 60))
			throw new OGRException("Zona incorrecta");

		if (ORGSpace.cPtr == 0)
			throw new OGRException(
					"Error en setUTM(). La llamada de creación de objeto no tuvo exito.");
	 ...
	 * @throws OGRException
	 */
	public static int setWellKnownGeogCS(OGRSpatialReference ORGSpace, String cs)
			throws OGRException {
		if ((cs == null) || (cs.equals("")))
			throw new OGRException("Parametro incorrecto");
		...
		if (ORGSpace.cPtr == 0)
			throw new OGRException(
					"Error en setWellKnownGeogCS(). La llamada de creación de objeto no tuvo exito.");
	 ...
	 * @throws OGRException
	 */
	public static int importFromEPSG(OGRSpatialReference ORGSpace, int cod)
			throws OGRException {
		if (ORGSpace.cPtr == 0)
			throw new OGRException(
					"Error importFromEPSG. La llamada de creación de objeto no tuvo exito.");

		int result = importFromEPSGNat(ORGSpace.cPtr, cod);

		if (result != 0)
			throw new OGRException(result,
					"Error en EPSG().La creacion del objeto no tuvo exito. ",
					ORGSpace);
	 ...
	 * @throws OGRException
	 */
	public static int importFromProj4(OGRSpatialReference ORGSpace, String cs)
			throws OGRException {
		...
		if (ORGSpace.cPtr == 0)
			throw new OGRException(
					"Error en Proj4(). La llamada de creación de objeto no tuvo exito.");
		...
		if (res != 0)
			throw new OGRException(
					res,
					"Error en Proj4(). No se ha podido asignar el sistema de coordenadas especificado. ",
					ORGSpace);
	 ...
	 */
	public static String exportToProj4(OGRSpatialReference ORGSpace)
			throws OGRException {
		if (ORGSpace.cPtr == 0)
			throw new OGRException(
					"Error en exportToProj4(). La llamada de creación de objeto no tuvo exito.");
	 ...
	 * @throws OGRException
	 */
	public static int importFromPCI(OGRSpatialReference ORGSpace, String cod,
			String cs, double[] coord) throws OGRException {
		if ((cs == null) || (cs.equals("")))
			throw new OGRException("Parametro incorrecto");
		...
		if (ORGSpace.cPtr == 0)
			throw new OGRException(
					"Error en importFromPCI. La llamada de creación de objeto no tuvo exito.");
		...
		if (result != 0)
			throw new OGRException(result,
					"Error en PCI().La creacion del objeto no tuvo exito. ",
					ORGSpace);
	 ...
	 * @throws OGRException
	 */
	public static int importFromUSGS(OGRSpatialReference ORGSpace, long code,
			long zone, double[] params, long datum) throws OGRException {
		if (ORGSpace.cPtr == 0)
			throw new OGRException(
					"Error en importFromUSGS. La llamada de creación de objeto no tuvo exito.");
		...
		if (result != 0)
			throw new OGRException(result,
					"Error en USGS().La creacion del objeto no tuvo exito. ",
					ORGSpace);
	 ...
	 * @throws OGRException
	 */
	public static int importFromESRI(OGRSpatialReference ORGSpace,
			String cadenas) throws OGRException {
		if (cadenas == null)
			throw new OGRException("Parametro incorrecto");

		if (ORGSpace.cPtr == 0)
			throw new OGRException(
					"Error en importFromEsri. La llamada de creación de objeto no tuvo exito.");

		int result = importFromESRINat(ORGSpace.cPtr, cadenas);
		if (result != 0)
			throw new OGRException(result,
					"Error en ESRI().La creacion del objeto no tuvo exito. ",
					ORGSpace);
		return result;
	}
}