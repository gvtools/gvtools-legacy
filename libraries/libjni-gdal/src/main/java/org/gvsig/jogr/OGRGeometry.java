...
public class OGRGeometry extends JNIBase {
	...
	private native void exportToWkbNat(long cPtr, boolean ogrwkbByteOrder,
			String wkt);// Excepciones
	...
	private native void assignSpatialReferenceNat(long cPtr,
	...
	private native int intersectNat(long cPtr, OGRGeometry geom); // return
																	// OGRBoolean

	private native int equalNat(long cPtr, OGRGeometry geom);// return
																// OGRBoolean

	private native int disjointNat(long cPtr, OGRGeometry geom); // return
																	// OGRBoolean

	private native int touchesNat(long cPtr, OGRGeometry geom); // return
																// OGRBoolean

	private native int crossesNat(long cPtr, OGRGeometry geom); // return
																// OGRBoolean

	private native int withinNat(long cPtr, OGRGeometry geom);// return
																// OGRBoolean

	private native int containsNat(long cPtr, OGRGeometry geom);// return
																// OGRBoolean

	private native int overlapsNat(long cPtr, OGRGeometry geom);// return
																// OGRBoolean
	 ...
	 * 
	 * @param cPtr
	 *            dirección de memoria al objeto OGRGeometry de C.
	 */
	...
	public void exportToWkb(boolean ogrwkbByteOrder, String wkt)
	...
	public void assignSpatialReference(OGRSpatialReference poSR)
			throws OGRException {
	...
	public int intersect(OGRGeometry geom) throws OGRException { // return
																	// OGRBoolean
		return 0;
	}
	...
	public int disjoint(OGRGeometry geom) throws OGRException { // return
																// OGRBoolean
		return 0;
	}
	...
	public int touches(OGRGeometry geom) throws OGRException { // return
																// OGRBoolean
		return 0;
	}
	...
	public int crosses(OGRGeometry geom) throws OGRException { // return
																// OGRBoolean
		return 0;
	}
	...
	public int within(OGRGeometry geom) throws OGRException {// return
																// OGRBoolean
		return 0;
	}
	...
	public int contains(OGRGeometry geom) throws OGRException {// return
																// OGRBoolean
		return 0;
	}
	...
	public int overlaps(OGRGeometry geom) throws OGRException {// return
																// OGRBoolean
		return 0;
	}
	...
	public OGRGeometry symmetricDifference(OGRGeometry geom)
			throws OGRException {
		return null;
	}
