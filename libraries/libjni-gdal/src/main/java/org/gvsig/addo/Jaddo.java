...
public class Jaddo extends JNIBase implements IOverviewIncrement {
	...
	private native int buildOverviewsNative(int resamplingAlg, String file,
			int[] overviews);
	...
	/**
	 * Asigna el porcentaje de incremento de la construccion de overview. Esto
	 * se hace automaticamente desde el callback que asigna el porcentaje.
	 */
