...
/**
 * Test para la generacion de overviews sobre una imagen raster. Registra un
 * listener para mostrar el incremento de la tarea.
 * 
 * 18-nov-2007
 * 
...
public class TestBuildOverviews extends TestCase implements IOverviewIncrement {
	...
	public void testStack() {
		try {
			...
			assertTrue("No hay overviews!!", gdal.getRasterBand(1)
					.getOverviewCount() > 0);
