...
public class SegmentsTypeBinding {
	...
	public ArrayList parse(IXmlStreamReader parser, GPEDefaultGmlParser handler)
		...
		while (!endFeature) {
			...
			case IXmlStreamReader.START_ELEMENT:
				if (CompareUtils.compareWithNamespace(tag,
					...
					segments.add(handler.getProfile()
							.getLinestringSegmentTypeBinding()
			...
			case IXmlStreamReader.END_ELEMENT:
				if (CompareUtils
						.compareWithNamespace(tag, GMLTags.GML_SEGMENTS)) {
					endFeature = true;
				}
				break;
