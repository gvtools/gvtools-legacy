 ...
 */
/**
 * GPE writer handler for the GML format. It writes a GML file.
 * 
 * @author Jorge Piera LLodrá (jorge.piera@iver.es)
 */
public abstract class GPEGmlWriterHandlerImplementor extends
	 ...
	 * 
	 * @see
	 * org.gvsig.gpe.writer.GPEWriterHandlerImplementor#startLayer(java.lang
	...
	public void startLayer(String id, String namespace, String name,
		...
		try {
			getProfile().getFeatureCollectionWriter().start(writer, this, id,
					namespace, name);
			writer.writeEndAttributes();
			getProfile().getNameWriter().write(writer, this, name);
			getProfile().getDescriptionWriter()
					.write(writer, this, description);
		} catch (IOException e) {
			getErrorHandler().addError(e);
		}
	}
	...
	protected void initPrefixes() throws XmlStreamException {
		writer.setPrefix(XMLTags.XML_NAMESPACE_URI,
				XMLTags.XML_NAMESPACE_PREFIX);
		writer.setPrefix(XMLTags.XML_SCHEMA_INSTANCE_NAMESPACE_URI,
				XMLTags.XML_SCHEMA_INSTANCE_NAMESPACE_PREFIX);
		writer.setPrefix(GMLTags.GML_NAMESPACE_PREFIX,
				GMLTags.GML_NAMESPACE_URI);
		writer.setPrefix(GPEDefaults
	 ...
	 * 
	 * @see
	 * org.gvsig.gpe.writer.GPEWriterHandlerImplementor#startFeature(java.lang
	 * .String, java.lang.String, java.lang.String)
	 */
	public void startFeature(String id, String namespace, String name) {
		currentFeature.push(name);
		try {
			profile.getFeatureMemberWriter().start(writer, this, id, namespace,
					name);
		} catch (IOException e) {
			getErrorHandler().addError(e);
		}
	...
	public void endFeature() {
		try {
			profile.getFeatureMemberWriter().end(writer, this,
					(String) currentFeature.pop(), getTargetNamespacePrefix());
		} catch (IOException e) {
			getErrorHandler().addError(e);
		}
	}
	 ...
	 * 
	 * @see
	 * org.gvsig.gpe.writer.IGPEWriterHandlerImplementor#startElement(java.lang
	...
	public void startElement(String namespace, String name, Object value) {
		...
		try {
			profile.getElementWriter().start(writer, this, namespace, name,
					value);
		} catch (IOException e) {
			getErrorHandler().addError(e);
		}
	...
	public void endElement() {
		try {
			profile.getElementWriter().end(writer, this,
					(String) currentElement.pop(), getTargetNamespacePrefix());
		} catch (IOException e) {
			getErrorHandler().addError(e);
		}
	}
	 ...
	 * .String, org.gvsig.gpe.writer.ICoordinateSequence, java.lang.String)
	 */
	public void startPoint(String id, ICoordinateSequence coords, String srs) {
		try {
			if (isMultiple) {
				if (hasMultipleType) {
					profile.getGeometryMemberWriter().startPoint(writer, this,
							id, srs);
					profile.getPointWriter().start(writer, this, id, coords,
							srs);
				} else {
					profile.getPointMemberWriter().start(writer, this, id,
							coords, srs);
				}
			} else {
	 ...
	 * .lang.String, org.gvsig.gpe.writer.ICoordinateSequence, java.lang.String)
	 */
		...
		try {
			if (isMultiple) {
				if (hasMultipleType) {
					profile.getGeometryMemberWriter().startPoint(writer, this,
							id, srs);
					profile.getLineStringWriter().start(writer, this, id,
							coords, srs);
				} else {
					profile.getLineStringMemeberWriter().start(writer, this,
							id, coords, srs);
				}
			} else {
				profile.getLineStringWriter().start(writer, this, id, coords,
						srs);
			}
		} catch (IOException e) {
			getErrorHandler().addError(e);
		...
		try {
			if (isMultiple) {
				if (hasMultipleType) {
					profile.getGeometryMemberWriter().startPoint(writer, this,
							id, srs);
					profile.getPolygonWriter().start(writer, this, id, coords,
							srs);
				} else {
					profile.getPolygonMemberWriter().start(writer, this, id,
							coords, srs);
				}
			} else {
	 ...
	 * java.lang.String, org.gvsig.gpe.writer.ICoordinateSequence,
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.gvsig.gpe.writers.GPEWriterHandler#startMultiPoint(java.lang.String,
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.gvsig.gpe.writers.GPEWriterHandler#startMultiLineString(java.lang
	 ...
	 * 
	 * @see
	 * org.gvsig.gpe.writers.GPEWriterHandler#startMultiPolygon(java.lang.String
	 * , java.lang.String)
	 */
