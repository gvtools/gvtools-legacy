...
/**
 * This class contains the properties for the GML parsers and writers. This
 * class has been registered using the SPI (Service Provider Interface) and the
 * values of their properties can be configured using {@link GPEDefaults}.
 */
public class GmlProperties implements IGPEProperties {
	...
	public GmlProperties() {
		...
		properties.put(DEFAULT_FEATURECOLLECTION,
				DEFAULT_FEATURECOLLECTION_VALUE);
		properties.put(DEFAULT_FEATURE, DEFAULT_FEATURE_VALUE);
		properties.put(SRS_BASED_ON_XML, SRS_BASED_ON_XML_VALUE);
	}

	/**
	 * This attribute is used to represent the decimal separator. It separates
	 * the integral and the fractional parts of a decimal numeral.
	 */
	public static final String DECIMAL = "decimal";
	private static final String DECIMAL_VALUE = ".";

	/**
	 * It separates the different dimensions of each coordinate of a geometry
	 * (e.g. Uses ",": X1,Y1,Z1)
	 */
	...
	/**
	 * It separates the different tuples of dimensions (e.g. Uses blank space
	 * " ": X1,Y1,Z1 X2,Y2,Z2)
	 */
	...
	/**
	 * Default name for a collection of features. This name will be used only if
	 * there is not a name for a feature collection.
	 */
	...
	/**
	 * Default name for a feature. It is only used if the feature to write
	 * doesn't has a name
	 */
