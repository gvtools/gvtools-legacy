...
public class ProjectionPool implements ICRSFactory {
    static TreeMap<String, IProjection> data = new TreeMap<String, IProjection>();
...
//    }
    ...
    public static Iterator<IProjection> iterator() {
        ArrayList<IProjection> projs = new ArrayList<IProjection>();

        Iterator<Entry<String, IProjection>> iter = data.entrySet().iterator();
