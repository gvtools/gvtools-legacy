...
public class WMSStatusTest extends TestCase {
	...
	protected void setUp() {
		...
		// Extent
		Rectangle2D rect1 = new Rectangle2D.Double(1.0, 1.00000001, 5.000000,
				6.8);
		st1.setExtent(rect1);
		// Exception format
		...
		// Extent
		Rectangle2D rect2 = new Rectangle2D.Double(1.0, 1.00000001, 5.000000,
				6.8);
		st2.setExtent(rect2);
		// Exception format
		...
		// Extent
		Rectangle2D rect3 = new Rectangle2D.Double(2.0, 1.00000001, 5.000000,
				6.8);
		st3.setExtent(rect3);
		// Exception format
		...
		// Extent
		Rectangle2D rect4 = new Rectangle2D.Double(2.0, 1.00000001, 5.000000,
				6.8);
		st4.setExtent(rect3);
		// Exception format
