	...
	public static void main(String[] args) {
		try {
			WMSClient wmsclient = new WMSClient(
					"http://orto.cth.gva.es:80/wmsconnector/com.esri.wms.Esrimap/wms_urbanismo_tematicos?");
			...
			Rectangle2D extent = new Rectangle2D.Double(-1.5597948439,
					37.8178641941, -1.5597948439 - 0.5286772976,
					37.8178641941 - 40.8151000365);
