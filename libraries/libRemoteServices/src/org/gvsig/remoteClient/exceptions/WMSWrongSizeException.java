...
/**
 * La petición al servidor era de un tamaño equivocado. Reconoce execepciones de
 * algunos tipos:<br>
 ...
 * 	  </ServiceException>
 * 	</ServiceExceptionReport>
 * </pre> <li>El server http://www.idee.es/wms/IDEE-Base/IDEE-Base da
 * 
 * <pre>
 ...
 * 	</ERROR>
 * </pre> <li>El server http://ovc.catastro.meh.es/Cartografia/WMS/ServidorWMS.aspx da
 * 
 * <pre>
...
public class WMSWrongSizeException extends WMSException {
	...
	/**
	 * Checks if the argument is a WrongSizeError message, in this case throws a
	 * WMSWrongSizeException
	 * 
	 * @param errorMsg
	 *            El mensaje de error que pasa el server.
	 * @throws WMSException
	 */
