...
/**
 * Describes the status of a WMSclient, so it adds to the Remote client status a
...
public class WMSStatus extends org.gvsig.remoteClient.RemoteClientStatus {
	...
	public boolean equals(Object obj) {
		...
		// Compare layer names
		if (!((s.getLayerNames() == null && this.getLayerNames() == null) || s
				.getLayerNames().equals(this.getLayerNames())))
			return false;
		...
		// Compare dimensions
		if (!((s.getDimensions() == null && this.getDimensions() == null) || s
				.getDimensions().equals(this.getDimensions())))
			return false;
	...
	/**
	 * Returns the URL that the server specified for a WMS request if any was
	 * described in its capabilities document.
	 * 
	 * @param operationName
	 *            , a String containing the name of the operation
	 *            (case-independent)
	 ...
	 * specific WMS request.
	 * 
	 * @param operationName
	 *            , String telling to which request correspond the address
	 * @param url
	 *            , String containing the URL for the given WMS request
	 */
