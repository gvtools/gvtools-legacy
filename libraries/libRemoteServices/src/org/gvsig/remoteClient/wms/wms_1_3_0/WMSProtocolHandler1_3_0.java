 ...
 * </p>
 */
public class WMSProtocolHandler1_3_0 extends
		...
		try {
			...
			if (kxmlParser.getEventType() != KXmlParser.END_DOCUMENT) {
				kxmlParser.require(KXmlParser.START_TAG, null,
						CapabilitiesTags.CAPABILITIES_ROOT1_3_0);
		...
		while (!end) {
			...
			case KXmlParser.START_TAG:
				if (parser.getName().compareTo(CapabilitiesTags.REQUEST) == 0) {
					...
					// TODO:
					// Add to serviceInformation the supported exception
					// formats.
		...
		while (!end) {
			...
			case KXmlParser.START_TAG:
				if (parser.getName()
					...
					// we could parse here the info of Capabilities request, but
					// we actually never use it.
	...
	/**
	 * Builds the GetFeatureInfoRequest according to the 1.3.0 OGC WMS
	 * Specifications
	 */
