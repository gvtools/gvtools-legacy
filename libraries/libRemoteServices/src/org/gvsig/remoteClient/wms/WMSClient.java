...
/**
 * <p>
 * Represents the class the with the necessary logic to connect to a OGCWMS and
...
public class WMSClient extends org.gvsig.remoteClient.RasterClient {
	...
	public File getMap(WMSStatus status, ICancellable cancel)
			throws WMSException, ServerErrorException {
		return handler.getMap(status, cancel);
	}

	/**
	 * <p>
	 * One of the three interfaces defined by OGC WMS, it gets the service
	 * capabilities
	 * </p>
	 * 
	 * @param override
	...
	/**
	 * <p>
	 * One of the three interfaces defined by the OGC WMS, it gets the
	...
	public String getFeatureInfo(WMSStatus status, int x, int y,
			int featureCount, ICancellable cancel) throws WMSException {
		return handler.getFeatureInfo(status, x, y, featureCount, cancel);
	}

	/**
	 * <p>
	 * One of the three interfaces defined by the OGC WMS, it gets legend of a
	 * layer
	 * </p>
	 * 
	 * @return
	...
	public File getLegendGraphic(WMSStatus status, String layerName,
			ICancellable cancel) throws WMSException, ServerErrorException {
	...
	/**
	 * <p>
	 * Reads from the WMS Capabilities the number if layers available in the
	 * service
	 * </p>
	 * 
	...
	public Rectangle2D getLayersExtent(String[] layerNames, String srs) {
		try {
			...
			Rectangle2D extent = new Rectangle2D.Double(xmin, ymin,
	 ...
	 * @param wmsStatus
	 * @param layerQuery
	 * @return true if the layers has LegendUrl inside the style object
	 *         (getcapabilities)
	 */
