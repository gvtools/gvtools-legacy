...
public abstract class WMSLayer implements org.gvsig.remoteClient.ILayer {
	...
	/**
	 * <p>
	 * Layer Abstract field in the capabilities document
	 * </p>
	 */
	...
	/**
	 * <p>
	 * extents for each srs the layer can be reproyected to
	 * </p>
	 */
	...
	/**
	 * <p>
	 * extents that defines the bbox for the LatLon projection It can be
	 * included in the bBoxes vector as well, because it is the most used, we
	 * keep it separeted too, according with the OGC WMSCapabilities
	 * specifications...
	 */
	...
	/**
	 * when set to true, noSubsets indicates that the server is not able to make
	 * a map of a geographic area other than the layer's bounding box.
	 */
	private boolean m_noSubSets = false;

	/**
	 * when present and non-zero fixedWidth and fixedHeight indicate that the
	 * server is not able to produce a map of the layer at a width and height
	 * different from the fixed sizes indicated.
	 */
	...
	// Methods to manipulate the box that defines the layer extent in LatLon
	// SRS.
	...
	/**
	 * @return <b>true</b> if this layer can be served with transparency,
	 *         otherwise <b>false</b>
	 */
	...
	// In case there is a version which has different implemantation of one of
	// this tags
	// the subclass can overwrite this method

	/**
	 * Parses the keywordlist from the capabilities and fills this list in the
	 * WMSLayer.
	 * 
	 * @param parser
	 */
	protected void parseKeywordList(KXmlParser parser) throws IOException,
	...
	/**
	 * Reads and parses the layer attributes Maybe this method should be moved
	 * to the WMSLayer. Until now the attributes are teh same for all versions.
	 * 
	 * @param parser
	 */
