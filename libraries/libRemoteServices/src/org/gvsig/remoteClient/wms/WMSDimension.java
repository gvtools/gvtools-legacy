...
public class WMSDimension {
	...
	/**
	 * Declares what value would be used along this dimension if a Web request
	 * omits a value for this dimension.
	 */
	private String dimDefaultValue;
	/**
	 * Indicates that the request may include multiple values or (if it is null
	 * or zero) have to include <b>only<b/> single value for this dimension.
	 */
	private String multipleValues;
	/**
	 * Indicates that the server will round off inexact dimension values to the
	 * nearest valid value, or (if it is null or zero) it will not.
	 */
	private String nearestValues;
	/**
	 * Indicates that temporal data are normally kept current and that the
	 * request parameter TIME <b>may</b> include the keyword 'current' instead
	 * of an ending value.
	 */
	...
	/**
	 * Tells that the temporal data are normally kept current and that the
	 * request parameter TIME may include the keyword 'current' instead of an
	 * ending value.
	 * 
	...
	/**
	 * Gets the value that would be used along this dimension if a Web request
	 * omits a value for the dimension.
	 * 
	...
	/**
	 * Parses the DIMENSION tag in the WMS capabilities, filling the
	...
	public void parse(KXmlParser parser) throws IOException,
		...
		unitSymbol = parser.getAttributeValue("",
				CapabilitiesTags.DIMENSION_UNIT_SYMBOL);
		dimDefaultValue = parser
				.getAttributeValue("", CapabilitiesTags.DEFAULT);
