...
public class WMSExtent {
	...
	/**
	 * Parses the EXTENT tag in the WMS capabilities, filling the Extend fills
	 * of the WMSDimension object and loading the data into memory to be easily
	 * accesed.
	 */
	public void parse(KXmlParser parser) throws IOException,
		...
		extDefaultValue = parser
				.getAttributeValue("", CapabilitiesTags.DEFAULT);
		nearestValue = parser.getAttributeValue("",
				CapabilitiesTags.EXTENT_NEAREST_VALUE);
