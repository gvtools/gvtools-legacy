...
public abstract class AFilter {
	...
	public void setBBox(Rectangle2D bbox, String bboxPropertyName, String srs,
			int option) {
	...
	/**
	 * returns the String that represents the logic operator in this query
	 * language
	 * 
	 * @param operator
	 *            Logic operator
	...
	/**
	 * returns the String that represents the relational operator in this query
	 * language
	 * 
	 * @param operator
	 *            Logic operator
	...
	/**
	 * returns the String that represents the geometric operator in this query
	 * language
	 * 
	 * @param operator
	 *            Logic operator
	...
	/**
	 * returns the String that represents the separator operator in this query
	 * language
	 * 
	 * @param separator
	 *            LSeparator "(" or ")"
	...
	public int getRelationalOperator(String operator) {
		...
		} else if (operator.equals("<>")) { // This is another way to tell
											// not-equal
			return RELATIONAL_OPERATOR_IS_NOT_EQUALS_TO;
		} else if (operator.equals(">")) {
