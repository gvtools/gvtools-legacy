...
/**
 * Class containing a description for all the TAGS defined in the Capabilities
 * Object returned from a WMS note: this describes the WMT_MS_Capabilitites
 * 1.1.1
 * */
public class CapabilitiesTags {
	...
	// Used in the WMS as "LatLonBoundingBox" don't change it and create your
	// own one
