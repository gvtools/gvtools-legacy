...
public class URLRequest {
	...
	public int hashCode() {
		if (hashCode == 0) {
			int result = 17;
			String[] stringFields = new String[] { fileName, host, file,
					protocol };
	...
	public boolean equals(Object o) {
		...
		for (int i = 0; i < stringFields.length; i++) {
			...
			if (stringFields[i] == null && othersStringField[i] != null)
				return false;
			if (stringFields[i] != null && othersStringField[i] != null)
				if (!stringFields[i].equals(othersStringField[i]))
					return false;
		}
