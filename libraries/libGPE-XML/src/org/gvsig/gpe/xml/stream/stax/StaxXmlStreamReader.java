...
public class StaxXmlStreamReader implements IXmlStreamReader {
	...
	/**
	 * Returns the (local) name of the current tag (the current event shall be
	 * START_ELEMENT or END_ELEMENT), or null if the current event is not a tag
	 * event.
	 * 
	 * @return
	...
	public int next() throws XmlStreamException {
		...
		try {
			...
			throw new XmlStreamException(msg,
					e.getNestedException() == null ? e : e.getNestedException());
		}
