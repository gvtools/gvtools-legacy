...
/**
 * IXmlStreamWriter defines an "XML push" like streaming API for writing XML
 * documents encoded as per the OGC Binary XML Best Practices document.
 * <p>
 * This interface does not defines setter methods to control encoding behavior
 * such as byte order to use or character encoding. A IXmlStreamWriter instance
 * is meant to be already configured with the desired encoding options when
 * returned from the {@link BxmlOutputFactory}.
 * </p>
 * <p>
 * Sample usage:
 * 
...
public interface IXmlStreamWriter {
	...
	/**
	 * Returns a safe copy of the encoding options this writer is settled up
	 * with.
	 * <p>
	 * Modifications to the returned object state does not affect this writer
	 * behaviour.
	 * </p>
	 * 
	 * @return an object representing the set of encoding options this writer
	 *         operates with
	 */
	 ...
	 * {@link #writeStartElement(String, String) writeStartElement} it shall
	 * return {@link EventType#START_ELEMENT START_ELEMENT}, if it was
	 * {@link #writeStartAttribute(String, String) writeStartAttribute},
	 * {@link EventType#ATTRIBUTE ATTRIBUTE}, etc.
	 * </p>
	 * 
	 * @post {$return != null}
	 * @return {@link EventType#NONE} if writing has not yet started (ie,
	 *         writeStartDocument has not been called), the event for the last
	 *         write operation otherwise.
	 */
	public EventType getLastEvent();

	/**
	 * @return {@code null} if no tag event has been written yet, START_ELEMENT
	 *         or END_ELEMENT otherwise, depending on which of them was lately
	 *         called
	 */
	...
	/**
	 * Closes this stream writer and releases any system resources associated
	 * with it, including the underlying output stream or any other output
	 * source it may be operating upon.
	 * <p>
	 * A call to this method implies a flush of any possible buffered wtrite
	 * before closing the stream.
	 * </p>
	 * <p>
	 * The first call to this method closes and releases resources. Subsequent
	 * calls shall take no effect and return quitely. After the first call to
	 * this method any non query method (defined as metadata retrieval methods
	 * in the class' javadoc) shall fail with an io exception.
	 * </p>
	 * 
	 * @throws IOException
	...
	/**
	 * Returns whether this stream writer and its underlying output source are
	 * open and able to receive more write calls.
	 * <p>
	 * A {@code IXmlStreamWriter} should be open since its creation until
	 * {@link #close()} is explicitly called by client code.
	 * </p>
	 * 
	 * @return {@code true} if this stream is still open, {@code false}
	 *         otherwise
	 */
	 ...
	 * <p>
	 * This should be the first non query method to call after a stream writer
	 * is created. The implementation will use the call to this method to write
	 * down the document header and xml declaration.
	 * </p>
	 * 
	 * @pre {getLastEvent() == NONE}
	 ...
	 * <p>
	 * Implementations shall use this method to write down the document's
	 * trailer token.
	 * </p>
	 * 
	 * @pre {getTagDeep() == 0}
	...
	public void writeStartElement(final String namespaceUri,
			final String localName) throws IOException;

	/**
	 * @pre {qname != null}
	 * @post {getLastEvent() == START_ELEMENT}
	 * @param qname
	 *            qualified element name. Only namespace and localName are
	 *            relevant. Prefix, if present, is ignored. The currently mapped
	 *            prefix for the namespace will be used in any case.
	 * @throws IOException
	...
	/**
	 * @pre {getTagDeep() > 0}
	 * @pre { ( getLastEvent().isValue() AND getWrittenValueCount() ==
	 *      getValueLength() ) || getLastEvent() IN ( START_ELEMENT,
	 *      END_ELEMENT, ATTRIBUTES_END, COMMENT}
	 ...
	 * <p>
	 * Writting an attribute and its value is split in two parts. This method
	 * only stand for the attribute declaration. Writting an attribute value is
	 * made after calling this method and is optional. The attribute value can
	 * be done with any of the {@code writeValue} methods, even using various
	 * {@code writeValue} calls for the same attribute.
	 * </p>
	 * <p>
	 * After the last element attribute has been written,
	 * {@link #writeEndAttributes()} shall be called to indicate the end of the
	 * attribute list.
	 * </p>
	 * Sample usage:
	 * 
	 ...
	 */
	public void writeStartAttribute(final String namespaceUri,
			final String localName) throws IOException;
	 ...
	 * @pre {qname != null}
	 * @param qname
	 *            a QName where to get the namespace uri and local name for the
	 *            attribute
	 * @throws IOException
	...
	/**
	 * Indicates there are no more element attributes to encode for the current
	 * element.
	 * <p>
	 * This method is useful for the encoder to recognize (and write down the
	 * appropriate tokens) the following potential call to some writeValue
	 * method corresponds to the element's contents and not to the current
	 * attribute value.
	 * </p>
	 * Sample usage:
	 * 
	...
	/**
	 * @pre {getLastEvent().isValue() == true || getLastEvent() IN
	 *      (START_ELEMENT, ATTRIBUTE, COMMENT )}
	 ...
	 * @throws IOException
	 */
	public void writeValue(final char[] chars, final int offset,
	 ...
	 * @throws IOException
	 */
	public void writeValue(final boolean[] value, final int offset,
			final int length) throws IOException;
	 ...
	 * @throws IOException
	 */
	public void writeValue(final long[] value, final int offset,
			final int length) throws IOException;
	 ...
	 * @throws IOException
	 */
	public void writeValue(final float[] value, final int offset,
			final int length) throws IOException;

	/**
	 * Writes a value section defined by the
	 * 
	 * @pre {getLastEvent() IN ( START_ELEMENT START_ELEMENT, ATTRIBUTE
	 *      ATTRIBUTE )}
	 * @post {getLastEvent() == VALUE_DOUBLE}
	 * @param value
	 * @param offset
	 ...
	 * @throws IOException
	 */
	public void writeValue(final double[] value, int offset, int length)
			throws IOException;

	/**
	 * Writes a comments block
	 * <p>
	 * The provided {@code commentContent} is the coalesced value of the
	 * equivalent XML comment block (enclosed between {@code <!--} and
	 * {@code -->} tags.
	 * </p>
	 * 
	 ...
	 * @throws IOException
	 */
	public void startArray(EventType valueType, int arrayLength)
			throws IOException;
	 ...
	 * <p>
	 * This URI is bound in the scope of the current START_ELEMENT / END_ELEMENT
	 * pair. If this method is called before a START_ELEMENT has been written
	 ...
	 * <p>
	 * This prefix is bound in the scope of the current START_ELEMENT /
	 * END_ELEMENT pair (current context). If this method is called before a
