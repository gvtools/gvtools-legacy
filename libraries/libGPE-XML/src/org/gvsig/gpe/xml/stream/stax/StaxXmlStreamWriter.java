...
public class StaxXmlStreamWriter implements IXmlStreamWriter {
	...
	/**
	 * nsuri for the attribute currently being processed. null if an attribute
	 * is not being processed
	 */
	private String attributeNamespace;

	/**
	 * local name for the attribute currently being processed. null if an
	...
	public StaxXmlStreamWriter(final OutputStream out)
	...
	/**
	 * @see IXmlStreamWriter#setSchemaLocation(java.lang.String,
	 *      java.lang.String)
	 */
	...
	/**
	 * @see IXmlStreamWriter#writeStartAttribute(java.lang.String,
	 *      java.lang.String)
	 */
	...
	private void flushAttribute() throws XmlStreamException {
		if (attributeLocalName != null) {
			...
			try {
				writer.writeAttribute(attributeNamespace, attributeLocalName,
						value);
			} catch (XMLStreamException e) {
				throw new XmlStreamException(e);
			}
	...
	/**
	 * @see IXmlStreamWriter#writeStartElement(java.lang.String,
	 *      java.lang.String)
	 */
	...
	/**
	 * All writeValue methods delegate to this one, which will call a
	 * writeCharacters if its an element's value or an attribute if its an
	 * attribute value.
	 * <p>
	 * Whether the value corresponds to an attribute or an element's one is
	 * determined by the nullity of the attributeLocalName field.
	 * </p>
	 * 
	 * @param value
	 * @throws XmlStreamException
	 ...
	 */
	public void writeValue(char[] chars, int offset, int length)
			throws XmlStreamException {
	 ...
	 */
	public void writeValue(boolean[] value, int offset, int length)
			throws XmlStreamException {
	 ...
	 */
	public void writeValue(int[] value, int offset, int length)
			throws XmlStreamException {
		valueBuff.setLength(0);
		for (int i = 0; i < length; i++) {
			valueBuff.append(value[offset + i]);
	 ...
	 */
	public void writeValue(long[] value, int offset, int length)
			throws XmlStreamException {
		valueBuff.setLength(0);
		for (int i = 0; i < length; i++) {
			valueBuff.append(value[offset + i]);
	 ...
	 */
	public void writeValue(float[] value, int offset, int length)
			throws XmlStreamException {
		valueBuff.setLength(0);
		for (int i = 0; i < length; i++) {
			valueBuff.append(value[offset + i]);
	 ...
	 */
	public void writeValue(double[] value, int offset, int length)
			throws XmlStreamException {
		valueBuff.setLength(0);
		for (int i = 0; i < length; i++) {
			valueBuff.append(value[offset + i]);
