...
/**
 * This class contains the properties for the XML parsers and writers. This
...
public class XmlProperties implements IGPEProperties {
	...
	public XmlProperties() {
		...
		properties
				.put(DEFAULT_NAMESPACE_PREFIX, DEFAULT_NAMESPACE_PREFIX_VALUE);
	 ...
	 * 
	 * @see <a href="http://www.w3.org/XML/Schema">XML Schema</a>
	 */
	 ...
	 * 
	 * @see <a href=" http://www.w3.org/XML/">XML</a>
	 */
	...
	/**
	 * Character to replace the blank spaces in the names that has to be added
	 * like a XML node. On the writing process all the blank spaces are replaced
	 * by this character and on the reading process this character is replaced
	 * by a blank space.
	 */
