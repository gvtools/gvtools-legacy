...
public class GPEContentHandlerTest extends GPEContentHandler {
	...
	public Object startElement(String namespace, String name, Object value,
			IAttributesIterator iterator, Object parentElement) {
	...
	public Object startFeature(String id, String namspace, String name,
			IAttributesIterator iterator, Object layer) {
	...
	public Object startLayer(String id, String namespace, String name,
			String description, String srs, IAttributesIterator iterator,
	...
	public Object startMultiLineString(String id, String srs) {
		System.out.print(tab + "Start MultiLineString, ID: " + id + ", SRS:"
				+ srs + "\n");
		tab = tab + "\t";
	...
	public Object startMultiGeometry(String id, String srs) {
		System.out.print(tab + "Start MultiGeometry, ID: " + id + ", SRS:"
				+ srs + "\n");
		tab = tab + "\t";
	...
	public Object startCurve(String id, ICoordinateIterator coords, String srs) {
		tab = tab + "\t";
		System.out
				.print(tab + "Start Curve, ID: " + id + ", SRS:" + srs + "\n");
		tab = tab + "\t";
	...
	public Object startMetadata(String type, String data,
		...
		tab = tab + "\t";
		MetaData meta = null;
		System.out.print(tab + "Start Metadata, META: " + type + ", DATA:"
				+ data + "\n");
		try {
