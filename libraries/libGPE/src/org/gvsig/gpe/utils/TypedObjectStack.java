 ...
 */
/**
 * This class implements a object stack. Every object is composed by an object
 * name and an XML schema element name. It is used on writing process to save
...
public class TypedObjectStack {
	...
	/**
	 * Retrieve the las element from the top of the stack
	 * 
	 * @return The las stack element
	 */
	...
	/**
	 * This class implements a pair of element name ald XML schema element type.
	 * 
	 * @author Jorge Piera Llodrá (jorge.piera@iver.es)
	 */
