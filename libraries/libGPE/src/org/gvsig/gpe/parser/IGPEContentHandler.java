 ...
 */
/**
 * This interface defines the "contract" between the consumer application and
 * libGPE. It has methods that will be invoke by the parser every time that an
 * event happens
 * 
...
public interface IGPEContentHandler extends IGPEContentHandlerSFP0 {
	 ...
	 * @return The consumer application object that represents a bounding box
	 */
	public Object startBbox(String id, ICoordinateIterator coords, String srs);

	/**
	 * This method indicates that the parser thas finished to parse the bounding
	 * box.
	 * 
	 * @param bbox
	 ...
	 * @param bBox
	 *            Layer bounding box
	 * @return The consumer application object that represents a layer
	 */
	...
	/**
	 * It adds a name to one layer that has been previously created using the
	 * startLayer method.
	 * 
	 * @param name
	 *            Layer name
	...
	/**
	 * It adds the description to one layer that has been previously created
	 * using the startLayer method.
	 * 
	 * @param description
	 *            Layer description
	 * @param layer
	...
	/**
	 * It adds a spatial reference system to one layer that has been previously
	...
	/**
	 * It establish the relationship parent-child between two layers that have
	 * been previously created using the startLayer method.
	 * 
	 * @param parent
	 *            The consumer application object that represents the parent
	 *            layer
	 * @param layer
	 *            The consumer application object that represents the child
	 *            layer
	 */
	public void addParentLayerToLayer(Object parent, Object layer);

	/**
	 * It adds a bounding box to one layer that has been previously created
	 * using the startLayer method.
	 * 
	 * @param bbox
	 *            Layer bounding box
	 ...
	 * @return Consumer application object that represents a feature
	 */
	...
	/**
	 * This method adds a name to one layer that has been previously created
	 * using the startFeature method.
	 * 
	 * @param name
	 *            Feature name
	 * @param feature
	...
	/**
	 * This method adds a feature to one layer that has been previously created
	 * using the startLayer method.
	 * 
	 * @param feature
	 *            Consumer application object that represents a feature
	 ...
	 * @return Consumer application object that represents an element
	 */
	...
	/**
	 * It is thrown to establish a relationship parent-child between two
	 * elements.
	 * 
	 * @param parent
	...
	/**
	 * This method adds an element to one feature that has been previously
	 * created using the startFeature method
	 * 
	 * @param element
	 *            Consumer application object that represents an element
	 * @param feature
	 ...
	 * @param srs
	 *            Spatial reference system
	 * @return Consumer application object that represents a point
	 */
	 ...
	 * @param srs
	 *            Spatial reference system
	 * @return Consumer application object that represents a linarRing
	 */
	 ...
	 * @param srs
	 *            Spatial reference system
	 * @return Consumer application object that represents a polygon
	 */
	 ...
	 * @param srs
	 *            Spatial reference system
	 * @return Consumer application object that represents a innerPolygon
	 */
	 ...
	 * @param srs
	 *            Spatial reference system
	 * @return Consumer application object that represents a multiPoint
	 */
	 ...
	 * @param srs
	 *            Spatial reference system
	 * @return Consumer application object that represents a multiLineString
	 */
	 ...
	 * @param srs
	 *            Spatial reference system
	 * @return Consumer application object that represents a multiPolygon
	 */
	 ...
	 * @param srs
	 *            Spatial reference system
	 * @return Consumer application object that represents a multiGeometry
	 */
	 ...
	 * 
	 * @param bbox
	 *            Consumer application object that represents a bounding box
	 * @param feature
	 *            Consumer application object that represents a feature
	 */
	 ...
	 * 
	 * @param type
	 *            String with the type of metadata, if is a description or any
	 *            else
	 * @param data
	 *            String with the value of the data.
	 * @param attributes
	 *            Object to pass the Atributtes
	 * @return Consumer application object that represents metadata
	 */
	 ...
	 *            Consumer application object that represents metadata
	 * @param parent
	 *            Consumer application object that represents the complex
	 *            metadata
	 */
	public void addMetadataToMetadata(Object metadata, Object parent);

	/**
	 * This method is thrown when the parser find the end of the metadata of an
	 * element.
	 * 
	 * @param metadata
	 *            Consumer application object that represents metadata
	...
	/**
	 * This method is thrown when the parser find the end of and element time
	 * tag
	 * 
	 * @param time
	 ...
	 * @param data
	 *            String with the value of the data.
	 * @return Consumer application object that represents time
	 */
